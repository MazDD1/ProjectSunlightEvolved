...
public:
	...
	*/
	...
	@param OtherItem the item we're using this item on, for example for attachments this is the weapon we're putting the attachment on. Most items wont need this.  */
