...
public:
	...
	//The animation blueprint this mesh should use, if we don't want it to leader
	UPROPERTY(BlueprintReadWrite, EditDefaultsOnly, Category = "Mesh", meta = (EditCondition="!bUseLeaderPose", EditConditionHides))
