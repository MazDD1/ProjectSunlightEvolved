...
public:
	...
	virtual void OnMarkerAdded(class UNarrativeNavigationComponent* OwnerNavComp);
	virtual void OnMarkerRemoved(class UNarrativeNavigationComponent* OwnerNavComp);
