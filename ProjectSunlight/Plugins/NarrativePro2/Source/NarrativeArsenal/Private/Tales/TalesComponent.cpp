...
void UTalesComponent::ClientExitDialogue_Implementation()
{
	if (CurrentDialogue)
	{
...
void UTalesComponent::ClientExitPartyDialogue_Implementation()
{
	if (PartyComponent)
	{
...
bool UTalesComponent::TryExitDialogue()
{
...
void UTalesComponent::ExitDialogue()
{
	if (HasAuthority())
	{
		ClientExitDialogue();
...
void UTalesComponent::ServerTryExitDialogue_Implementation()
{
	TryExitDialogue();
}
...
void UTalesComponent::DialogueFinished(UDialogue* Dialogue, const bool bStartingNewDialogue)
{
