...
void UNarrativeAbilitySystemComponent::DamagedBy(UNarrativeAbilitySystemComponent* DamageCauser, const float Damage)
{
	if (DamageCauser)
	{
		OnDamagedBy.Broadcast(DamageCauser, Damage);
	}
}

void UNarrativeAbilitySystemComponent::DealtDamage(UNarrativeAbilitySystemComponent* DamagedTarget, const float Damage)
{
	if (DamagedTarget)
	{
		OnDealtDamage.Broadcast(DamagedTarget, Damage);
	}
}
