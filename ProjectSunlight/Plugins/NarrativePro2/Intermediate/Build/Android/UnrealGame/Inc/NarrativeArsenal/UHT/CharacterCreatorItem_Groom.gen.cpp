...
const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UCharacterCreatorItem_Groom_Statics::NewProp_GroomMaterials_Inner = { "GroomMaterials", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UScriptStruct_FCreatorMeshMaterialOption, METADATA_PARAMS(0, nullptr) }; // 1180866392
const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UCharacterCreatorItem_Groom_Statics::NewProp_GroomMaterials = { "GroomMaterials", nullptr, (EPropertyFlags)0x0010000001010005, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UCharacterCreatorItem_Groom, GroomMaterials), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_GroomMaterials_MetaData), NewProp_GroomMaterials_MetaData) }; // 1180866392
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UCharacterCreatorItem_Groom_Statics::PropPointers[] = {
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UCharacterCreatorItem_Groom_Statics::NewProp_GroomMaterials_Inner,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UCharacterCreatorItem_Groom_Statics::NewProp_GroomMaterials,
};
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeArsenal_Public_CharacterCreator_Items_CharacterCreatorItem_Groom_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UCharacterCreatorItem_Groom, UCharacterCreatorItem_Groom::StaticClass, TEXT("UCharacterCreatorItem_Groom"), &Z_Registration_Info_UClass_UCharacterCreatorItem_Groom, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UCharacterCreatorItem_Groom), 3726347162U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeArsenal_Public_CharacterCreator_Items_CharacterCreatorItem_Groom_h_3578833166(TEXT("/Script/NarrativeArsenal"),
	Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeArsenal_Public_CharacterCreator_Items_CharacterCreatorItem_Groom_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeArsenal_Public_CharacterCreator_Items_CharacterCreatorItem_Groom_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
