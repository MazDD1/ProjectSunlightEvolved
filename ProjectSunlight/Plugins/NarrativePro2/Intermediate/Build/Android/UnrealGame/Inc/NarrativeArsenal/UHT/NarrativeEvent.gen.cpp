...
void UNarrativeEvent::ExecuteEvent(APawn* Target, APlayerController* Controller, UTalesComponent* NarrativeComponent)
{
	...
	{
		ExecuteEvent_Implementation(Target, Controller, NarrativeComponent);
	}
}
struct Z_Construct_UFunction_UNarrativeEvent_ExecuteEvent_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[] = {
		{ "Category", "Event" },
		{ "Comment", "/**Execute the event.\n\x09@param Target this is the target that the event was specified to run on. \n\x09*/" },
		{ "ModuleRelativePath", "Public/Tales/NarrativeEvent.h" },
...
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UNarrativeEvent_ExecuteEvent_Statics::NewProp_Target = { "Target", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(NarrativeEvent_eventExecuteEvent_Parms, Target), Z_Construct_UClass_APawn_NoRegister, METADATA_PARAMS(0, nullptr) };
...
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UNarrativeEvent_ExecuteEvent_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UNarrativeEvent_ExecuteEvent_Statics::NewProp_Target,
...
DEFINE_FUNCTION(UNarrativeEvent::execExecuteEvent)
{
	...
	P_FINISH;
	P_NATIVE_BEGIN;
	P_THIS->ExecuteEvent_Implementation(Z_Param_Target,Z_Param_Controller,Z_Param_NarrativeComponent);
	P_NATIVE_END;
}
...
// Begin Class UNarrativeEvent Function OnActivate
struct NarrativeEvent_eventOnActivate_Parms
{
	APawn* Target;
	APlayerController* Controller;
	UTalesComponent* NarrativeComponent;
};
static const FName NAME_UNarrativeEvent_OnActivate = FName(TEXT("OnActivate"));
void UNarrativeEvent::OnActivate(APawn* Target, APlayerController* Controller, UTalesComponent* NarrativeComponent)
{
	UFunction* Func = FindFunctionChecked(NAME_UNarrativeEvent_OnActivate);
	if (!Func->GetOwnerClass()->HasAnyClassFlags(CLASS_Native))
	{
		NarrativeEvent_eventOnActivate_Parms Parms;
		Parms.Target=Target;
		Parms.Controller=Controller;
		Parms.NarrativeComponent=NarrativeComponent;
	ProcessEvent(Func,&Parms);
	...
	{
		OnActivate_Implementation(Target, Controller, NarrativeComponent);
	}
}
struct Z_Construct_UFunction_UNarrativeEvent_OnActivate_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[] = {
		{ "Category", "Event" },
...
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UNarrativeEvent_OnActivate_Statics::NewProp_Target = { "Target", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(NarrativeEvent_eventOnActivate_Parms, Target), Z_Construct_UClass_APawn_NoRegister, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UNarrativeEvent_OnActivate_Statics::NewProp_Controller = { "Controller", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(NarrativeEvent_eventOnActivate_Parms, Controller), Z_Construct_UClass_APlayerController_NoRegister, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UNarrativeEvent_OnActivate_Statics::NewProp_NarrativeComponent = { "NarrativeComponent", nullptr, (EPropertyFlags)0x0010000000080080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(NarrativeEvent_eventOnActivate_Parms, NarrativeComponent), Z_Construct_UClass_UTalesComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_NarrativeComponent_MetaData), NewProp_NarrativeComponent_MetaData) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UNarrativeEvent_OnActivate_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UNarrativeEvent_OnActivate_Statics::NewProp_Target,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UNarrativeEvent_OnActivate_Statics::NewProp_Controller,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UNarrativeEvent_OnActivate_Statics::NewProp_NarrativeComponent,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UNarrativeEvent_OnActivate_Statics::PropPointers) < 2048);
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UNarrativeEvent_OnActivate_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UNarrativeEvent, nullptr, "OnActivate", nullptr, nullptr, Z_Construct_UFunction_UNarrativeEvent_OnActivate_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UNarrativeEvent_OnActivate_Statics::PropPointers), sizeof(NarrativeEvent_eventOnActivate_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x08020C00, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UNarrativeEvent_OnActivate_Statics::Function_MetaDataParams), Z_Construct_UFunction_UNarrativeEvent_OnActivate_Statics::Function_MetaDataParams) };
static_assert(sizeof(NarrativeEvent_eventOnActivate_Parms) < MAX_uint16);
UFunction* Z_Construct_UFunction_UNarrativeEvent_OnActivate()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UNarrativeEvent_OnActivate_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(UNarrativeEvent::execOnActivate)
{
	P_GET_OBJECT(APawn,Z_Param_Target);
	P_GET_OBJECT(APlayerController,Z_Param_Controller);
	P_GET_OBJECT(UTalesComponent,Z_Param_NarrativeComponent);
	P_FINISH;
	P_NATIVE_BEGIN;
	P_THIS->OnActivate_Implementation(Z_Param_Target,Z_Param_Controller,Z_Param_NarrativeComponent);
	P_NATIVE_END;
}
// End Class UNarrativeEvent Function OnActivate

// Begin Class UNarrativeEvent Function OnDeactivate
struct NarrativeEvent_eventOnDeactivate_Parms
{
	APawn* Target;
	APlayerController* Controller;
	UTalesComponent* NarrativeComponent;
};
static const FName NAME_UNarrativeEvent_OnDeactivate = FName(TEXT("OnDeactivate"));
void UNarrativeEvent::OnDeactivate(APawn* Target, APlayerController* Controller, UTalesComponent* NarrativeComponent)
{
	UFunction* Func = FindFunctionChecked(NAME_UNarrativeEvent_OnDeactivate);
	if (!Func->GetOwnerClass()->HasAnyClassFlags(CLASS_Native))
	{
		NarrativeEvent_eventOnDeactivate_Parms Parms;
		Parms.Target=Target;
		Parms.Controller=Controller;
		Parms.NarrativeComponent=NarrativeComponent;
	ProcessEvent(Func,&Parms);
	...
	{
		OnDeactivate_Implementation(Target, Controller, NarrativeComponent);
	}
}
struct Z_Construct_UFunction_UNarrativeEvent_OnDeactivate_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[] = {
		{ "Category", "Event" },
...
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UNarrativeEvent_OnDeactivate_Statics::NewProp_Target = { "Target", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(NarrativeEvent_eventOnDeactivate_Parms, Target), Z_Construct_UClass_APawn_NoRegister, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UNarrativeEvent_OnDeactivate_Statics::NewProp_Controller = { "Controller", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(NarrativeEvent_eventOnDeactivate_Parms, Controller), Z_Construct_UClass_APlayerController_NoRegister, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UNarrativeEvent_OnDeactivate_Statics::NewProp_NarrativeComponent = { "NarrativeComponent", nullptr, (EPropertyFlags)0x0010000000080080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(NarrativeEvent_eventOnDeactivate_Parms, NarrativeComponent), Z_Construct_UClass_UTalesComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_NarrativeComponent_MetaData), NewProp_NarrativeComponent_MetaData) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UNarrativeEvent_OnDeactivate_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UNarrativeEvent_OnDeactivate_Statics::NewProp_Target,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UNarrativeEvent_OnDeactivate_Statics::NewProp_Controller,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UNarrativeEvent_OnDeactivate_Statics::NewProp_NarrativeComponent,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UNarrativeEvent_OnDeactivate_Statics::PropPointers) < 2048);
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UNarrativeEvent_OnDeactivate_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UNarrativeEvent, nullptr, "OnDeactivate", nullptr, nullptr, Z_Construct_UFunction_UNarrativeEvent_OnDeactivate_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UNarrativeEvent_OnDeactivate_Statics::PropPointers), sizeof(NarrativeEvent_eventOnDeactivate_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x08020C00, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UNarrativeEvent_OnDeactivate_Statics::Function_MetaDataParams), Z_Construct_UFunction_UNarrativeEvent_OnDeactivate_Statics::Function_MetaDataParams) };
static_assert(sizeof(NarrativeEvent_eventOnDeactivate_Parms) < MAX_uint16);
UFunction* Z_Construct_UFunction_UNarrativeEvent_OnDeactivate()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UNarrativeEvent_OnDeactivate_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(UNarrativeEvent::execOnDeactivate)
{
	P_GET_OBJECT(APawn,Z_Param_Target);
	P_GET_OBJECT(APlayerController,Z_Param_Controller);
	P_GET_OBJECT(UTalesComponent,Z_Param_NarrativeComponent);
	P_FINISH;
	P_NATIVE_BEGIN;
	P_THIS->OnDeactivate_Implementation(Z_Param_Target,Z_Param_Controller,Z_Param_NarrativeComponent);
	P_NATIVE_END;
}
// End Class UNarrativeEvent Function OnDeactivate
...
void UNarrativeEvent::StaticRegisterNativesUNarrativeEvent()
{
	...
	static const FNameNativePtrPair Funcs[] = {
		...
		{ "OnActivate", &UNarrativeEvent::execOnActivate },
		{ "OnDeactivate", &UNarrativeEvent::execOnDeactivate },
	};
...
struct Z_Construct_UClass_UNarrativeEvent_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_Conditions_Inner_MetaData[] = {
		...
		{ "Comment", "/**\n\x09This event will only fire if the following conditions are met \n\x09*/" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "Public/Tales/NarrativeEvent.h" },
		{ "ToolTip", "This event will only fire if the following conditions are met" },
	};
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_UNarrativeEvent_ExecuteEvent, "ExecuteEvent" }, // 2151933075
		...
		{ &Z_Construct_UFunction_UNarrativeEvent_OnActivate, "OnActivate" }, // 274996666
		{ &Z_Construct_UFunction_UNarrativeEvent_OnDeactivate, "OnDeactivate" }, // 993728438
	};
...
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UNarrativeEvent_Statics::NewProp_Conditions_Inner = { "Conditions", nullptr, (EPropertyFlags)0x0002000000080008, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UClass_UNarrativeCondition_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_Conditions_Inner_MetaData), NewProp_Conditions_Inner_MetaData) };
const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UNarrativeEvent_Statics::NewProp_Conditions = { "Conditions", nullptr, (EPropertyFlags)0x001000800000001d, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNarrativeEvent, Conditions), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_Conditions_MetaData), NewProp_Conditions_MetaData) };
...
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UNarrativeEvent_Statics::PropPointers[] = {
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UNarrativeEvent_Statics::NewProp_Conditions_Inner,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UNarrativeEvent_Statics::NewProp_Conditions,
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeArsenal_Public_Tales_NarrativeEvent_h_Statics
{
	...
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UNarrativeEvent, UNarrativeEvent::StaticClass, TEXT("UNarrativeEvent"), &Z_Registration_Info_UClass_UNarrativeEvent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNarrativeEvent), 3641777742U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeArsenal_Public_Tales_NarrativeEvent_h_1045131859(TEXT("/Script/NarrativeArsenal"),
	Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeArsenal_Public_Tales_NarrativeEvent_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeArsenal_Public_Tales_NarrativeEvent_h_Statics::ClassInfo),
	nullptr, 0,
	Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeArsenal_Public_Tales_NarrativeEvent_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeArsenal_Public_Tales_NarrativeEvent_h_Statics::EnumInfo));
// End Registration
