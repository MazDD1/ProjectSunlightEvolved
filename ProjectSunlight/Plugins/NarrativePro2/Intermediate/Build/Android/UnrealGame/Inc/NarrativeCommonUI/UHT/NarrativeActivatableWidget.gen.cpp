...
struct Z_Construct_UClass_UNarrativeActivatableWidget_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_BlockTags_MetaData[] = {
		{ "Category", "Narrative Activatable Widget" },
		{ "Comment", "//If owner has any of these tags we'll block the widget from being added to the GameplayHUD. \n" },
		{ "ModuleRelativePath", "Public/NarrativeActivatableWidget.h" },
		{ "ToolTip", "If owner has any of these tags we'll block the widget from being added to the GameplayHUD." },
	};
...
const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UNarrativeActivatableWidget_Statics::NewProp_BlockTags = { "BlockTags", nullptr, (EPropertyFlags)0x0020080000010015, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNarrativeActivatableWidget, BlockTags), Z_Construct_UScriptStruct_FGameplayTagContainer, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_BlockTags_MetaData), NewProp_BlockTags_MetaData) }; // 3352185621
...
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UNarrativeActivatableWidget_Statics::NewProp_bUseGameInput = { "bUseGameInput", nullptr, (EPropertyFlags)0x0020080000010015, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UNarrativeActivatableWidget), &Z_Construct_UClass_UNarrativeActivatableWidget_Statics::NewProp_bUseGameInput_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_bUseGameInput_MetaData), NewProp_bUseGameInput_MetaData) };
...
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UNarrativeActivatableWidget_Statics::NewProp_bDeactivateOnBack = { "bDeactivateOnBack", nullptr, (EPropertyFlags)0x0020080000010015, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UNarrativeActivatableWidget), &Z_Construct_UClass_UNarrativeActivatableWidget_Statics::NewProp_bDeactivateOnBack_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_bDeactivateOnBack_MetaData), NewProp_bDeactivateOnBack_MetaData) };
...
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UNarrativeActivatableWidget_Statics::NewProp_bFocusDesiredTargetOnActivate = { "bFocusDesiredTargetOnActivate", nullptr, (EPropertyFlags)0x0020080000010015, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UNarrativeActivatableWidget), &Z_Construct_UClass_UNarrativeActivatableWidget_Statics::NewProp_bFocusDesiredTargetOnActivate_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_bFocusDesiredTargetOnActivate_MetaData), NewProp_bFocusDesiredTargetOnActivate_MetaData) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UNarrativeActivatableWidget_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UNarrativeActivatableWidget_Statics::NewProp_BlockTags,
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeCommonUI_Public_NarrativeActivatableWidget_h_Statics
{
	...
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UNarrativeActivatableWidget, UNarrativeActivatableWidget::StaticClass, TEXT("UNarrativeActivatableWidget"), &Z_Registration_Info_UClass_UNarrativeActivatableWidget, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNarrativeActivatableWidget), 3594335105U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeCommonUI_Public_NarrativeActivatableWidget_h_4180325588(TEXT("/Script/NarrativeCommonUI"),
	Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeCommonUI_Public_NarrativeActivatableWidget_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeCommonUI_Public_NarrativeActivatableWidget_h_Statics::ClassInfo),
	Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeCommonUI_Public_NarrativeActivatableWidget_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeCommonUI_Public_NarrativeActivatableWidget_h_Statics::ScriptStructInfo),
	nullptr, 0);
// End Registration
