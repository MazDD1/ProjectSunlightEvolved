...
struct Z_Construct_UClass_UNPCDefinition_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_MinLevel_MetaData[] = {
		...
		{ "ClampMax", "5000" },
		{ "ClampMin", "1" },
		{ "Comment", "/** The NPCs level will not be lower than this value */" },
		{ "ModuleRelativePath", "Public/AI/NPCDefinition.h" },
		{ "ToolTip", "The NPCs level will not be lower than this value" },
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_MaxLevel_MetaData[] = {
		{ "Category", "NPC" },
		{ "ClampMax", "5000" },
		{ "ClampMin", "1" },
		{ "Comment", "/** The NPCs level will not be higher than this value */" },
		{ "ModuleRelativePath", "Public/AI/NPCDefinition.h" },
		{ "ToolTip", "The NPCs level will not be higher than this value" },
	};
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_TaggedDialogueSet_MetaData[] = {
		{ "AssetBundles", "SpawnedData" },
		{ "Category", "Dialogue" },
		{ "Comment", "/** The NPCs tagged dialogues - usually free movement dialopgues that can be kicked off via a tag \"TaggedDialogue.Taunt, TaggedDialogue.Greet, etc. */" },
		{ "ModuleRelativePath", "Public/AI/NPCDefinition.h" },
		{ "ToolTip", "The NPCs tagged dialogues - usually free movement dialopgues that can be kicked off via a tag \"TaggedDialogue.Taunt, TaggedDialogue.Greet, etc." },
	};
	...
	static const UECodeGen_Private::FSoftObjectPropertyParams NewProp_TaggedDialogueSet;
...
const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UNPCDefinition_Statics::NewProp_MinLevel = { "MinLevel", nullptr, (EPropertyFlags)0x0010000000000015, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNPCDefinition, MinLevel), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_MinLevel_MetaData), NewProp_MinLevel_MetaData) };
const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UNPCDefinition_Statics::NewProp_MaxLevel = { "MaxLevel", nullptr, (EPropertyFlags)0x0010000000000015, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNPCDefinition, MaxLevel), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_MaxLevel_MetaData), NewProp_MaxLevel_MetaData) };
...
const UECodeGen_Private::FSoftObjectPropertyParams Z_Construct_UClass_UNPCDefinition_Statics::NewProp_TaggedDialogueSet = { "TaggedDialogueSet", nullptr, (EPropertyFlags)0x0014000000000015, UECodeGen_Private::EPropertyGenFlags::SoftObject, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNPCDefinition, TaggedDialogueSet), Z_Construct_UClass_UTaggedDialogueSet_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_TaggedDialogueSet_MetaData), NewProp_TaggedDialogueSet_MetaData) };
...
const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UNPCDefinition_Statics::NewProp_ActivitySchedules = { "ActivitySchedules", nullptr, (EPropertyFlags)0x0014000000000014, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNPCDefinition, ActivitySchedules), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_ActivitySchedules_MetaData), NewProp_ActivitySchedules_MetaData) };
...
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UNPCDefinition_Statics::PropPointers[] = {
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UNPCDefinition_Statics::NewProp_MinLevel,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UNPCDefinition_Statics::NewProp_MaxLevel,
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UNPCDefinition_Statics::NewProp_TaggedDialogueSet,
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UNPCDefinition_Statics::NewProp_ActivitySchedules_Inner,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UNPCDefinition_Statics::NewProp_ActivitySchedules,
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeArsenal_Public_AI_NPCDefinition_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UNPCDefinition, UNPCDefinition::StaticClass, TEXT("UNPCDefinition"), &Z_Registration_Info_UClass_UNPCDefinition, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNPCDefinition), 4075325141U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeArsenal_Public_AI_NPCDefinition_h_3406277623(TEXT("/Script/NarrativeArsenal"),
	Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeArsenal_Public_AI_NPCDefinition_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeArsenal_Public_AI_NPCDefinition_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
