...
// Begin Class UNarrativeInteractionComponent Function HasOccupiedInteractable
struct Z_Construct_UFunction_UNarrativeInteractionComponent_HasOccupiedInteractable_Statics
{
	struct NarrativeInteractionComponent_eventHasOccupiedInteractable_Parms
	{
		bool ReturnValue;
	};
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[] = {
		{ "Category", "Narrative|NarrativeCharacter|Interaction" },
		{ "Comment", "//Return true if we're occuping an interactable currently, such as a seat. \n" },
		{ "ModuleRelativePath", "Public/Interaction/InteractionComponent.h" },
		{ "ToolTip", "Return true if we're occuping an interactable currently, such as a seat." },
	};
#endif // WITH_METADATA
	static void NewProp_ReturnValue_SetBit(void* Obj);
	static const UECodeGen_Private::FBoolPropertyParams NewProp_ReturnValue;
...
void Z_Construct_UFunction_UNarrativeInteractionComponent_HasOccupiedInteractable_Statics::NewProp_ReturnValue_SetBit(void* Obj)
{
	((NarrativeInteractionComponent_eventHasOccupiedInteractable_Parms*)Obj)->ReturnValue = 1;
}
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UNarrativeInteractionComponent_HasOccupiedInteractable_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(NarrativeInteractionComponent_eventHasOccupiedInteractable_Parms), &Z_Construct_UFunction_UNarrativeInteractionComponent_HasOccupiedInteractable_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UNarrativeInteractionComponent_HasOccupiedInteractable_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UNarrativeInteractionComponent_HasOccupiedInteractable_Statics::NewProp_ReturnValue,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UNarrativeInteractionComponent_HasOccupiedInteractable_Statics::PropPointers) < 2048);
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UNarrativeInteractionComponent_HasOccupiedInteractable_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UNarrativeInteractionComponent, nullptr, "HasOccupiedInteractable", nullptr, nullptr, Z_Construct_UFunction_UNarrativeInteractionComponent_HasOccupiedInteractable_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UNarrativeInteractionComponent_HasOccupiedInteractable_Statics::PropPointers), sizeof(Z_Construct_UFunction_UNarrativeInteractionComponent_HasOccupiedInteractable_Statics::NarrativeInteractionComponent_eventHasOccupiedInteractable_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UNarrativeInteractionComponent_HasOccupiedInteractable_Statics::Function_MetaDataParams), Z_Construct_UFunction_UNarrativeInteractionComponent_HasOccupiedInteractable_Statics::Function_MetaDataParams) };
static_assert(sizeof(Z_Construct_UFunction_UNarrativeInteractionComponent_HasOccupiedInteractable_Statics::NarrativeInteractionComponent_eventHasOccupiedInteractable_Parms) < MAX_uint16);
UFunction* Z_Construct_UFunction_UNarrativeInteractionComponent_HasOccupiedInteractable()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UNarrativeInteractionComponent_HasOccupiedInteractable_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(UNarrativeInteractionComponent::execHasOccupiedInteractable)
{
	P_FINISH;
	P_NATIVE_BEGIN;
	*(bool*)Z_Param__Result=P_THIS->HasOccupiedInteractable();
	P_NATIVE_END;
}
// End Class UNarrativeInteractionComponent Function HasOccupiedInteractable
...
void UNarrativeInteractionComponent::StaticRegisterNativesUNarrativeInteractionComponent()
{
	...
	static const FNameNativePtrPair Funcs[] = {
		...
		{ "HasOccupiedInteractable", &UNarrativeInteractionComponent::execHasOccupiedInteractable },
...
struct Z_Construct_UClass_UNarrativeInteractionComponent_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_OccupiedInteractableSoftOwner_MetaData[] = {
		{ "Category", "Narrative|NarrativeCharacter|Interaction" },
		{ "Comment", "//Soft ref of the owner so we can restore when the game loads back in\n" },
		{ "ModuleRelativePath", "Public/Interaction/InteractionComponent.h" },
		{ "ToolTip", "Soft ref of the owner so we can restore when the game loads back in" },
	};
	...
	static const UECodeGen_Private::FSoftObjectPropertyParams NewProp_OccupiedInteractableSoftOwner;
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_UNarrativeInteractionComponent_HasOccupiedInteractable, "HasOccupiedInteractable" }, // 834544124
...
const UECodeGen_Private::FSoftObjectPropertyParams Z_Construct_UClass_UNarrativeInteractionComponent_Statics::NewProp_OccupiedInteractableSoftOwner = { "OccupiedInteractableSoftOwner", nullptr, (EPropertyFlags)0x0024080001000004, UECodeGen_Private::EPropertyGenFlags::SoftObject, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNarrativeInteractionComponent, OccupiedInteractableSoftOwner), Z_Construct_UClass_AActor_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_OccupiedInteractableSoftOwner_MetaData), NewProp_OccupiedInteractableSoftOwner_MetaData) };
...
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UNarrativeInteractionComponent_Statics::PropPointers[] = {
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UNarrativeInteractionComponent_Statics::NewProp_OccupiedInteractableSoftOwner,
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeArsenal_Public_Interaction_InteractionComponent_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UNarrativeInteractionComponent, UNarrativeInteractionComponent::StaticClass, TEXT("UNarrativeInteractionComponent"), &Z_Registration_Info_UClass_UNarrativeInteractionComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNarrativeInteractionComponent), 926430022U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeArsenal_Public_Interaction_InteractionComponent_h_3761191519(TEXT("/Script/NarrativeArsenal"),
	Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeArsenal_Public_Interaction_InteractionComponent_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeArsenal_Public_Interaction_InteractionComponent_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
