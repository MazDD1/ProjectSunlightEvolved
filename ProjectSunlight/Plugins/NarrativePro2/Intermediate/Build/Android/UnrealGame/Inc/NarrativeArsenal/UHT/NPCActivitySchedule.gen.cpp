...
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UScheduledBehavior_AddNPCGoal_Statics::NewProp_ActiveGoal = { "ActiveGoal", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UScheduledBehavior_AddNPCGoal, ActiveGoal), Z_Construct_UClass_UNPCGoalItem_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_ActiveGoal_MetaData), NewProp_ActiveGoal_MetaData) };
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeArsenal_Public_AI_Activities_NPCActivitySchedule_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UScheduledBehavior_NPC, UScheduledBehavior_NPC::StaticClass, TEXT("UScheduledBehavior_NPC"), &Z_Registration_Info_UClass_UScheduledBehavior_NPC, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UScheduledBehavior_NPC), 2579126386U) },
		{ Z_Construct_UClass_UScheduledBehavior_AddNPCGoal, UScheduledBehavior_AddNPCGoal::StaticClass, TEXT("UScheduledBehavior_AddNPCGoal"), &Z_Registration_Info_UClass_UScheduledBehavior_AddNPCGoal, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UScheduledBehavior_AddNPCGoal), 943980184U) },
...
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeArsenal_Public_AI_Activities_NPCActivitySchedule_h_3596909535(TEXT("/Script/NarrativeArsenal"),
	Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeArsenal_Public_AI_Activities_NPCActivitySchedule_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeArsenal_Public_AI_Activities_NPCActivitySchedule_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
