...
struct Z_Construct_UClass_UEquippableItem_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_EquipmentModGE_MetaData[] = {
		{ "Category", "Item - Equippable" },
		{ "Comment", "// Gameplay effect to apply when the item is equipped, removed when item is taken off. \n" },
		{ "ModuleRelativePath", "Public/Items/EquippableItem.h" },
		{ "ToolTip", "Gameplay effect to apply when the item is equipped, removed when item is taken off." },
	};
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_StealthRating_MetaData[] = {
		{ "Category", "Item - Equippable" },
		{ "Comment", "/**The amount we'll increase the wearers stealth rating by when item is equipped  */" },
		{ "ModuleRelativePath", "Public/Items/EquippableItem.h" },
		{ "ToolTip", "The amount we'll increase the wearers stealth rating by when item is equipped" },
	};
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_AIEquipmentScore_MetaData[] = {
		{ "Category", "Item - Equippable | AI" },
		{ "Comment", "/** A value denoting how \"good\" the item is to AI - they will prefer to equip higher score equipment. */" },
		{ "ModuleRelativePath", "Public/Items/EquippableItem.h" },
		{ "ToolTip", "A value denoting how \"good\" the item is to AI - they will prefer to equip higher score equipment." },
	};
#endif // WITH_METADATA
	...
	static const UECodeGen_Private::FFloatPropertyParams NewProp_StealthRating;
	...
	static const UECodeGen_Private::FFloatPropertyParams NewProp_AIEquipmentScore;
...
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UEquippableItem_Statics::NewProp_StealthRating = { "StealthRating", nullptr, (EPropertyFlags)0x0020080000010015, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UEquippableItem, StealthRating), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_StealthRating_MetaData), NewProp_StealthRating_MetaData) };
...
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UEquippableItem_Statics::NewProp_AIEquipmentScore = { "AIEquipmentScore", nullptr, (EPropertyFlags)0x0020080000010015, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UEquippableItem, AIEquipmentScore), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_AIEquipmentScore_MetaData), NewProp_AIEquipmentScore_MetaData) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UEquippableItem_Statics::PropPointers[] = {
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UEquippableItem_Statics::NewProp_StealthRating,
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UEquippableItem_Statics::NewProp_AIEquipmentScore,
};
...
// Begin Class UEquippableItem_Clothing Function ApplyClothingMesh
struct Z_Construct_UFunction_UEquippableItem_Clothing_ApplyClothingMesh_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Public/Items/EquippableItem.h" },
...
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UEquippableItem_Clothing_ApplyClothingMesh_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UEquippableItem_Clothing, nullptr, "ApplyClothingMesh", nullptr, nullptr, nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00080400, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UEquippableItem_Clothing_ApplyClothingMesh_Statics::Function_MetaDataParams), Z_Construct_UFunction_UEquippableItem_Clothing_ApplyClothingMesh_Statics::Function_MetaDataParams) };
UFunction* Z_Construct_UFunction_UEquippableItem_Clothing_ApplyClothingMesh()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UEquippableItem_Clothing_ApplyClothingMesh_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(UEquippableItem_Clothing::execApplyClothingMesh)
{
	P_FINISH;
	P_NATIVE_BEGIN;
	P_THIS->ApplyClothingMesh();
	P_NATIVE_END;
}
// End Class UEquippableItem_Clothing Function ApplyClothingMesh

// Begin Class UEquippableItem_Clothing
void UEquippableItem_Clothing::StaticRegisterNativesUEquippableItem_Clothing()
{
	UClass* Class = UEquippableItem_Clothing::StaticClass();
	static const FNameNativePtrPair Funcs[] = {
		{ "ApplyClothingMesh", &UEquippableItem_Clothing::execApplyClothingMesh },
	};
	FNativeFunctionRegistrar::RegisterFunctions(Class, Funcs, UE_ARRAY_COUNT(Funcs));
}
...
struct Z_Construct_UClass_UEquippableItem_Clothing_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_ClothingMeshData_MetaData[] = {
		{ "Category", "Item - Equippable | Clothing Mesh" },
	...
	static UObject* (*const DependentSingletons[])();
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_UEquippableItem_Clothing_ApplyClothingMesh, "ApplyClothingMesh" }, // 2756414385
	};
	static_assert(UE_ARRAY_COUNT(FuncInfo) < 2048);
	static constexpr FCppClassTypeInfoStatic StaticCppClassTypeInfo = {
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeArsenal_Public_Items_EquippableItem_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UEquippableItem, UEquippableItem::StaticClass, TEXT("UEquippableItem"), &Z_Registration_Info_UClass_UEquippableItem, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UEquippableItem), 2275246582U) },
		{ Z_Construct_UClass_UEquippableItem_Clothing, UEquippableItem_Clothing::StaticClass, TEXT("UEquippableItem_Clothing"), &Z_Registration_Info_UClass_UEquippableItem_Clothing, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UEquippableItem_Clothing), 1219250483U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeArsenal_Public_Items_EquippableItem_h_3469259385(TEXT("/Script/NarrativeArsenal"),
	Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeArsenal_Public_Items_EquippableItem_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeArsenal_Public_Items_EquippableItem_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
