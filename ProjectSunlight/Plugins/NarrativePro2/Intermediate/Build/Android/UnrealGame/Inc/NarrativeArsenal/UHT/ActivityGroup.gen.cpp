...
struct Z_Construct_UClass_UActivityGroup_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_GroupTag_MetaData[] = {
		{ "Category", "Activity Group" },
		{ "Comment", "//An optional tag, can be used to grab the group in case you want to add/remove an activity from it. \n" },
		{ "ModuleRelativePath", "Public/AI/Activities/ActivityGroup.h" },
		{ "ToolTip", "An optional tag, can be used to grab the group in case you want to add/remove an activity from it." },
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_SupportedGoal_MetaData[] = {
		{ "Category", "Activity Group" },
		{ "Comment", "//The goals this group supports. This is useful to \"early out\", ie don't check the group unless we have a goal of this type. \n" },
		{ "ModuleRelativePath", "Public/AI/Activities/ActivityGroup.h" },
		{ "ToolTip", "The goals this group supports. This is useful to \"early out\", ie don't check the group unless we have a goal of this type." },
	};
	...
	static const UECodeGen_Private::FStructPropertyParams NewProp_GroupTag;
	static const UECodeGen_Private::FClassPropertyParams NewProp_SupportedGoal;
...
const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UActivityGroup_Statics::NewProp_GroupTag = { "GroupTag", nullptr, (EPropertyFlags)0x0020080000010001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UActivityGroup, GroupTag), Z_Construct_UScriptStruct_FGameplayTag, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_GroupTag_MetaData), NewProp_GroupTag_MetaData) }; // 1298103297
const UECodeGen_Private::FClassPropertyParams Z_Construct_UClass_UActivityGroup_Statics::NewProp_SupportedGoal = { "SupportedGoal", nullptr, (EPropertyFlags)0x0024080000010001, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UActivityGroup, SupportedGoal), Z_Construct_UClass_UClass, Z_Construct_UClass_UNPCGoalItem_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_SupportedGoal_MetaData), NewProp_SupportedGoal_MetaData) };
...
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UActivityGroup_Statics::PropPointers[] = {
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UActivityGroup_Statics::NewProp_GroupTag,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UActivityGroup_Statics::NewProp_SupportedGoal,
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeArsenal_Public_AI_Activities_ActivityGroup_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UActivityGroup, UActivityGroup::StaticClass, TEXT("UActivityGroup"), &Z_Registration_Info_UClass_UActivityGroup, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UActivityGroup), 471756006U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeArsenal_Public_AI_Activities_ActivityGroup_h_1502294614(TEXT("/Script/NarrativeArsenal"),
	Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeArsenal_Public_AI_Activities_ActivityGroup_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeArsenal_Public_AI_Activities_ActivityGroup_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
