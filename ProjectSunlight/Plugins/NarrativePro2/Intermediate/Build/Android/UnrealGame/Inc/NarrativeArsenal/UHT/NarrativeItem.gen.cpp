...
#include "NarrativeArsenal/Public/Items/NarrativeItem.h"
...
NARRATIVEARSENAL_API UClass* Z_Construct_UClass_UNarrativeInventoryItemButton_NoRegister();
...
NARRATIVEARSENAL_API UFunction* Z_Construct_UDelegateFunction_NarrativeArsenal_OnItemModified__DelegateSignature();
NARRATIVEARSENAL_API UScriptStruct* Z_Construct_UScriptStruct_FNarrativeItemStat();
UPackage* Z_Construct_UPackage__Script_NarrativeArsenal();
// End Cross Module References

// Begin Delegate FOnItemModified
struct Z_Construct_UDelegateFunction_NarrativeArsenal_OnItemModified__DelegateSignature_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Public/Items/NarrativeItem.h" },
	};
#endif // WITH_METADATA
	static const UECodeGen_Private::FFunctionParams FuncParams;
};
const UECodeGen_Private::FFunctionParams Z_Construct_UDelegateFunction_NarrativeArsenal_OnItemModified__DelegateSignature_Statics::FuncParams = { (UObject*(*)())Z_Construct_UPackage__Script_NarrativeArsenal, nullptr, "OnItemModified__DelegateSignature", nullptr, nullptr, nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00130000, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_NarrativeArsenal_OnItemModified__DelegateSignature_Statics::Function_MetaDataParams), Z_Construct_UDelegateFunction_NarrativeArsenal_OnItemModified__DelegateSignature_Statics::Function_MetaDataParams) };
UFunction* Z_Construct_UDelegateFunction_NarrativeArsenal_OnItemModified__DelegateSignature()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UDelegateFunction_NarrativeArsenal_OnItemModified__DelegateSignature_Statics::FuncParams);
	}
...
class UScriptStruct* FNarrativeItemStat::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_NarrativeItemStat.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FNarrativeItemStat, (UObject*)Z_Construct_UPackage__Script_NarrativeArsenal(), TEXT("NarrativeItemStat"));
	}
	return Z_Registration_Info_UScriptStruct_NarrativeItemStat.OuterSingleton;
}
template<> NARRATIVEARSENAL_API UScriptStruct* StaticStruct<FNarrativeItemStat>()
{
...
// Begin Class UNarrativeItem Function CanUseItemWith
struct NarrativeItem_eventCanUseItemWith_Parms
{
	UNarrativeItem* TestItem;
	bool ReturnValue;

	/** Constructor, initializes return property only **/
	NarrativeItem_eventCanUseItemWith_Parms()
		: ReturnValue(false)
	{
	}
};
static const FName NAME_UNarrativeItem_CanUseItemWith = FName(TEXT("CanUseItemWith"));
bool UNarrativeItem::CanUseItemWith(UNarrativeItem* TestItem) const
{
	UFunction* Func = FindFunctionChecked(NAME_UNarrativeItem_CanUseItemWith);
	if (!Func->GetOwnerClass()->HasAnyClassFlags(CLASS_Native))
	{
		NarrativeItem_eventCanUseItemWith_Parms Parms;
		Parms.TestItem=TestItem;
		const_cast<UNarrativeItem*>(this)->ProcessEvent(Func,&Parms);
		return !!Parms.ReturnValue;
	}
	else
	{
		return const_cast<UNarrativeItem*>(this)->CanUseItemWith_Implementation(TestItem);
	}
}
struct Z_Construct_UFunction_UNarrativeItem_CanUseItemWith_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[] = {
		{ "Category", "Item | Usage" },
		{ "Comment", "//If this item has bUsedWithOther item, this function allows us to define which items we'll allow this item to be used on. \n" },
		{ "ModuleRelativePath", "Public/Items/NarrativeItem.h" },
		{ "ToolTip", "If this item has bUsedWithOther item, this function allows us to define which items we'll allow this item to be used on." },
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_TestItem_MetaData[] = {
		{ "EditInline", "true" },
	};
#endif // WITH_METADATA
...
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UNarrativeItem_CanUseItemWith_Statics::NewProp_TestItem = { "TestItem", nullptr, (EPropertyFlags)0x0010000000080080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(NarrativeItem_eventCanUseItemWith_Parms, TestItem), Z_Construct_UClass_UNarrativeItem_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_TestItem_MetaData), NewProp_TestItem_MetaData) };
void Z_Construct_UFunction_UNarrativeItem_CanUseItemWith_Statics::NewProp_ReturnValue_SetBit(void* Obj)
{
	((NarrativeItem_eventCanUseItemWith_Parms*)Obj)->ReturnValue = 1;
}
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UNarrativeItem_CanUseItemWith_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(NarrativeItem_eventCanUseItemWith_Parms), &Z_Construct_UFunction_UNarrativeItem_CanUseItemWith_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UNarrativeItem_CanUseItemWith_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UNarrativeItem_CanUseItemWith_Statics::NewProp_TestItem,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UNarrativeItem_CanUseItemWith_Statics::NewProp_ReturnValue,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UNarrativeItem_CanUseItemWith_Statics::PropPointers) < 2048);
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UNarrativeItem_CanUseItemWith_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UNarrativeItem, nullptr, "CanUseItemWith", nullptr, nullptr, Z_Construct_UFunction_UNarrativeItem_CanUseItemWith_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UNarrativeItem_CanUseItemWith_Statics::PropPointers), sizeof(NarrativeItem_eventCanUseItemWith_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x5C020C00, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UNarrativeItem_CanUseItemWith_Statics::Function_MetaDataParams), Z_Construct_UFunction_UNarrativeItem_CanUseItemWith_Statics::Function_MetaDataParams) };
static_assert(sizeof(NarrativeItem_eventCanUseItemWith_Parms) < MAX_uint16);
UFunction* Z_Construct_UFunction_UNarrativeItem_CanUseItemWith()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UNarrativeItem_CanUseItemWith_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(UNarrativeItem::execCanUseItemWith)
{
	P_GET_OBJECT(UNarrativeItem,Z_Param_TestItem);
	P_FINISH;
	P_NATIVE_BEGIN;
	*(bool*)Z_Param__Result=P_THIS->CanUseItemWith_Implementation(Z_Param_TestItem);
	P_NATIVE_END;
}
// End Class UNarrativeItem Function CanUseItemWith
...
struct NarrativeItem_eventOnUse_Parms
{
	UNarrativeItem* OtherItem;
};
static const FName NAME_UNarrativeItem_OnUse = FName(TEXT("OnUse"));
void UNarrativeItem::OnUse(UNarrativeItem* OtherItem)
{
	NarrativeItem_eventOnUse_Parms Parms;
...
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UNarrativeItem_OnUse_Statics::NewProp_OtherItem = { "OtherItem", nullptr, (EPropertyFlags)0x0010000000080080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(NarrativeItem_eventOnUse_Parms, OtherItem), Z_Construct_UClass_UNarrativeItem_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_OtherItem_MetaData), NewProp_OtherItem_MetaData) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UNarrativeItem_OnUse_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UNarrativeItem_OnUse_Statics::NewProp_OtherItem,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UNarrativeItem_OnUse_Statics::PropPointers) < 2048);
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UNarrativeItem_OnUse_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UNarrativeItem, nullptr, "OnUse", nullptr, nullptr, Z_Construct_UFunction_UNarrativeItem_OnUse_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UNarrativeItem_OnUse_Statics::PropPointers), sizeof(NarrativeItem_eventOnUse_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x08020800, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UNarrativeItem_OnUse_Statics::Function_MetaDataParams), Z_Construct_UFunction_UNarrativeItem_OnUse_Statics::Function_MetaDataParams) };
static_assert(sizeof(NarrativeItem_eventOnUse_Parms) < MAX_uint16);
...
// Begin Class UNarrativeItem Function SetBusy
struct Z_Construct_UFunction_UNarrativeItem_SetBusy_Statics
{
	struct NarrativeItem_eventSetBusy_Parms
	{
		bool bNewBusy;
	};
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[] = {
		{ "Category", "Item" },
		{ "Comment", "/**Sets whether the item is considered \"Busy\". By default, this will show a loading icon and will prevent the item from being used. \n\x09You'd generally use this when an item needs to load some assets, like a clothing mesh, weapon item, etc and you need the player to visually see that in the UI. */" },
		{ "ModuleRelativePath", "Public/Items/NarrativeItem.h" },
		{ "ToolTip", "Sets whether the item is considered \"Busy\". By default, this will show a loading icon and will prevent the item from being used.\n       You'd generally use this when an item needs to load some assets, like a clothing mesh, weapon item, etc and you need the player to visually see that in the UI." },
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_bNewBusy_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif // WITH_METADATA
	static void NewProp_bNewBusy_SetBit(void* Obj);
	static const UECodeGen_Private::FBoolPropertyParams NewProp_bNewBusy;
	static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
	static const UECodeGen_Private::FFunctionParams FuncParams;
};
void Z_Construct_UFunction_UNarrativeItem_SetBusy_Statics::NewProp_bNewBusy_SetBit(void* Obj)
{
	((NarrativeItem_eventSetBusy_Parms*)Obj)->bNewBusy = 1;
}
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UNarrativeItem_SetBusy_Statics::NewProp_bNewBusy = { "bNewBusy", nullptr, (EPropertyFlags)0x0010000000000082, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(NarrativeItem_eventSetBusy_Parms), &Z_Construct_UFunction_UNarrativeItem_SetBusy_Statics::NewProp_bNewBusy_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_bNewBusy_MetaData), NewProp_bNewBusy_MetaData) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UNarrativeItem_SetBusy_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UNarrativeItem_SetBusy_Statics::NewProp_bNewBusy,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UNarrativeItem_SetBusy_Statics::PropPointers) < 2048);
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UNarrativeItem_SetBusy_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UNarrativeItem, nullptr, "SetBusy", nullptr, nullptr, Z_Construct_UFunction_UNarrativeItem_SetBusy_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UNarrativeItem_SetBusy_Statics::PropPointers), sizeof(Z_Construct_UFunction_UNarrativeItem_SetBusy_Statics::NarrativeItem_eventSetBusy_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UNarrativeItem_SetBusy_Statics::Function_MetaDataParams), Z_Construct_UFunction_UNarrativeItem_SetBusy_Statics::Function_MetaDataParams) };
static_assert(sizeof(Z_Construct_UFunction_UNarrativeItem_SetBusy_Statics::NarrativeItem_eventSetBusy_Parms) < MAX_uint16);
UFunction* Z_Construct_UFunction_UNarrativeItem_SetBusy()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UNarrativeItem_SetBusy_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(UNarrativeItem::execSetBusy)
{
	P_GET_UBOOL(Z_Param_bNewBusy);
	P_FINISH;
	P_NATIVE_BEGIN;
	P_THIS->SetBusy(Z_Param_bNewBusy);
	P_NATIVE_END;
}
// End Class UNarrativeItem Function SetBusy
...
void UNarrativeItem::StaticRegisterNativesUNarrativeItem()
{
	...
	static const FNameNativePtrPair Funcs[] = {
		...
		{ "CanUseItemWith", &UNarrativeItem::execCanUseItemWith },
		...
		{ "SetBusy", &UNarrativeItem::execSetBusy },
...
struct Z_Construct_UClass_UNarrativeItem_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam Class_MetaDataParams[] = {
		...
		{ "IncludePath", "Items/NarrativeItem.h" },
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_ItemWidgetOverride_MetaData[] = {
		{ "Category", "Item | UI" },
		{ "Comment", "/** The inventory item button we should spawn for this item if it requires one. If none we'll just use the default item button. */" },
		{ "ModuleRelativePath", "Public/Items/NarrativeItem.h" },
		{ "ToolTip", "The inventory item button we should spawn for this item if it requires one. If none we'll just use the default item button." },
	};
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_bUsedWithOtherItem_MetaData[] = {
		{ "Category", "Item | Usage" },
		{ "Comment", "/**If true, using this item will open a prompt asking which other item you'd like to use it on. All items passing CanUseItemWith() will be shown. */" },
		{ "ModuleRelativePath", "Public/Items/NarrativeItem.h" },
		{ "ToolTip", "If true, using this item will open a prompt asking which other item you'd like to use it on. All items passing CanUseItemWith() will be shown." },
	};
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_bIsBusy_MetaData[] = {
		{ "Category", "Item | General" },
		{ "Comment", "/**Whether or not this item is busy*/" },
		{ "ModuleRelativePath", "Public/Items/NarrativeItem.h" },
		{ "ToolTip", "Whether or not this item is busy" },
	};
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_bWantsTickByDefault_MetaData[] = {
		{ "AdvancedDisplay", "" },
		{ "Category", "Item | General" },
		{ "Comment", "/**Whether the item requires TickItem() to be called. */" },
		{ "ModuleRelativePath", "Public/Items/NarrativeItem.h" },
		{ "ToolTip", "Whether the item requires TickItem() to be called." },
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_ActivitiesToGrant_MetaData[] = {
		{ "Category", "Item | AI" },
		{ "Comment", "/** AI that acquire this item will have these activities added to themselves whilst they have the item.  */" },
		{ "ModuleRelativePath", "Public/Items/NarrativeItem.h" },
		{ "ToolTip", "AI that acquire this item will have these activities added to themselves whilst they have the item." },
	};
	...
	static const UECodeGen_Private::FClassPropertyParams NewProp_ItemWidgetOverride;
	...
	static void NewProp_bUsedWithOtherItem_SetBit(void* Obj);
	static const UECodeGen_Private::FBoolPropertyParams NewProp_bUsedWithOtherItem;
	...
	static void NewProp_bWantsTickByDefault_SetBit(void* Obj);
	static const UECodeGen_Private::FBoolPropertyParams NewProp_bWantsTickByDefault;
	static const UECodeGen_Private::FClassPropertyParams NewProp_ActivitiesToGrant_Inner;
	static const UECodeGen_Private::FArrayPropertyParams NewProp_ActivitiesToGrant;
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_UNarrativeItem_Activated, "Activated" }, // 4039458498
		{ &Z_Construct_UFunction_UNarrativeItem_CanBeRemoved, "CanBeRemoved" }, // 3199870621
		{ &Z_Construct_UFunction_UNarrativeItem_CanUse, "CanUse" }, // 2289922876
		{ &Z_Construct_UFunction_UNarrativeItem_CanUseItemWith, "CanUseItemWith" }, // 2092047302
		{ &Z_Construct_UFunction_UNarrativeItem_Deactivated, "Deactivated" }, // 3563248764
		{ &Z_Construct_UFunction_UNarrativeItem_GetLastUseTime, "GetLastUseTime" }, // 77567540
		{ &Z_Construct_UFunction_UNarrativeItem_GetMaxStackSize, "GetMaxStackSize" }, // 2236105105
		{ &Z_Construct_UFunction_UNarrativeItem_GetOwningController, "GetOwningController" }, // 23182707
		{ &Z_Construct_UFunction_UNarrativeItem_GetOwningPawn, "GetOwningPawn" }, // 3058452616
		{ &Z_Construct_UFunction_UNarrativeItem_GetParsedDescription, "GetParsedDescription" }, // 2629448622
		{ &Z_Construct_UFunction_UNarrativeItem_GetQuantity, "GetQuantity" }, // 2871091969
		{ &Z_Construct_UFunction_UNarrativeItem_GetRawDescription, "GetRawDescription" }, // 1782418268
		{ &Z_Construct_UFunction_UNarrativeItem_GetStackSpace, "GetStackSpace" }, // 4195837678
		{ &Z_Construct_UFunction_UNarrativeItem_GetStackWeight, "GetStackWeight" }, // 3963287977
		{ &Z_Construct_UFunction_UNarrativeItem_GetStringVariable, "GetStringVariable" }, // 2999575645
		{ &Z_Construct_UFunction_UNarrativeItem_IsStackFull, "IsStackFull" }, // 1355619716
		{ &Z_Construct_UFunction_UNarrativeItem_MarkDirtyForReplication, "MarkDirtyForReplication" }, // 3139741914
		{ &Z_Construct_UFunction_UNarrativeItem_OnRep_bActive, "OnRep_bActive" }, // 2864530617
		{ &Z_Construct_UFunction_UNarrativeItem_OnRep_Quantity, "OnRep_Quantity" }, // 844107891
		{ &Z_Construct_UFunction_UNarrativeItem_OnUse, "OnUse" }, // 4270539848
		{ &Z_Construct_UFunction_UNarrativeItem_SetActive, "SetActive" }, // 3501241968
		{ &Z_Construct_UFunction_UNarrativeItem_SetBusy, "SetBusy" }, // 2579341331
		{ &Z_Construct_UFunction_UNarrativeItem_SetLastUseTime, "SetLastUseTime" }, // 253862917
		{ &Z_Construct_UFunction_UNarrativeItem_ShouldShowInInventory, "ShouldShowInInventory" }, // 362474645
		{ &Z_Construct_UFunction_UNarrativeItem_ShouldUseOnAdd, "ShouldUseOnAdd" }, // 1190272342
	};
...
const UECodeGen_Private::FClassPropertyParams Z_Construct_UClass_UNarrativeItem_Statics::NewProp_ItemWidgetOverride = { "ItemWidgetOverride", nullptr, (EPropertyFlags)0x0014000000010005, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNarrativeItem, ItemWidgetOverride), Z_Construct_UClass_UClass, Z_Construct_UClass_UNarrativeInventoryItemButton_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_ItemWidgetOverride_MetaData), NewProp_ItemWidgetOverride_MetaData) };
...
void Z_Construct_UClass_UNarrativeItem_Statics::NewProp_bUsedWithOtherItem_SetBit(void* Obj)
{
	((UNarrativeItem*)Obj)->bUsedWithOtherItem = 1;
}
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UNarrativeItem_Statics::NewProp_bUsedWithOtherItem = { "bUsedWithOtherItem", nullptr, (EPropertyFlags)0x0010000000010005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UNarrativeItem), &Z_Construct_UClass_UNarrativeItem_Statics::NewProp_bUsedWithOtherItem_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_bUsedWithOtherItem_MetaData), NewProp_bUsedWithOtherItem_MetaData) };
...
void Z_Construct_UClass_UNarrativeItem_Statics::NewProp_bIsBusy_SetBit(void* Obj)
{
	((UNarrativeItem*)Obj)->bIsBusy = 1;
}
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UNarrativeItem_Statics::NewProp_bIsBusy = { "bIsBusy", nullptr, (EPropertyFlags)0x0010000000000004, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UNarrativeItem), &Z_Construct_UClass_UNarrativeItem_Statics::NewProp_bIsBusy_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_bIsBusy_MetaData), NewProp_bIsBusy_MetaData) };
...
void Z_Construct_UClass_UNarrativeItem_Statics::NewProp_bWantsTickByDefault_SetBit(void* Obj)
{
	((UNarrativeItem*)Obj)->bWantsTickByDefault = 1;
}
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UNarrativeItem_Statics::NewProp_bWantsTickByDefault = { "bWantsTickByDefault", nullptr, (EPropertyFlags)0x0010000000010005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UNarrativeItem), &Z_Construct_UClass_UNarrativeItem_Statics::NewProp_bWantsTickByDefault_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_bWantsTickByDefault_MetaData), NewProp_bWantsTickByDefault_MetaData) };
const UECodeGen_Private::FClassPropertyParams Z_Construct_UClass_UNarrativeItem_Statics::NewProp_ActivitiesToGrant_Inner = { "ActivitiesToGrant", nullptr, (EPropertyFlags)0x0004000000000000, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UClass_UClass, Z_Construct_UClass_UNPCActivity_NoRegister, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UNarrativeItem_Statics::NewProp_ActivitiesToGrant = { "ActivitiesToGrant", nullptr, (EPropertyFlags)0x0014000000010005, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNarrativeItem, ActivitiesToGrant), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_ActivitiesToGrant_MetaData), NewProp_ActivitiesToGrant_MetaData) };
const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UNarrativeItem_Statics::NewProp_Stats_Inner = { "Stats", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UScriptStruct_FNarrativeItemStat, METADATA_PARAMS(0, nullptr) }; // 2262779437
const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UNarrativeItem_Statics::NewProp_Stats = { "Stats", nullptr, (EPropertyFlags)0x0010000000010005, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNarrativeItem, Stats), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_Stats_MetaData), NewProp_Stats_MetaData) }; // 2262779437
...
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UNarrativeItem_Statics::PropPointers[] = {
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UNarrativeItem_Statics::NewProp_ItemWidgetOverride,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UNarrativeItem_Statics::NewProp_bConsumeOnUse,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UNarrativeItem_Statics::NewProp_bUsedWithOtherItem,
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UNarrativeItem_Statics::NewProp_bIsBusy,
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UNarrativeItem_Statics::NewProp_bWantsTickByDefault,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UNarrativeItem_Statics::NewProp_ActivitiesToGrant_Inner,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UNarrativeItem_Statics::NewProp_ActivitiesToGrant,
...
template<> NARRATIVEARSENAL_API UClass* StaticClass<UNarrativeItem>()
{
	return UNarrativeItem::StaticClass();
}
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeArsenal_Public_Items_NarrativeItem_h_Statics
{
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FNarrativeItemStat::StaticStruct, Z_Construct_UScriptStruct_FNarrativeItemStat_Statics::NewStructOps, TEXT("NarrativeItemStat"), &Z_Registration_Info_UScriptStruct_NarrativeItemStat, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FNarrativeItemStat), 2262779437U) },
	};
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UNarrativeItem, UNarrativeItem::StaticClass, TEXT("UNarrativeItem"), &Z_Registration_Info_UClass_UNarrativeItem, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNarrativeItem), 3021529041U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeArsenal_Public_Items_NarrativeItem_h_195539192(TEXT("/Script/NarrativeArsenal"),
	Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeArsenal_Public_Items_NarrativeItem_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeArsenal_Public_Items_NarrativeItem_h_Statics::ClassInfo),
	Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeArsenal_Public_Items_NarrativeItem_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeArsenal_Public_Items_NarrativeItem_h_Statics::ScriptStructInfo),
	nullptr, 0);
// End Registration
