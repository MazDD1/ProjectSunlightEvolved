...
// Begin ScriptStruct FWeaponAttachmentSlotConfig
static FStructRegistrationInfo Z_Registration_Info_UScriptStruct_WeaponAttachmentSlotConfig;
class UScriptStruct* FWeaponAttachmentSlotConfig::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_WeaponAttachmentSlotConfig.OuterSingleton)
	{
		Z_Registration_Info_UScriptStruct_WeaponAttachmentSlotConfig.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FWeaponAttachmentSlotConfig, (UObject*)Z_Construct_UPackage__Script_NarrativeArsenal(), TEXT("WeaponAttachmentSlotConfig"));
	}
	return Z_Registration_Info_UScriptStruct_WeaponAttachmentSlotConfig.OuterSingleton;
}
template<> NARRATIVEARSENAL_API UScriptStruct* StaticStruct<FWeaponAttachmentSlotConfig>()
{
	return FWeaponAttachmentSlotConfig::StaticStruct();
}
struct Z_Construct_UScriptStruct_FWeaponAttachmentSlotConfig_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Struct_MetaDataParams[] = {
		{ "BlueprintType", "true" },
		{ "Comment", "//Lets us defined the attachments a given weapon supports\n" },
		{ "ModuleRelativePath", "Public/Items/WeaponItem.h" },
		{ "ToolTip", "Lets us defined the attachments a given weapon supports" },
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_SocketName_MetaData[] = {
		{ "Category", "Slot Config" },
		{ "Comment", "//The bone or socket we want the attachment to equip to \n" },
		{ "ModuleRelativePath", "Public/Items/WeaponItem.h" },
		{ "ToolTip", "The bone or socket we want the attachment to equip to" },
	};
#endif // WITH_METADATA
	...
	{
		return (UScriptStruct::ICppStructOps*)new UScriptStruct::TCppStructOps<FWeaponAttachmentSlotConfig>();
	}
	static const UECodeGen_Private::FStructParams StructParams;
};
const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FWeaponAttachmentSlotConfig_Statics::NewProp_SocketName = { "SocketName", nullptr, (EPropertyFlags)0x0010000000010015, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FWeaponAttachmentSlotConfig, SocketName), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_SocketName_MetaData), NewProp_SocketName_MetaData) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UScriptStruct_FWeaponAttachmentSlotConfig_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FWeaponAttachmentSlotConfig_Statics::NewProp_SocketName,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FWeaponAttachmentSlotConfig_Statics::PropPointers) < 2048);
const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FWeaponAttachmentSlotConfig_Statics::StructParams = {
	(UObject* (*)())Z_Construct_UPackage__Script_NarrativeArsenal,
	nullptr,
	&NewStructOps,
	"WeaponAttachmentSlotConfig",
	Z_Construct_UScriptStruct_FWeaponAttachmentSlotConfig_Statics::PropPointers,
	UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FWeaponAttachmentSlotConfig_Statics::PropPointers),
	sizeof(FWeaponAttachmentSlotConfig),
	alignof(FWeaponAttachmentSlotConfig),
	RF_Public|RF_Transient|RF_MarkAsNative,
	EStructFlags(0x00000001),
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FWeaponAttachmentSlotConfig_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FWeaponAttachmentSlotConfig_Statics::Struct_MetaDataParams)
};
UScriptStruct* Z_Construct_UScriptStruct_FWeaponAttachmentSlotConfig()
{
	if (!Z_Registration_Info_UScriptStruct_WeaponAttachmentSlotConfig.InnerSingleton)
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_WeaponAttachmentSlotConfig.InnerSingleton, Z_Construct_UScriptStruct_FWeaponAttachmentSlotConfig_Statics::StructParams);
	}
	return Z_Registration_Info_UScriptStruct_WeaponAttachmentSlotConfig.InnerSingleton;
}
// End ScriptStruct FWeaponAttachmentSlotConfig
...
// Begin Class UWeaponItem Function GetAttachment
struct Z_Construct_UFunction_UWeaponItem_GetAttachment_Statics
{
	struct WeaponItem_eventGetAttachment_Parms
	{
		FGameplayTag AttachmentSlot;
		UWeaponAttachmentItem* ReturnValue;
	};
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[] = {
		{ "Category", "Weapon" },
		{ "Comment", "//Get the attachment at the given slot if there is one \n" },
		{ "ModuleRelativePath", "Public/Items/WeaponItem.h" },
		{ "ToolTip", "Get the attachment at the given slot if there is one" },
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_AttachmentSlot_MetaData[] = {
...
#endif // WITH_METADATA
	static const UECodeGen_Private::FStructPropertyParams NewProp_AttachmentSlot;
	static const UECodeGen_Private::FObjectPropertyParams NewProp_ReturnValue;
	static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
	static const UECodeGen_Private::FFunctionParams FuncParams;
};
const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UWeaponItem_GetAttachment_Statics::NewProp_AttachmentSlot = { "AttachmentSlot", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(WeaponItem_eventGetAttachment_Parms, AttachmentSlot), Z_Construct_UScriptStruct_FGameplayTag, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_AttachmentSlot_MetaData), NewProp_AttachmentSlot_MetaData) }; // 1298103297
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UWeaponItem_GetAttachment_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000080588, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(WeaponItem_eventGetAttachment_Parms, ReturnValue), Z_Construct_UClass_UWeaponAttachmentItem_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_ReturnValue_MetaData), NewProp_ReturnValue_MetaData) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UWeaponItem_GetAttachment_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UWeaponItem_GetAttachment_Statics::NewProp_AttachmentSlot,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UWeaponItem_GetAttachment_Statics::NewProp_ReturnValue,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UWeaponItem_GetAttachment_Statics::PropPointers) < 2048);
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UWeaponItem_GetAttachment_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UWeaponItem, nullptr, "GetAttachment", nullptr, nullptr, Z_Construct_UFunction_UWeaponItem_GetAttachment_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UWeaponItem_GetAttachment_Statics::PropPointers), sizeof(Z_Construct_UFunction_UWeaponItem_GetAttachment_Statics::WeaponItem_eventGetAttachment_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54420400, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UWeaponItem_GetAttachment_Statics::Function_MetaDataParams), Z_Construct_UFunction_UWeaponItem_GetAttachment_Statics::Function_MetaDataParams) };
static_assert(sizeof(Z_Construct_UFunction_UWeaponItem_GetAttachment_Statics::WeaponItem_eventGetAttachment_Parms) < MAX_uint16);
UFunction* Z_Construct_UFunction_UWeaponItem_GetAttachment()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UWeaponItem_GetAttachment_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(UWeaponItem::execGetAttachment)
{
	P_GET_STRUCT_REF(FGameplayTag,Z_Param_Out_AttachmentSlot);
	P_FINISH;
	P_NATIVE_BEGIN;
	*(UWeaponAttachmentItem**)Z_Param__Result=P_THIS->GetAttachment(Z_Param_Out_AttachmentSlot);
	P_NATIVE_END;
}
// End Class UWeaponItem Function GetAttachment
...
// Begin Class UWeaponItem Function GetWeaponSpread
struct WeaponItem_eventGetWeaponSpread_Parms
{
	float ReturnValue;

	/** Constructor, initializes return property only **/
	WeaponItem_eventGetWeaponSpread_Parms()
		: ReturnValue(0)
	{
	}
};
static const FName NAME_UWeaponItem_GetWeaponSpread = FName(TEXT("GetWeaponSpread"));
float UWeaponItem::GetWeaponSpread() const
{
	UFunction* Func = FindFunctionChecked(NAME_UWeaponItem_GetWeaponSpread);
	if (!Func->GetOwnerClass()->HasAnyClassFlags(CLASS_Native))
	{
		WeaponItem_eventGetWeaponSpread_Parms Parms;
		const_cast<UWeaponItem*>(this)->ProcessEvent(Func,&Parms);
		return Parms.ReturnValue;
	}
	else
	{
		return const_cast<UWeaponItem*>(this)->GetWeaponSpread_Implementation();
	}
}
struct Z_Construct_UFunction_UWeaponItem_GetWeaponSpread_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[] = {
		{ "Category", "Weapon" },
...
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UWeaponItem_GetWeaponSpread_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(WeaponItem_eventGetWeaponSpread_Parms, ReturnValue), METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UWeaponItem_GetWeaponSpread_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UWeaponItem_GetWeaponSpread_Statics::NewProp_ReturnValue,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UWeaponItem_GetWeaponSpread_Statics::PropPointers) < 2048);
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UWeaponItem_GetWeaponSpread_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UWeaponItem, nullptr, "GetWeaponSpread", nullptr, nullptr, Z_Construct_UFunction_UWeaponItem_GetWeaponSpread_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UWeaponItem_GetWeaponSpread_Statics::PropPointers), sizeof(WeaponItem_eventGetWeaponSpread_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x5C080C00, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UWeaponItem_GetWeaponSpread_Statics::Function_MetaDataParams), Z_Construct_UFunction_UWeaponItem_GetWeaponSpread_Statics::Function_MetaDataParams) };
static_assert(sizeof(WeaponItem_eventGetWeaponSpread_Parms) < MAX_uint16);
UFunction* Z_Construct_UFunction_UWeaponItem_GetWeaponSpread()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UWeaponItem_GetWeaponSpread_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(UWeaponItem::execGetWeaponSpread)
{
	P_FINISH;
	P_NATIVE_BEGIN;
	*(float*)Z_Param__Result=P_THIS->GetWeaponSpread_Implementation();
	P_NATIVE_END;
}
// End Class UWeaponItem Function GetWeaponSpread
...
// Begin Class UWeaponItem Function OnAttack
static const FName NAME_UWeaponItem_OnAttack = FName(TEXT("OnAttack"));
void UWeaponItem::OnAttack()
{
	UFunction* Func = FindFunctionChecked(NAME_UWeaponItem_OnAttack);
	if (!Func->GetOwnerClass()->HasAnyClassFlags(CLASS_Native))
	{
	ProcessEvent(Func,NULL);
	}
...
struct Z_Construct_UFunction_UWeaponItem_OnAttack_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[] = {
		{ "Category", "Weapon" },
...
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UWeaponItem_OnAttack_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UWeaponItem, nullptr, "OnAttack", nullptr, nullptr, nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x0C020C00, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UWeaponItem_OnAttack_Statics::Function_MetaDataParams), Z_Construct_UFunction_UWeaponItem_OnAttack_Statics::Function_MetaDataParams) };
UFunction* Z_Construct_UFunction_UWeaponItem_OnAttack()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UWeaponItem_OnAttack_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(UWeaponItem::execOnAttack)
{
	P_FINISH;
	P_NATIVE_BEGIN;
...
// End Class UWeaponItem Function OnAttack

// Begin Class UWeaponItem Function OnRep_WeaponAttachments
struct Z_Construct_UFunction_UWeaponItem_OnRep_WeaponAttachments_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Public/Items/WeaponItem.h" },
...
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UWeaponItem_OnRep_WeaponAttachments_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UWeaponItem, nullptr, "OnRep_WeaponAttachments", nullptr, nullptr, nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00080400, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UWeaponItem_OnRep_WeaponAttachments_Statics::Function_MetaDataParams), Z_Construct_UFunction_UWeaponItem_OnRep_WeaponAttachments_Statics::Function_MetaDataParams) };
UFunction* Z_Construct_UFunction_UWeaponItem_OnRep_WeaponAttachments()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UWeaponItem_OnRep_WeaponAttachments_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(UWeaponItem::execOnRep_WeaponAttachments)
{
	P_FINISH;
	P_NATIVE_BEGIN;
	P_THIS->OnRep_WeaponAttachments();
	P_NATIVE_END;
}
// End Class UWeaponItem Function OnRep_WeaponAttachments
...
void UWeaponItem::StaticRegisterNativesUWeaponItem()
{
	...
	static const FNameNativePtrPair Funcs[] = {
		...
		{ "GetAttachment", &UWeaponItem::execGetAttachment },
		...
		{ "GetWeaponSpread", &UWeaponItem::execGetWeaponSpread },
		...
		{ "OnAttack", &UWeaponItem::execOnAttack },
		{ "OnRep_WeaponAttachments", &UWeaponItem::execOnRep_WeaponAttachments },
...
struct Z_Construct_UClass_UWeaponItem_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_WeaponAnimLayer_MetaData[] = {
		{ "Category", "Item - Weapon | Weapon Visuals" },
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_FormSpecificLayers_MetaData[] = {
		{ "Categories", "Narrative.CharacterCreator.Forms" },
		{ "Category", "Item - Weapon | Weapon Visuals" },
		{ "Comment", "/** Form specific overrides for WeaponAnimLayer */" },
		{ "ForceInlineRow", "" },
		{ "ModuleRelativePath", "Public/Items/WeaponItem.h" },
		{ "ToolTip", "Form specific overrides for WeaponAnimLayer" },
	};
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_AttackDamage_MetaData[] = {
		{ "Category", "Item - Weapon | Attack Settings" },
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_WeaponAttachmentConfiguration_MetaData[] = {
		{ "Categories", "Narrative.Equipment.Weapon.AttachSlot" },
		{ "Category", "Item - Weapon | Attachments" },
		{ "Comment", "/** Defines the attachment configuration for this weapon */" },
		{ "ModuleRelativePath", "Public/Items/WeaponItem.h" },
		{ "ToolTip", "Defines the attachment configuration for this weapon" },
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_RequiredAmmo_MetaData[] = {
		{ "Category", "Item - Weapon | Ammo" },
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_ClipSize_MetaData[] = {
		{ "Category", "Item - Weapon | Ammo" },
		{ "Comment", "/** The clip size of the weapon, if the weapon uses one. */" },
		{ "ModuleRelativePath", "Public/Items/WeaponItem.h" },
		{ "ToolTip", "The clip size of the weapon, if the weapon uses one." },
	};
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_WeaponAttachments_MetaData[] = {
		{ "Category", "Item - Weapon | Attachments" },
		{ "Comment", "/** The attachment items currently on this weapon. */" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "Public/Items/WeaponItem.h" },
		{ "ToolTip", "The attachment items currently on this weapon." },
	};
	...
	static const UECodeGen_Private::FClassPropertyParams NewProp_FormSpecificLayers_ValueProp;
	static const UECodeGen_Private::FStructPropertyParams NewProp_FormSpecificLayers_Key_KeyProp;
	static const UECodeGen_Private::FMapPropertyParams NewProp_FormSpecificLayers;
	static const UECodeGen_Private::FSoftClassPropertyParams NewProp_WeaponVisualClass;
	...
	static const UECodeGen_Private::FStructPropertyParams NewProp_WeaponAttachmentConfiguration_ValueProp;
	static const UECodeGen_Private::FStructPropertyParams NewProp_WeaponAttachmentConfiguration_Key_KeyProp;
	static const UECodeGen_Private::FMapPropertyParams NewProp_WeaponAttachmentConfiguration;
	...
	static const UECodeGen_Private::FObjectPropertyParams NewProp_WeaponAttachments_ValueProp;
	static const UECodeGen_Private::FStructPropertyParams NewProp_WeaponAttachments_Key_KeyProp;
	static const UECodeGen_Private::FMapPropertyParams NewProp_WeaponAttachments;
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_UWeaponItem_GetAttachment, "GetAttachment" }, // 4101853431
		...
		{ &Z_Construct_UFunction_UWeaponItem_GetWeaponSpread, "GetWeaponSpread" }, // 3324921443
		...
		{ &Z_Construct_UFunction_UWeaponItem_OnAttack, "OnAttack" }, // 125897403
		{ &Z_Construct_UFunction_UWeaponItem_OnRep_WeaponAttachments, "OnRep_WeaponAttachments" }, // 1298965749
...
const UECodeGen_Private::FClassPropertyParams Z_Construct_UClass_UWeaponItem_Statics::NewProp_FormSpecificLayers_ValueProp = { "FormSpecificLayers", nullptr, (EPropertyFlags)0x0004000000000001, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 1, Z_Construct_UClass_UClass, Z_Construct_UClass_UAnimInstance_NoRegister, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UWeaponItem_Statics::NewProp_FormSpecificLayers_Key_KeyProp = { "FormSpecificLayers_Key", nullptr, (EPropertyFlags)0x0000000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UScriptStruct_FGameplayTag, METADATA_PARAMS(0, nullptr) }; // 1298103297
const UECodeGen_Private::FMapPropertyParams Z_Construct_UClass_UWeaponItem_Statics::NewProp_FormSpecificLayers = { "FormSpecificLayers", nullptr, (EPropertyFlags)0x0024080000010015, UECodeGen_Private::EPropertyGenFlags::Map, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UWeaponItem, FormSpecificLayers), EMapPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_FormSpecificLayers_MetaData), NewProp_FormSpecificLayers_MetaData) }; // 1298103297
const UECodeGen_Private::FSoftClassPropertyParams Z_Construct_UClass_UWeaponItem_Statics::NewProp_WeaponVisualClass = { "WeaponVisualClass", nullptr, (EPropertyFlags)0x0024080000010015, UECodeGen_Private::EPropertyGenFlags::SoftClass, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UWeaponItem, WeaponVisualClass), Z_Construct_UClass_AWeaponVisual_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_WeaponVisualClass_MetaData), NewProp_WeaponVisualClass_MetaData) };
...
const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UWeaponItem_Statics::NewProp_WeaponAttachmentConfiguration_ValueProp = { "WeaponAttachmentConfiguration", nullptr, (EPropertyFlags)0x0000000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 1, Z_Construct_UScriptStruct_FWeaponAttachmentSlotConfig, METADATA_PARAMS(0, nullptr) }; // 2429602380
const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UWeaponItem_Statics::NewProp_WeaponAttachmentConfiguration_Key_KeyProp = { "WeaponAttachmentConfiguration_Key", nullptr, (EPropertyFlags)0x0000000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UScriptStruct_FGameplayTag, METADATA_PARAMS(0, nullptr) }; // 1298103297
const UECodeGen_Private::FMapPropertyParams Z_Construct_UClass_UWeaponItem_Statics::NewProp_WeaponAttachmentConfiguration = { "WeaponAttachmentConfiguration", nullptr, (EPropertyFlags)0x0020080000010015, UECodeGen_Private::EPropertyGenFlags::Map, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UWeaponItem, WeaponAttachmentConfiguration), EMapPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_WeaponAttachmentConfiguration_MetaData), NewProp_WeaponAttachmentConfiguration_MetaData) }; // 1298103297 2429602380
...
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UWeaponItem_Statics::NewProp_WeaponAttachments_ValueProp = { "WeaponAttachments", nullptr, (EPropertyFlags)0x0000000000080008, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 1, Z_Construct_UClass_UWeaponAttachmentItem_NoRegister, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UWeaponItem_Statics::NewProp_WeaponAttachments_Key_KeyProp = { "WeaponAttachments_Key", nullptr, (EPropertyFlags)0x0000000000080008, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UScriptStruct_FGameplayTag, METADATA_PARAMS(0, nullptr) }; // 1298103297
const UECodeGen_Private::FMapPropertyParams Z_Construct_UClass_UWeaponItem_Statics::NewProp_WeaponAttachments = { "WeaponAttachments", nullptr, (EPropertyFlags)0x002008800000001c, UECodeGen_Private::EPropertyGenFlags::Map, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UWeaponItem, WeaponAttachments), EMapPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_WeaponAttachments_MetaData), NewProp_WeaponAttachments_MetaData) }; // 1298103297
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UWeaponItem_Statics::NewProp_LastAttackTime = { "LastAttackTime", nullptr, (EPropertyFlags)0x0020080000020815, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UWeaponItem, LastAttackTime), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_LastAttackTime_MetaData), NewProp_LastAttackTime_MetaData) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UWeaponItem_Statics::PropPointers[] = {
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UWeaponItem_Statics::NewProp_FormSpecificLayers_ValueProp,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UWeaponItem_Statics::NewProp_FormSpecificLayers_Key_KeyProp,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UWeaponItem_Statics::NewProp_FormSpecificLayers,
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UWeaponItem_Statics::NewProp_WeaponAttachmentConfiguration_ValueProp,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UWeaponItem_Statics::NewProp_WeaponAttachmentConfiguration_Key_KeyProp,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UWeaponItem_Statics::NewProp_WeaponAttachmentConfiguration,
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UWeaponItem_Statics::NewProp_WeaponAttachments_ValueProp,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UWeaponItem_Statics::NewProp_WeaponAttachments_Key_KeyProp,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UWeaponItem_Statics::NewProp_WeaponAttachments,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UWeaponItem_Statics::NewProp_LastAttackTime,
};
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeArsenal_Public_Items_WeaponItem_h_Statics
{
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FWeaponAttachmentSlotConfig::StaticStruct, Z_Construct_UScriptStruct_FWeaponAttachmentSlotConfig_Statics::NewStructOps, TEXT("WeaponAttachmentSlotConfig"), &Z_Registration_Info_UScriptStruct_WeaponAttachmentSlotConfig, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FWeaponAttachmentSlotConfig), 2429602380U) },
	};
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UWeaponItem, UWeaponItem::StaticClass, TEXT("UWeaponItem"), &Z_Registration_Info_UClass_UWeaponItem, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UWeaponItem), 1424702133U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeArsenal_Public_Items_WeaponItem_h_3636264157(TEXT("/Script/NarrativeArsenal"),
	Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeArsenal_Public_Items_WeaponItem_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeArsenal_Public_Items_WeaponItem_h_Statics::ClassInfo),
	Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeArsenal_Public_Items_WeaponItem_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeArsenal_Public_Items_WeaponItem_h_Statics::ScriptStructInfo),
	nullptr, 0);
// End Registration
