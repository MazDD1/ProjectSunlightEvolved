...
struct Z_Construct_UClass_UCharacterCreatorPage_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_PageCameraTransform_MetaData[] = {
		{ "Category", "Attribute" },
		{ "Comment", "//The transform in the level the camera should lerp to when this page is selected \n" },
		{ "ModuleRelativePath", "Public/CharacterCreator/CharacterCreatorConfiguration.h" },
		{ "ToolTip", "The transform in the level the camera should lerp to when this page is selected" },
	};
	...
	static const UECodeGen_Private::FStructPropertyParams NewProp_PageCameraTransform;
...
const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UCharacterCreatorPage_Statics::NewProp_PageCameraTransform = { "PageCameraTransform", nullptr, (EPropertyFlags)0x0010000000010005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UCharacterCreatorPage, PageCameraTransform), Z_Construct_UScriptStruct_FTransform, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_PageCameraTransform_MetaData), NewProp_PageCameraTransform_MetaData) };
...
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UCharacterCreatorPage_Statics::PropPointers[] = {
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UCharacterCreatorPage_Statics::NewProp_PageCameraTransform,
...
struct Z_Construct_UClass_UCharacterCreatorForm_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_CharacterVisualClass_MetaData[] = {
		{ "Category", "Form" },
		{ "Comment", "//The visual class that should be spawned if we're using this form \n" },
		{ "ModuleRelativePath", "Public/CharacterCreator/CharacterCreatorConfiguration.h" },
		{ "ToolTip", "The visual class that should be spawned if we're using this form" },
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_BaseMesh_MetaData[] = {
		{ "Category", "Form" },
		{ "Comment", "//The base mesh this form should have by default - usually hidden\n" },
		{ "ModuleRelativePath", "Public/CharacterCreator/CharacterCreatorConfiguration.h" },
		{ "ToolTip", "The base mesh this form should have by default - usually hidden" },
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_bHideBaseMesh_MetaData[] = {
		{ "Category", "Form" },
		{ "Comment", "//Whether or not to hide the base mesh. Usually you'd hide it and your visible body parts would follow this.  \n" },
		{ "ModuleRelativePath", "Public/CharacterCreator/CharacterCreatorConfiguration.h" },
		{ "ToolTip", "Whether or not to hide the base mesh. Usually you'd hide it and your visible body parts would follow this." },
	};
...
const UECodeGen_Private::FClassPropertyParams Z_Construct_UClass_UCharacterCreatorForm_Statics::NewProp_CharacterVisualClass = { "CharacterVisualClass", nullptr, (EPropertyFlags)0x0014000000010005, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UCharacterCreatorForm, CharacterVisualClass), Z_Construct_UClass_UClass, Z_Construct_UClass_ANarrativeCharacterVisual_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_CharacterVisualClass_MetaData), NewProp_CharacterVisualClass_MetaData) };
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UCharacterCreatorForm_Statics::NewProp_BaseMesh = { "BaseMesh", nullptr, (EPropertyFlags)0x0114000000010005, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UCharacterCreatorForm, BaseMesh), Z_Construct_UClass_USkeletalMesh_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_BaseMesh_MetaData), NewProp_BaseMesh_MetaData) };
void Z_Construct_UClass_UCharacterCreatorForm_Statics::NewProp_bHideBaseMesh_SetBit(void* Obj)
{
	((UCharacterCreatorForm*)Obj)->bHideBaseMesh = 1;
}
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UCharacterCreatorForm_Statics::NewProp_bHideBaseMesh = { "bHideBaseMesh", nullptr, (EPropertyFlags)0x0010000000010005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UCharacterCreatorForm), &Z_Construct_UClass_UCharacterCreatorForm_Statics::NewProp_bHideBaseMesh_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_bHideBaseMesh_MetaData), NewProp_bHideBaseMesh_MetaData) };
...
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UCharacterCreatorForm_Statics::PropPointers[] = {
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UCharacterCreatorForm_Statics::NewProp_CharacterVisualClass,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UCharacterCreatorForm_Statics::NewProp_BaseMesh,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UCharacterCreatorForm_Statics::NewProp_bHideBaseMesh,
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeArsenal_Public_CharacterCreator_CharacterCreatorConfiguration_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UCharacterCreatorPage, UCharacterCreatorPage::StaticClass, TEXT("UCharacterCreatorPage"), &Z_Registration_Info_UClass_UCharacterCreatorPage, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UCharacterCreatorPage), 2486045138U) },
		...
		{ Z_Construct_UClass_UCharacterCreatorForm, UCharacterCreatorForm::StaticClass, TEXT("UCharacterCreatorForm"), &Z_Registration_Info_UClass_UCharacterCreatorForm, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UCharacterCreatorForm), 3486126427U) },
...
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeArsenal_Public_CharacterCreator_CharacterCreatorConfiguration_h_353862354(TEXT("/Script/NarrativeArsenal"),
	Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeArsenal_Public_CharacterCreator_CharacterCreatorConfiguration_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeArsenal_Public_CharacterCreator_CharacterCreatorConfiguration_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
