...
// Begin Class UNarrativeSaveSubsystem Function DoesRecordExist
struct Z_Construct_UFunction_UNarrativeSaveSubsystem_DoesRecordExist_Statics
{
	struct NarrativeSaveSubsystem_eventDoesRecordExist_Parms
	{
		FGuid RecordGUID;
		bool ReturnValue;
	};
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[] = {
		{ "Category", "Saving" },
		{ "Comment", "/**Check if a record exists with the given ID. */" },
		{ "ModuleRelativePath", "Public/Subsystems/NarrativeSaveSubsystem.h" },
		{ "ToolTip", "Check if a record exists with the given ID." },
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_RecordGUID_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif // WITH_METADATA
	static const UECodeGen_Private::FStructPropertyParams NewProp_RecordGUID;
	static void NewProp_ReturnValue_SetBit(void* Obj);
	static const UECodeGen_Private::FBoolPropertyParams NewProp_ReturnValue;
	static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
	static const UECodeGen_Private::FFunctionParams FuncParams;
};
const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UNarrativeSaveSubsystem_DoesRecordExist_Statics::NewProp_RecordGUID = { "RecordGUID", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(NarrativeSaveSubsystem_eventDoesRecordExist_Parms, RecordGUID), Z_Construct_UScriptStruct_FGuid, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_RecordGUID_MetaData), NewProp_RecordGUID_MetaData) };
void Z_Construct_UFunction_UNarrativeSaveSubsystem_DoesRecordExist_Statics::NewProp_ReturnValue_SetBit(void* Obj)
{
	((NarrativeSaveSubsystem_eventDoesRecordExist_Parms*)Obj)->ReturnValue = 1;
}
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UNarrativeSaveSubsystem_DoesRecordExist_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(NarrativeSaveSubsystem_eventDoesRecordExist_Parms), &Z_Construct_UFunction_UNarrativeSaveSubsystem_DoesRecordExist_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UNarrativeSaveSubsystem_DoesRecordExist_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UNarrativeSaveSubsystem_DoesRecordExist_Statics::NewProp_RecordGUID,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UNarrativeSaveSubsystem_DoesRecordExist_Statics::NewProp_ReturnValue,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UNarrativeSaveSubsystem_DoesRecordExist_Statics::PropPointers) < 2048);
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UNarrativeSaveSubsystem_DoesRecordExist_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UNarrativeSaveSubsystem, nullptr, "DoesRecordExist", nullptr, nullptr, Z_Construct_UFunction_UNarrativeSaveSubsystem_DoesRecordExist_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UNarrativeSaveSubsystem_DoesRecordExist_Statics::PropPointers), sizeof(Z_Construct_UFunction_UNarrativeSaveSubsystem_DoesRecordExist_Statics::NarrativeSaveSubsystem_eventDoesRecordExist_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54C20405, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UNarrativeSaveSubsystem_DoesRecordExist_Statics::Function_MetaDataParams), Z_Construct_UFunction_UNarrativeSaveSubsystem_DoesRecordExist_Statics::Function_MetaDataParams) };
static_assert(sizeof(Z_Construct_UFunction_UNarrativeSaveSubsystem_DoesRecordExist_Statics::NarrativeSaveSubsystem_eventDoesRecordExist_Parms) < MAX_uint16);
UFunction* Z_Construct_UFunction_UNarrativeSaveSubsystem_DoesRecordExist()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UNarrativeSaveSubsystem_DoesRecordExist_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(UNarrativeSaveSubsystem::execDoesRecordExist)
{
	P_GET_STRUCT_REF(FGuid,Z_Param_Out_RecordGUID);
	P_FINISH;
	P_NATIVE_BEGIN;
	*(bool*)Z_Param__Result=P_THIS->DoesRecordExist(Z_Param_Out_RecordGUID);
	P_NATIVE_END;
}
// End Class UNarrativeSaveSubsystem Function DoesRecordExist
...
// Begin Class UNarrativeSaveSubsystem Function IsNewGame
struct Z_Construct_UFunction_UNarrativeSaveSubsystem_IsNewGame_Statics
{
	struct NarrativeSaveSubsystem_eventIsNewGame_Parms
	{
		bool ReturnValue;
	};
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[] = {
		{ "Category", "Saving" },
		{ "Comment", "/** Return true if we're a new game, ie we've started a new game and havent saved yet  */" },
		{ "ModuleRelativePath", "Public/Subsystems/NarrativeSaveSubsystem.h" },
		{ "ToolTip", "Return true if we're a new game, ie we've started a new game and havent saved yet" },
	};
#endif // WITH_METADATA
	static void NewProp_ReturnValue_SetBit(void* Obj);
	static const UECodeGen_Private::FBoolPropertyParams NewProp_ReturnValue;
...
void Z_Construct_UFunction_UNarrativeSaveSubsystem_IsNewGame_Statics::NewProp_ReturnValue_SetBit(void* Obj)
{
	((NarrativeSaveSubsystem_eventIsNewGame_Parms*)Obj)->ReturnValue = 1;
}
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UNarrativeSaveSubsystem_IsNewGame_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(NarrativeSaveSubsystem_eventIsNewGame_Parms), &Z_Construct_UFunction_UNarrativeSaveSubsystem_IsNewGame_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UNarrativeSaveSubsystem_IsNewGame_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UNarrativeSaveSubsystem_IsNewGame_Statics::NewProp_ReturnValue,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UNarrativeSaveSubsystem_IsNewGame_Statics::PropPointers) < 2048);
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UNarrativeSaveSubsystem_IsNewGame_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UNarrativeSaveSubsystem, nullptr, "IsNewGame", nullptr, nullptr, Z_Construct_UFunction_UNarrativeSaveSubsystem_IsNewGame_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UNarrativeSaveSubsystem_IsNewGame_Statics::PropPointers), sizeof(Z_Construct_UFunction_UNarrativeSaveSubsystem_IsNewGame_Statics::NarrativeSaveSubsystem_eventIsNewGame_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UNarrativeSaveSubsystem_IsNewGame_Statics::Function_MetaDataParams), Z_Construct_UFunction_UNarrativeSaveSubsystem_IsNewGame_Statics::Function_MetaDataParams) };
static_assert(sizeof(Z_Construct_UFunction_UNarrativeSaveSubsystem_IsNewGame_Statics::NarrativeSaveSubsystem_eventIsNewGame_Parms) < MAX_uint16);
UFunction* Z_Construct_UFunction_UNarrativeSaveSubsystem_IsNewGame()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UNarrativeSaveSubsystem_IsNewGame_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(UNarrativeSaveSubsystem::execIsNewGame)
{
	P_FINISH;
	P_NATIVE_BEGIN;
...
// End Class UNarrativeSaveSubsystem Function IsNewGame
...
void UNarrativeSaveSubsystem::StaticRegisterNativesUNarrativeSaveSubsystem()
{
	...
	static const FNameNativePtrPair Funcs[] = {
		...
		{ "DoesRecordExist", &UNarrativeSaveSubsystem::execDoesRecordExist },
		{ "GetSaveObject", &UNarrativeSaveSubsystem::execGetSaveObject },
		{ "IsLoading", &UNarrativeSaveSubsystem::execIsLoading },
		{ "IsNewGame", &UNarrativeSaveSubsystem::execIsNewGame },
...
struct Z_Construct_UClass_UNarrativeSaveSubsystem_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_UNarrativeSaveSubsystem_DoesRecordExist, "DoesRecordExist" }, // 2531475927
		...
		{ &Z_Construct_UFunction_UNarrativeSaveSubsystem_IsNewGame, "IsNewGame" }, // 1499687866
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeSaveSystem_Public_Subsystems_NarrativeSaveSubsystem_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UNarrativeSaveSubsystem, UNarrativeSaveSubsystem::StaticClass, TEXT("UNarrativeSaveSubsystem"), &Z_Registration_Info_UClass_UNarrativeSaveSubsystem, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNarrativeSaveSubsystem), 970874306U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeSaveSystem_Public_Subsystems_NarrativeSaveSubsystem_h_932135916(TEXT("/Script/NarrativeSaveSystem"),
	Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeSaveSystem_Public_Subsystems_NarrativeSaveSubsystem_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeSaveSystem_Public_Subsystems_NarrativeSaveSubsystem_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
