...
struct Z_Construct_UEnum_NarrativeArsenal_ENarrativeAbilityInputID_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
		...
		{ "Throw.Comment", "// G - Throwable attack\n" },
		{ "Throw.DisplayName", "Throw" },
		{ "Throw.Name", "ENarrativeAbilityInputID::Throw" },
		{ "Throw.ToolTip", "G - Throwable attack" },
	};
#endif // WITH_METADATA
	static constexpr UECodeGen_Private::FEnumeratorParam Enumerators[] = {
		...
		{ "ENarrativeAbilityInputID::Throw", (int64)ENarrativeAbilityInputID::Throw },
	};
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeArsenal_Public_NarrativeArsenal_h_Statics
{
	static constexpr FEnumRegisterCompiledInInfo EnumInfo[] = {
		{ ENarrativeAbilityInputID_StaticEnum, TEXT("ENarrativeAbilityInputID"), &Z_Registration_Info_UEnum_ENarrativeAbilityInputID, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3840447446U) },
...
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeArsenal_Public_NarrativeArsenal_h_2362737378(TEXT("/Script/NarrativeArsenal"),
	nullptr, 0,
	nullptr, 0,
	Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeArsenal_Public_NarrativeArsenal_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeArsenal_Public_NarrativeArsenal_h_Statics::EnumInfo));
// End Registration
