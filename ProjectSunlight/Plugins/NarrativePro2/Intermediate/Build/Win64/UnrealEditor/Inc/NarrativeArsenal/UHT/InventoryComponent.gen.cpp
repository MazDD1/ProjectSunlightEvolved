...
NARRATIVEARSENAL_API UClass* Z_Construct_UClass_UItemCollection();
NARRATIVEARSENAL_API UClass* Z_Construct_UClass_UItemCollection_NoRegister();
NARRATIVEARSENAL_API UClass* Z_Construct_UClass_UNarrativeInventoryComponent();
NARRATIVEARSENAL_API UClass* Z_Construct_UClass_UNarrativeInventoryComponent_NoRegister();
NARRATIVEARSENAL_API UClass* Z_Construct_UClass_UNarrativeItem_NoRegister();
NARRATIVEARSENAL_API UFunction* Z_Construct_UDelegateFunction_NarrativeArsenal_OnBeginLooting__DelegateSignature();
NARRATIVEARSENAL_API UFunction* Z_Construct_UDelegateFunction_NarrativeArsenal_OnCurrencyChanged__DelegateSignature();
NARRATIVEARSENAL_API UFunction* Z_Construct_UDelegateFunction_NarrativeArsenal_OnEndLooting__DelegateSignature();
NARRATIVEARSENAL_API UFunction* Z_Construct_UDelegateFunction_NarrativeArsenal_OnInventoryUpdated__DelegateSignature();
NARRATIVEARSENAL_API UFunction* Z_Construct_UDelegateFunction_NarrativeArsenal_OnItemAdded__DelegateSignature();
NARRATIVEARSENAL_API UFunction* Z_Construct_UDelegateFunction_NarrativeArsenal_OnItemRemoved__DelegateSignature();
NARRATIVEARSENAL_API UFunction* Z_Construct_UDelegateFunction_NarrativeArsenal_OnItemUsed__DelegateSignature();
NARRATIVEARSENAL_API UScriptStruct* Z_Construct_UScriptStruct_FItemAddResult();
NARRATIVEARSENAL_API UScriptStruct* Z_Construct_UScriptStruct_FItemWithQuantity();
NARRATIVEARSENAL_API UScriptStruct* Z_Construct_UScriptStruct_FLootTableRoll();
NARRATIVEARSENAL_API UScriptStruct* Z_Construct_UScriptStruct_FLootTableRow();
NARRATIVEARSENAL_API UScriptStruct* Z_Construct_UScriptStruct_FNarrativeSavedItem();
...
class UScriptStruct* FItemAddResult::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_ItemAddResult.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FItemAddResult, (UObject*)Z_Construct_UPackage__Script_NarrativeArsenal(), TEXT("ItemAddResult"));
	}
	return Z_Registration_Info_UScriptStruct_ItemAddResult.OuterSingleton;
}
template<> NARRATIVEARSENAL_API UScriptStruct* StaticStruct<FItemAddResult>()
{
...
struct Z_Construct_UScriptStruct_FItemAddResult_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam Struct_MetaDataParams[] = {
		...
		{ "ModuleRelativePath", "Public/Items/InventoryComponent.h" },
...
struct Z_Construct_UDelegateFunction_NarrativeArsenal_OnInventoryUpdated__DelegateSignature_Statics
{
#if WITH_METADATA
...
const UECodeGen_Private::FFunctionParams Z_Construct_UDelegateFunction_NarrativeArsenal_OnInventoryUpdated__DelegateSignature_Statics::FuncParams = { (UObject*(*)())Z_Construct_UPackage__Script_NarrativeArsenal, nullptr, "OnInventoryUpdated__DelegateSignature", nullptr, nullptr, nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00130000, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_NarrativeArsenal_OnInventoryUpdated__DelegateSignature_Statics::Function_MetaDataParams), Z_Construct_UDelegateFunction_NarrativeArsenal_OnInventoryUpdated__DelegateSignature_Statics::Function_MetaDataParams) };
UFunction* Z_Construct_UDelegateFunction_NarrativeArsenal_OnInventoryUpdated__DelegateSignature()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UDelegateFunction_NarrativeArsenal_OnInventoryUpdated__DelegateSignature_Statics::FuncParams);
	}
...
struct Z_Construct_UDelegateFunction_NarrativeArsenal_OnItemAdded__DelegateSignature_Statics
{
	struct _Script_NarrativeArsenal_eventOnItemAdded_Parms
	{
...
const UECodeGen_Private::FStructPropertyParams Z_Construct_UDelegateFunction_NarrativeArsenal_OnItemAdded__DelegateSignature_Statics::NewProp_AddResult = { "AddResult", nullptr, (EPropertyFlags)0x0010008008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(_Script_NarrativeArsenal_eventOnItemAdded_Parms, AddResult), Z_Construct_UScriptStruct_FItemAddResult, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_AddResult_MetaData), NewProp_AddResult_MetaData) }; // 4140060516
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UDelegateFunction_NarrativeArsenal_OnItemAdded__DelegateSignature_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_NarrativeArsenal_OnItemAdded__DelegateSignature_Statics::NewProp_AddResult,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_NarrativeArsenal_OnItemAdded__DelegateSignature_Statics::PropPointers) < 2048);
const UECodeGen_Private::FFunctionParams Z_Construct_UDelegateFunction_NarrativeArsenal_OnItemAdded__DelegateSignature_Statics::FuncParams = { (UObject*(*)())Z_Construct_UPackage__Script_NarrativeArsenal, nullptr, "OnItemAdded__DelegateSignature", nullptr, nullptr, Z_Construct_UDelegateFunction_NarrativeArsenal_OnItemAdded__DelegateSignature_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_NarrativeArsenal_OnItemAdded__DelegateSignature_Statics::PropPointers), sizeof(Z_Construct_UDelegateFunction_NarrativeArsenal_OnItemAdded__DelegateSignature_Statics::_Script_NarrativeArsenal_eventOnItemAdded_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00130000, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_NarrativeArsenal_OnItemAdded__DelegateSignature_Statics::Function_MetaDataParams), Z_Construct_UDelegateFunction_NarrativeArsenal_OnItemAdded__DelegateSignature_Statics::Function_MetaDataParams) };
static_assert(sizeof(Z_Construct_UDelegateFunction_NarrativeArsenal_OnItemAdded__DelegateSignature_Statics::_Script_NarrativeArsenal_eventOnItemAdded_Parms) < MAX_uint16);
UFunction* Z_Construct_UDelegateFunction_NarrativeArsenal_OnItemAdded__DelegateSignature()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UDelegateFunction_NarrativeArsenal_OnItemAdded__DelegateSignature_Statics::FuncParams);
	}
	return ReturnFunction;
}
void FOnItemAdded_DelegateWrapper(const FMulticastScriptDelegate& OnItemAdded, FItemAddResult const& AddResult)
{
	...
	_Script_NarrativeArsenal_eventOnItemAdded_Parms Parms;
...
struct Z_Construct_UDelegateFunction_NarrativeArsenal_OnItemRemoved__DelegateSignature_Statics
{
	struct _Script_NarrativeArsenal_eventOnItemRemoved_Parms
	{
		UNarrativeItem* Item;
		int32 Amount;
	};
...
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UDelegateFunction_NarrativeArsenal_OnItemRemoved__DelegateSignature_Statics::NewProp_Item = { "Item", nullptr, (EPropertyFlags)0x0010000000080080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(_Script_NarrativeArsenal_eventOnItemRemoved_Parms, Item), Z_Construct_UClass_UNarrativeItem_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_Item_MetaData), NewProp_Item_MetaData) };
const UECodeGen_Private::FIntPropertyParams Z_Construct_UDelegateFunction_NarrativeArsenal_OnItemRemoved__DelegateSignature_Statics::NewProp_Amount = { "Amount", nullptr, (EPropertyFlags)0x0010000000000082, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(_Script_NarrativeArsenal_eventOnItemRemoved_Parms, Amount), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_Amount_MetaData), NewProp_Amount_MetaData) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UDelegateFunction_NarrativeArsenal_OnItemRemoved__DelegateSignature_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_NarrativeArsenal_OnItemRemoved__DelegateSignature_Statics::NewProp_Item,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_NarrativeArsenal_OnItemRemoved__DelegateSignature_Statics::NewProp_Amount,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_NarrativeArsenal_OnItemRemoved__DelegateSignature_Statics::PropPointers) < 2048);
const UECodeGen_Private::FFunctionParams Z_Construct_UDelegateFunction_NarrativeArsenal_OnItemRemoved__DelegateSignature_Statics::FuncParams = { (UObject*(*)())Z_Construct_UPackage__Script_NarrativeArsenal, nullptr, "OnItemRemoved__DelegateSignature", nullptr, nullptr, Z_Construct_UDelegateFunction_NarrativeArsenal_OnItemRemoved__DelegateSignature_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_NarrativeArsenal_OnItemRemoved__DelegateSignature_Statics::PropPointers), sizeof(Z_Construct_UDelegateFunction_NarrativeArsenal_OnItemRemoved__DelegateSignature_Statics::_Script_NarrativeArsenal_eventOnItemRemoved_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00130000, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_NarrativeArsenal_OnItemRemoved__DelegateSignature_Statics::Function_MetaDataParams), Z_Construct_UDelegateFunction_NarrativeArsenal_OnItemRemoved__DelegateSignature_Statics::Function_MetaDataParams) };
static_assert(sizeof(Z_Construct_UDelegateFunction_NarrativeArsenal_OnItemRemoved__DelegateSignature_Statics::_Script_NarrativeArsenal_eventOnItemRemoved_Parms) < MAX_uint16);
UFunction* Z_Construct_UDelegateFunction_NarrativeArsenal_OnItemRemoved__DelegateSignature()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UDelegateFunction_NarrativeArsenal_OnItemRemoved__DelegateSignature_Statics::FuncParams);
	}
	return ReturnFunction;
}
void FOnItemRemoved_DelegateWrapper(const FMulticastScriptDelegate& OnItemRemoved, UNarrativeItem* Item, const int32 Amount)
{
	...
	_Script_NarrativeArsenal_eventOnItemRemoved_Parms Parms;
	Parms.Item=Item;
	Parms.Amount=Amount;
...
struct Z_Construct_UDelegateFunction_NarrativeArsenal_OnBeginLooting__DelegateSignature_Statics
{
	struct _Script_NarrativeArsenal_eventOnBeginLooting_Parms
	{
...
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UDelegateFunction_NarrativeArsenal_OnBeginLooting__DelegateSignature_Statics::NewProp_LootSource = { "LootSource", nullptr, (EPropertyFlags)0x0010000000080080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(_Script_NarrativeArsenal_eventOnBeginLooting_Parms, LootSource), Z_Construct_UClass_UNarrativeInventoryComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_LootSource_MetaData), NewProp_LootSource_MetaData) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UDelegateFunction_NarrativeArsenal_OnBeginLooting__DelegateSignature_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_NarrativeArsenal_OnBeginLooting__DelegateSignature_Statics::NewProp_LootSource,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_NarrativeArsenal_OnBeginLooting__DelegateSignature_Statics::PropPointers) < 2048);
const UECodeGen_Private::FFunctionParams Z_Construct_UDelegateFunction_NarrativeArsenal_OnBeginLooting__DelegateSignature_Statics::FuncParams = { (UObject*(*)())Z_Construct_UPackage__Script_NarrativeArsenal, nullptr, "OnBeginLooting__DelegateSignature", nullptr, nullptr, Z_Construct_UDelegateFunction_NarrativeArsenal_OnBeginLooting__DelegateSignature_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_NarrativeArsenal_OnBeginLooting__DelegateSignature_Statics::PropPointers), sizeof(Z_Construct_UDelegateFunction_NarrativeArsenal_OnBeginLooting__DelegateSignature_Statics::_Script_NarrativeArsenal_eventOnBeginLooting_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00130000, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_NarrativeArsenal_OnBeginLooting__DelegateSignature_Statics::Function_MetaDataParams), Z_Construct_UDelegateFunction_NarrativeArsenal_OnBeginLooting__DelegateSignature_Statics::Function_MetaDataParams) };
static_assert(sizeof(Z_Construct_UDelegateFunction_NarrativeArsenal_OnBeginLooting__DelegateSignature_Statics::_Script_NarrativeArsenal_eventOnBeginLooting_Parms) < MAX_uint16);
UFunction* Z_Construct_UDelegateFunction_NarrativeArsenal_OnBeginLooting__DelegateSignature()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UDelegateFunction_NarrativeArsenal_OnBeginLooting__DelegateSignature_Statics::FuncParams);
	}
	return ReturnFunction;
}
void FOnBeginLooting_DelegateWrapper(const FMulticastScriptDelegate& OnBeginLooting, UNarrativeInventoryComponent* LootSource)
{
	...
	_Script_NarrativeArsenal_eventOnBeginLooting_Parms Parms;
...
struct Z_Construct_UDelegateFunction_NarrativeArsenal_OnEndLooting__DelegateSignature_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Public/Items/InventoryComponent.h" },
...
const UECodeGen_Private::FFunctionParams Z_Construct_UDelegateFunction_NarrativeArsenal_OnEndLooting__DelegateSignature_Statics::FuncParams = { (UObject*(*)())Z_Construct_UPackage__Script_NarrativeArsenal, nullptr, "OnEndLooting__DelegateSignature", nullptr, nullptr, nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00130000, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_NarrativeArsenal_OnEndLooting__DelegateSignature_Statics::Function_MetaDataParams), Z_Construct_UDelegateFunction_NarrativeArsenal_OnEndLooting__DelegateSignature_Statics::Function_MetaDataParams) };
UFunction* Z_Construct_UDelegateFunction_NarrativeArsenal_OnEndLooting__DelegateSignature()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UDelegateFunction_NarrativeArsenal_OnEndLooting__DelegateSignature_Statics::FuncParams);
	}
	return ReturnFunction;
}
...
struct Z_Construct_UDelegateFunction_NarrativeArsenal_OnItemUsed__DelegateSignature_Statics
{
	struct _Script_NarrativeArsenal_eventOnItemUsed_Parms
	{
		UNarrativeItem* Item;
	};
#if WITH_METADATA
...
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UDelegateFunction_NarrativeArsenal_OnItemUsed__DelegateSignature_Statics::NewProp_Item = { "Item", nullptr, (EPropertyFlags)0x0010000000080080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(_Script_NarrativeArsenal_eventOnItemUsed_Parms, Item), Z_Construct_UClass_UNarrativeItem_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_Item_MetaData), NewProp_Item_MetaData) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UDelegateFunction_NarrativeArsenal_OnItemUsed__DelegateSignature_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_NarrativeArsenal_OnItemUsed__DelegateSignature_Statics::NewProp_Item,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_NarrativeArsenal_OnItemUsed__DelegateSignature_Statics::PropPointers) < 2048);
const UECodeGen_Private::FFunctionParams Z_Construct_UDelegateFunction_NarrativeArsenal_OnItemUsed__DelegateSignature_Statics::FuncParams = { (UObject*(*)())Z_Construct_UPackage__Script_NarrativeArsenal, nullptr, "OnItemUsed__DelegateSignature", nullptr, nullptr, Z_Construct_UDelegateFunction_NarrativeArsenal_OnItemUsed__DelegateSignature_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_NarrativeArsenal_OnItemUsed__DelegateSignature_Statics::PropPointers), sizeof(Z_Construct_UDelegateFunction_NarrativeArsenal_OnItemUsed__DelegateSignature_Statics::_Script_NarrativeArsenal_eventOnItemUsed_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00130000, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_NarrativeArsenal_OnItemUsed__DelegateSignature_Statics::Function_MetaDataParams), Z_Construct_UDelegateFunction_NarrativeArsenal_OnItemUsed__DelegateSignature_Statics::Function_MetaDataParams) };
static_assert(sizeof(Z_Construct_UDelegateFunction_NarrativeArsenal_OnItemUsed__DelegateSignature_Statics::_Script_NarrativeArsenal_eventOnItemUsed_Parms) < MAX_uint16);
UFunction* Z_Construct_UDelegateFunction_NarrativeArsenal_OnItemUsed__DelegateSignature()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UDelegateFunction_NarrativeArsenal_OnItemUsed__DelegateSignature_Statics::FuncParams);
	}
	return ReturnFunction;
}
void FOnItemUsed_DelegateWrapper(const FMulticastScriptDelegate& OnItemUsed, UNarrativeItem* Item)
{
	...
	_Script_NarrativeArsenal_eventOnItemUsed_Parms Parms;
	Parms.Item=Item;
...
struct Z_Construct_UDelegateFunction_NarrativeArsenal_OnCurrencyChanged__DelegateSignature_Statics
{
	struct _Script_NarrativeArsenal_eventOnCurrencyChanged_Parms
	{
		int32 OldCurrency;
		int32 NewCurrency;
	};
...
const UECodeGen_Private::FIntPropertyParams Z_Construct_UDelegateFunction_NarrativeArsenal_OnCurrencyChanged__DelegateSignature_Statics::NewProp_OldCurrency = { "OldCurrency", nullptr, (EPropertyFlags)0x0010000000000082, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(_Script_NarrativeArsenal_eventOnCurrencyChanged_Parms, OldCurrency), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_OldCurrency_MetaData), NewProp_OldCurrency_MetaData) };
const UECodeGen_Private::FIntPropertyParams Z_Construct_UDelegateFunction_NarrativeArsenal_OnCurrencyChanged__DelegateSignature_Statics::NewProp_NewCurrency = { "NewCurrency", nullptr, (EPropertyFlags)0x0010000000000082, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(_Script_NarrativeArsenal_eventOnCurrencyChanged_Parms, NewCurrency), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_NewCurrency_MetaData), NewProp_NewCurrency_MetaData) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UDelegateFunction_NarrativeArsenal_OnCurrencyChanged__DelegateSignature_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_NarrativeArsenal_OnCurrencyChanged__DelegateSignature_Statics::NewProp_OldCurrency,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_NarrativeArsenal_OnCurrencyChanged__DelegateSignature_Statics::NewProp_NewCurrency,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_NarrativeArsenal_OnCurrencyChanged__DelegateSignature_Statics::PropPointers) < 2048);
const UECodeGen_Private::FFunctionParams Z_Construct_UDelegateFunction_NarrativeArsenal_OnCurrencyChanged__DelegateSignature_Statics::FuncParams = { (UObject*(*)())Z_Construct_UPackage__Script_NarrativeArsenal, nullptr, "OnCurrencyChanged__DelegateSignature", nullptr, nullptr, Z_Construct_UDelegateFunction_NarrativeArsenal_OnCurrencyChanged__DelegateSignature_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_NarrativeArsenal_OnCurrencyChanged__DelegateSignature_Statics::PropPointers), sizeof(Z_Construct_UDelegateFunction_NarrativeArsenal_OnCurrencyChanged__DelegateSignature_Statics::_Script_NarrativeArsenal_eventOnCurrencyChanged_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00130000, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_NarrativeArsenal_OnCurrencyChanged__DelegateSignature_Statics::Function_MetaDataParams), Z_Construct_UDelegateFunction_NarrativeArsenal_OnCurrencyChanged__DelegateSignature_Statics::Function_MetaDataParams) };
static_assert(sizeof(Z_Construct_UDelegateFunction_NarrativeArsenal_OnCurrencyChanged__DelegateSignature_Statics::_Script_NarrativeArsenal_eventOnCurrencyChanged_Parms) < MAX_uint16);
UFunction* Z_Construct_UDelegateFunction_NarrativeArsenal_OnCurrencyChanged__DelegateSignature()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UDelegateFunction_NarrativeArsenal_OnCurrencyChanged__DelegateSignature_Statics::FuncParams);
	}
	return ReturnFunction;
}
void FOnCurrencyChanged_DelegateWrapper(const FMulticastScriptDelegate& OnCurrencyChanged, const int32 OldCurrency, const int32 NewCurrency)
{
	...
	_Script_NarrativeArsenal_eventOnCurrencyChanged_Parms Parms;
...
class UScriptStruct* FItemWithQuantity::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_ItemWithQuantity.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FItemWithQuantity, (UObject*)Z_Construct_UPackage__Script_NarrativeArsenal(), TEXT("ItemWithQuantity"));
	}
	return Z_Registration_Info_UScriptStruct_ItemWithQuantity.OuterSingleton;
}
template<> NARRATIVEARSENAL_API UScriptStruct* StaticStruct<FItemWithQuantity>()
{
...
const UECodeGen_Private::FSoftClassPropertyParams Z_Construct_UScriptStruct_FItemWithQuantity_Statics::NewProp_Item = { "Item", nullptr, (EPropertyFlags)0x0014000000000015, UECodeGen_Private::EPropertyGenFlags::SoftClass, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FItemWithQuantity, Item), Z_Construct_UClass_UNarrativeItem_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_Item_MetaData), NewProp_Item_MetaData) };
const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FItemWithQuantity_Statics::NewProp_Quantity = { "Quantity", nullptr, (EPropertyFlags)0x0010000000000015, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FItemWithQuantity, Quantity), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_Quantity_MetaData), NewProp_Quantity_MetaData) };
...
struct Z_Construct_UClass_UItemCollection_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam Class_MetaDataParams[] = {
		...
		{ "IncludePath", "Items/InventoryComponent.h" },
		{ "ModuleRelativePath", "Public/Items/InventoryComponent.h" },
...
const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UItemCollection_Statics::NewProp_Items_Inner = { "Items", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UScriptStruct_FItemWithQuantity, METADATA_PARAMS(0, nullptr) }; // 1532294103
const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UItemCollection_Statics::NewProp_Items = { "Items", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UItemCollection, Items), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_Items_MetaData), NewProp_Items_MetaData) }; // 1532294103
...
template<> NARRATIVEARSENAL_API UClass* StaticClass<UItemCollection>()
{
	return UItemCollection::StaticClass();
}
...
class UScriptStruct* FLootTableRoll::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_LootTableRoll.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FLootTableRoll, (UObject*)Z_Construct_UPackage__Script_NarrativeArsenal(), TEXT("LootTableRoll"));
	}
	return Z_Registration_Info_UScriptStruct_LootTableRoll.OuterSingleton;
}
template<> NARRATIVEARSENAL_API UScriptStruct* StaticStruct<FLootTableRoll>()
{
...
struct Z_Construct_UScriptStruct_FLootTableRoll_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_ItemsToGrant_MetaData[] = {
		{ "Category", "Loot Table Row" },
		{ "Comment", "//The items to grant - these will always be granted \n" },
		{ "ModuleRelativePath", "Public/Items/InventoryComponent.h" },
		{ "ToolTip", "The items to grant - these will always be granted" },
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_ItemCollectionsToGrant_MetaData[] = {
		{ "Category", "Loot Table Row" },
		{ "Comment", "//Item collections to grant - these will always be granted\n" },
		{ "ModuleRelativePath", "Public/Items/InventoryComponent.h" },
		{ "ToolTip", "Item collections to grant - these will always be granted" },
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_TableToRoll_MetaData[] = {
		{ "Category", "Loot Table Row" },
		{ "Comment", "//The items to grant if this row is given to the inventory \n" },
		{ "ModuleRelativePath", "Public/Items/InventoryComponent.h" },
		{ "RequiredAssetDataTags", "RowStructure=/Script/NarrativeArsenal.LootTableRow" },
		{ "ToolTip", "The items to grant if this row is given to the inventory" },
	};
...
const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FLootTableRoll_Statics::NewProp_ItemsToGrant_Inner = { "ItemsToGrant", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UScriptStruct_FItemWithQuantity, METADATA_PARAMS(0, nullptr) }; // 1532294103
const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FLootTableRoll_Statics::NewProp_ItemsToGrant = { "ItemsToGrant", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FLootTableRoll, ItemsToGrant), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_ItemsToGrant_MetaData), NewProp_ItemsToGrant_MetaData) }; // 1532294103
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UScriptStruct_FLootTableRoll_Statics::NewProp_ItemCollectionsToGrant_Inner = { "ItemCollectionsToGrant", nullptr, (EPropertyFlags)0x0104000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UClass_UItemCollection_NoRegister, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FLootTableRoll_Statics::NewProp_ItemCollectionsToGrant = { "ItemCollectionsToGrant", nullptr, (EPropertyFlags)0x0114000000000001, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FLootTableRoll, ItemCollectionsToGrant), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_ItemCollectionsToGrant_MetaData), NewProp_ItemCollectionsToGrant_MetaData) };
...
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UScriptStruct_FLootTableRoll_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FLootTableRoll_Statics::NewProp_ItemsToGrant_Inner,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FLootTableRoll_Statics::NewProp_ItemsToGrant,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FLootTableRoll_Statics::NewProp_ItemCollectionsToGrant_Inner,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FLootTableRoll_Statics::NewProp_ItemCollectionsToGrant,
...
class UScriptStruct* FLootTableRow::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_LootTableRow.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FLootTableRow, (UObject*)Z_Construct_UPackage__Script_NarrativeArsenal(), TEXT("LootTableRow"));
	}
	return Z_Registration_Info_UScriptStruct_LootTableRow.OuterSingleton;
}
template<> NARRATIVEARSENAL_API UScriptStruct* StaticStruct<FLootTableRow>()
{
...
const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FLootTableRow_Statics::NewProp_ItemsToGrant_Inner = { "ItemsToGrant", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UScriptStruct_FItemWithQuantity, METADATA_PARAMS(0, nullptr) }; // 1532294103
const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FLootTableRow_Statics::NewProp_ItemsToGrant = { "ItemsToGrant", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FLootTableRow, ItemsToGrant), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_ItemsToGrant_MetaData), NewProp_ItemsToGrant_MetaData) }; // 1532294103
...
class UScriptStruct* FNarrativeSavedItem::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_NarrativeSavedItem.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FNarrativeSavedItem, (UObject*)Z_Construct_UPackage__Script_NarrativeArsenal(), TEXT("NarrativeSavedItem"));
	}
	return Z_Registration_Info_UScriptStruct_NarrativeSavedItem.OuterSingleton;
}
template<> NARRATIVEARSENAL_API UScriptStruct* StaticStruct<FNarrativeSavedItem>()
{
...
struct Z_Construct_UScriptStruct_FNarrativeSavedItem_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_Quantity_MetaData[] = {
		{ "Comment", "//TODO quantity and bActive are fields on UNarrativeItem, we can probably just mark those as SaveGame rather than storing in here \n" },
		{ "ModuleRelativePath", "Public/Items/InventoryComponent.h" },
		{ "ToolTip", "TODO quantity and bActive are fields on UNarrativeItem, we can probably just mark those as SaveGame rather than storing in here" },
	};
...
// Begin Class UNarrativeInventoryComponent Function GetItemsOfClass
struct Z_Construct_UFunction_UNarrativeInventoryComponent_GetItemsOfClass_Statics
{
	struct NarrativeInventoryComponent_eventGetItemsOfClass_Parms
	{
		TSubclassOf<UNarrativeItem> ItemClass;
		TArray<UNarrativeItem*> OutItems;
		bool bCheckVisibility;
		bool ReturnValue;
	};
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[] = {
		{ "Category", "Inventory" },
		{ "Comment", "//Return the items that match the given class\n" },
		{ "CPP_Default_bCheckVisibility", "false" },
		{ "DeterminesOutputType", "ItemClass" },
		{ "DynamicOutputParam", "OutItems" },
		{ "ModuleRelativePath", "Public/Items/InventoryComponent.h" },
		{ "ToolTip", "Return the items that match the given class" },
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_OutItems_MetaData[] = {
		{ "EditInline", "true" },
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_bCheckVisibility_MetaData[] = {
		{ "NativeConst", "" },
...
const UECodeGen_Private::FClassPropertyParams Z_Construct_UFunction_UNarrativeInventoryComponent_GetItemsOfClass_Statics::NewProp_ItemClass = { "ItemClass", nullptr, (EPropertyFlags)0x0014000000000080, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(NarrativeInventoryComponent_eventGetItemsOfClass_Parms, ItemClass), Z_Construct_UClass_UClass, Z_Construct_UClass_UNarrativeItem_NoRegister, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UNarrativeInventoryComponent_GetItemsOfClass_Statics::NewProp_OutItems_Inner = { "OutItems", nullptr, (EPropertyFlags)0x0000000000080000, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UClass_UNarrativeItem_NoRegister, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FArrayPropertyParams Z_Construct_UFunction_UNarrativeInventoryComponent_GetItemsOfClass_Statics::NewProp_OutItems = { "OutItems", nullptr, (EPropertyFlags)0x0010008000000180, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(NarrativeInventoryComponent_eventGetItemsOfClass_Parms, OutItems), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_OutItems_MetaData), NewProp_OutItems_MetaData) };
void Z_Construct_UFunction_UNarrativeInventoryComponent_GetItemsOfClass_Statics::NewProp_bCheckVisibility_SetBit(void* Obj)
{
	((NarrativeInventoryComponent_eventGetItemsOfClass_Parms*)Obj)->bCheckVisibility = 1;
}
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UNarrativeInventoryComponent_GetItemsOfClass_Statics::NewProp_bCheckVisibility = { "bCheckVisibility", nullptr, (EPropertyFlags)0x0010000000000082, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(NarrativeInventoryComponent_eventGetItemsOfClass_Parms), &Z_Construct_UFunction_UNarrativeInventoryComponent_GetItemsOfClass_Statics::NewProp_bCheckVisibility_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_bCheckVisibility_MetaData), NewProp_bCheckVisibility_MetaData) };
void Z_Construct_UFunction_UNarrativeInventoryComponent_GetItemsOfClass_Statics::NewProp_ReturnValue_SetBit(void* Obj)
{
	((NarrativeInventoryComponent_eventGetItemsOfClass_Parms*)Obj)->ReturnValue = 1;
}
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UNarrativeInventoryComponent_GetItemsOfClass_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(NarrativeInventoryComponent_eventGetItemsOfClass_Parms), &Z_Construct_UFunction_UNarrativeInventoryComponent_GetItemsOfClass_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UNarrativeInventoryComponent_GetItemsOfClass_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UNarrativeInventoryComponent_GetItemsOfClass_Statics::NewProp_ItemClass,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UNarrativeInventoryComponent_GetItemsOfClass_Statics::NewProp_OutItems_Inner,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UNarrativeInventoryComponent_GetItemsOfClass_Statics::NewProp_OutItems,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UNarrativeInventoryComponent_GetItemsOfClass_Statics::NewProp_bCheckVisibility,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UNarrativeInventoryComponent_GetItemsOfClass_Statics::NewProp_ReturnValue,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UNarrativeInventoryComponent_GetItemsOfClass_Statics::PropPointers) < 2048);
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UNarrativeInventoryComponent_GetItemsOfClass_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UNarrativeInventoryComponent, nullptr, "GetItemsOfClass", nullptr, nullptr, Z_Construct_UFunction_UNarrativeInventoryComponent_GetItemsOfClass_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UNarrativeInventoryComponent_GetItemsOfClass_Statics::PropPointers), sizeof(Z_Construct_UFunction_UNarrativeInventoryComponent_GetItemsOfClass_Statics::NarrativeInventoryComponent_eventGetItemsOfClass_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54420401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UNarrativeInventoryComponent_GetItemsOfClass_Statics::Function_MetaDataParams), Z_Construct_UFunction_UNarrativeInventoryComponent_GetItemsOfClass_Statics::Function_MetaDataParams) };
static_assert(sizeof(Z_Construct_UFunction_UNarrativeInventoryComponent_GetItemsOfClass_Statics::NarrativeInventoryComponent_eventGetItemsOfClass_Parms) < MAX_uint16);
UFunction* Z_Construct_UFunction_UNarrativeInventoryComponent_GetItemsOfClass()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UNarrativeInventoryComponent_GetItemsOfClass_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(UNarrativeInventoryComponent::execGetItemsOfClass)
{
	P_GET_OBJECT(UClass,Z_Param_ItemClass);
	P_GET_TARRAY_REF(UNarrativeItem*,Z_Param_Out_OutItems);
	P_GET_UBOOL(Z_Param_bCheckVisibility);
	P_FINISH;
	P_NATIVE_BEGIN;
	*(bool*)Z_Param__Result=P_THIS->GetItemsOfClass(Z_Param_ItemClass,Z_Param_Out_OutItems,Z_Param_bCheckVisibility);
	P_NATIVE_END;
}
// End Class UNarrativeInventoryComponent Function GetItemsOfClass

// Begin Class UNarrativeInventoryComponent Function GetItemsUsableWith
struct Z_Construct_UFunction_UNarrativeInventoryComponent_GetItemsUsableWith_Statics
{
	struct NarrativeInventoryComponent_eventGetItemsUsableWith_Parms
	{
		UNarrativeItem* Item;
		TArray<UNarrativeItem*> OutItems;
		bool bCheckVisibility;
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[] = {
		{ "Category", "Inventory" },
		{ "Comment", "//Return all items that the supplied item can be used on \n" },
		{ "CPP_Default_bCheckVisibility", "false" },
		{ "DeterminesOutputType", "ItemClass" },
		{ "DynamicOutputParam", "OutItems" },
		{ "ModuleRelativePath", "Public/Items/InventoryComponent.h" },
		{ "ToolTip", "Return all items that the supplied item can be used on" },
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_Item_MetaData[] = {
		{ "EditInline", "true" },
	};
...
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UNarrativeInventoryComponent_GetItemsUsableWith_Statics::NewProp_Item = { "Item", nullptr, (EPropertyFlags)0x0010000000080080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(NarrativeInventoryComponent_eventGetItemsUsableWith_Parms, Item), Z_Construct_UClass_UNarrativeItem_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_Item_MetaData), NewProp_Item_MetaData) };
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UNarrativeInventoryComponent_GetItemsUsableWith_Statics::NewProp_OutItems_Inner = { "OutItems", nullptr, (EPropertyFlags)0x0000000000080000, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UClass_UNarrativeItem_NoRegister, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FArrayPropertyParams Z_Construct_UFunction_UNarrativeInventoryComponent_GetItemsUsableWith_Statics::NewProp_OutItems = { "OutItems", nullptr, (EPropertyFlags)0x0010008000000180, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(NarrativeInventoryComponent_eventGetItemsUsableWith_Parms, OutItems), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_OutItems_MetaData), NewProp_OutItems_MetaData) };
void Z_Construct_UFunction_UNarrativeInventoryComponent_GetItemsUsableWith_Statics::NewProp_bCheckVisibility_SetBit(void* Obj)
{
	((NarrativeInventoryComponent_eventGetItemsUsableWith_Parms*)Obj)->bCheckVisibility = 1;
}
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UNarrativeInventoryComponent_GetItemsUsableWith_Statics::NewProp_bCheckVisibility = { "bCheckVisibility", nullptr, (EPropertyFlags)0x0010000000000082, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(NarrativeInventoryComponent_eventGetItemsUsableWith_Parms), &Z_Construct_UFunction_UNarrativeInventoryComponent_GetItemsUsableWith_Statics::NewProp_bCheckVisibility_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_bCheckVisibility_MetaData), NewProp_bCheckVisibility_MetaData) };
void Z_Construct_UFunction_UNarrativeInventoryComponent_GetItemsUsableWith_Statics::NewProp_ReturnValue_SetBit(void* Obj)
{
	((NarrativeInventoryComponent_eventGetItemsUsableWith_Parms*)Obj)->ReturnValue = 1;
}
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UNarrativeInventoryComponent_GetItemsUsableWith_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(NarrativeInventoryComponent_eventGetItemsUsableWith_Parms), &Z_Construct_UFunction_UNarrativeInventoryComponent_GetItemsUsableWith_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UNarrativeInventoryComponent_GetItemsUsableWith_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UNarrativeInventoryComponent_GetItemsUsableWith_Statics::NewProp_Item,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UNarrativeInventoryComponent_GetItemsUsableWith_Statics::NewProp_OutItems_Inner,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UNarrativeInventoryComponent_GetItemsUsableWith_Statics::NewProp_OutItems,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UNarrativeInventoryComponent_GetItemsUsableWith_Statics::NewProp_bCheckVisibility,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UNarrativeInventoryComponent_GetItemsUsableWith_Statics::NewProp_ReturnValue,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UNarrativeInventoryComponent_GetItemsUsableWith_Statics::PropPointers) < 2048);
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UNarrativeInventoryComponent_GetItemsUsableWith_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UNarrativeInventoryComponent, nullptr, "GetItemsUsableWith", nullptr, nullptr, Z_Construct_UFunction_UNarrativeInventoryComponent_GetItemsUsableWith_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UNarrativeInventoryComponent_GetItemsUsableWith_Statics::PropPointers), sizeof(Z_Construct_UFunction_UNarrativeInventoryComponent_GetItemsUsableWith_Statics::NarrativeInventoryComponent_eventGetItemsUsableWith_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54420401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UNarrativeInventoryComponent_GetItemsUsableWith_Statics::Function_MetaDataParams), Z_Construct_UFunction_UNarrativeInventoryComponent_GetItemsUsableWith_Statics::Function_MetaDataParams) };
static_assert(sizeof(Z_Construct_UFunction_UNarrativeInventoryComponent_GetItemsUsableWith_Statics::NarrativeInventoryComponent_eventGetItemsUsableWith_Parms) < MAX_uint16);
UFunction* Z_Construct_UFunction_UNarrativeInventoryComponent_GetItemsUsableWith()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UNarrativeInventoryComponent_GetItemsUsableWith_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(UNarrativeInventoryComponent::execGetItemsUsableWith)
{
	P_GET_OBJECT(UNarrativeItem,Z_Param_Item);
	P_GET_TARRAY_REF(UNarrativeItem*,Z_Param_Out_OutItems);
	P_GET_UBOOL(Z_Param_bCheckVisibility);
	P_FINISH;
	P_NATIVE_BEGIN;
	*(bool*)Z_Param__Result=P_THIS->GetItemsUsableWith(Z_Param_Item,Z_Param_Out_OutItems,Z_Param_bCheckVisibility);
	P_NATIVE_END;
}
// End Class UNarrativeInventoryComponent Function GetItemsUsableWith
...
{
	UNarrativeItem* Item;
	UNarrativeItem* OtherItem;
};
static const FName NAME_UNarrativeInventoryComponent_ServerUseItem = FName(TEXT("ServerUseItem"));
void UNarrativeInventoryComponent::ServerUseItem(UNarrativeItem* Item, UNarrativeItem* OtherItem)
{
...
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UNarrativeInventoryComponent_ServerUseItem_Statics::NewProp_OtherItem = { "OtherItem", nullptr, (EPropertyFlags)0x0010000000080080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(NarrativeInventoryComponent_eventServerUseItem_Parms, OtherItem), Z_Construct_UClass_UNarrativeItem_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_OtherItem_MetaData), NewProp_OtherItem_MetaData) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UNarrativeInventoryComponent_ServerUseItem_Statics::PropPointers[] = {
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UNarrativeInventoryComponent_ServerUseItem_Statics::NewProp_OtherItem,
};
...
{
	P_GET_OBJECT(UNarrativeItem,Z_Param_Item);
	P_GET_OBJECT(UNarrativeItem,Z_Param_OtherItem);
	P_FINISH;
	P_NATIVE_BEGIN;
	P_THIS->ServerUseItem_Implementation(Z_Param_Item,Z_Param_OtherItem);
	P_NATIVE_END;
}
...
const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UNarrativeInventoryComponent_TryAddFromLootTable_Statics::NewProp_OutItemAddResults_Inner = { "OutItemAddResults", nullptr, (EPropertyFlags)0x0000008000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UScriptStruct_FItemAddResult, METADATA_PARAMS(0, nullptr) }; // 4140060516
const UECodeGen_Private::FArrayPropertyParams Z_Construct_UFunction_UNarrativeInventoryComponent_TryAddFromLootTable_Statics::NewProp_OutItemAddResults = { "OutItemAddResults", nullptr, (EPropertyFlags)0x0010008000000180, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(NarrativeInventoryComponent_eventTryAddFromLootTable_Parms, OutItemAddResults), EArrayPropertyFlags::None, METADATA_PARAMS(0, nullptr) }; // 4140060516
...
const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UNarrativeInventoryComponent_TryAddItemFromClass_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010008000000580, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(NarrativeInventoryComponent_eventTryAddItemFromClass_Parms, ReturnValue), Z_Construct_UScriptStruct_FItemAddResult, METADATA_PARAMS(0, nullptr) }; // 4140060516
...
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UNarrativeInventoryComponent_UseItem_Statics::NewProp_OtherItem = { "OtherItem", nullptr, (EPropertyFlags)0x0010000000080080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(NarrativeInventoryComponent_eventUseItem_Parms, OtherItem), Z_Construct_UClass_UNarrativeItem_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_OtherItem_MetaData), NewProp_OtherItem_MetaData) };
...
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UNarrativeInventoryComponent_UseItem_Statics::PropPointers[] = {
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UNarrativeInventoryComponent_UseItem_Statics::NewProp_OtherItem,
...
DEFINE_FUNCTION(UNarrativeInventoryComponent::execUseItem)
{
	...
	P_FINISH;
	P_NATIVE_BEGIN;
	*(bool*)Z_Param__Result=P_THIS->UseItem(Z_Param_Item,Z_Param_OtherItem);
	P_NATIVE_END;
}
...
void UNarrativeInventoryComponent::StaticRegisterNativesUNarrativeInventoryComponent()
{
	...
	static const FNameNativePtrPair Funcs[] = {
		...
		{ "GetItemsOfClass", &UNarrativeInventoryComponent::execGetItemsOfClass },
		{ "GetItemsUsableWith", &UNarrativeInventoryComponent::execGetItemsUsableWith },
...
struct Z_Construct_UClass_UNarrativeInventoryComponent_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_TickItems_MetaData[] = {
		{ "Comment", "/**Item that want to tick are stored in here so we can tick them. */" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "Public/Items/InventoryComponent.h" },
		{ "ToolTip", "Item that want to tick are stored in here so we can tick them." },
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_Items_MetaData[] = {
		{ "Category", "Inventory" },
	...
	static const UECodeGen_Private::FObjectPropertyParams NewProp_LootSource;
	static const UECodeGen_Private::FObjectPropertyParams NewProp_TickItems_ElementProp;
	static const UECodeGen_Private::FSetPropertyParams NewProp_TickItems;
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_UNarrativeInventoryComponent_AddCurrency, "AddCurrency" }, // 2292157800
		{ &Z_Construct_UFunction_UNarrativeInventoryComponent_AllowLootItem, "AllowLootItem" }, // 3437077991
		{ &Z_Construct_UFunction_UNarrativeInventoryComponent_AllowStoreItem, "AllowStoreItem" }, // 436888575
		{ &Z_Construct_UFunction_UNarrativeInventoryComponent_ClientRefreshInventory, "ClientRefreshInventory" }, // 468066886
		{ &Z_Construct_UFunction_UNarrativeInventoryComponent_ConsumeItem, "ConsumeItem" }, // 3745764214
		{ &Z_Construct_UFunction_UNarrativeInventoryComponent_FindItemByClass, "FindItemByClass" }, // 3694880537
		{ &Z_Construct_UFunction_UNarrativeInventoryComponent_FindItemsOfClass, "FindItemsOfClass" }, // 2794296058
		{ &Z_Construct_UFunction_UNarrativeInventoryComponent_GetBuyPrice, "GetBuyPrice" }, // 1712984902
		{ &Z_Construct_UFunction_UNarrativeInventoryComponent_GetCapacity, "GetCapacity" }, // 44787261
		{ &Z_Construct_UFunction_UNarrativeInventoryComponent_GetCurrency, "GetCurrency" }, // 3950316659
		{ &Z_Construct_UFunction_UNarrativeInventoryComponent_GetCurrentWeight, "GetCurrentWeight" }, // 79035112
		{ &Z_Construct_UFunction_UNarrativeInventoryComponent_GetItems, "GetItems" }, // 827061652
		{ &Z_Construct_UFunction_UNarrativeInventoryComponent_GetItemsOfClass, "GetItemsOfClass" }, // 3854102382
		{ &Z_Construct_UFunction_UNarrativeInventoryComponent_GetItemsUsableWith, "GetItemsUsableWith" }, // 1096076363
		{ &Z_Construct_UFunction_UNarrativeInventoryComponent_GetOwningController, "GetOwningController" }, // 1175422411
		{ &Z_Construct_UFunction_UNarrativeInventoryComponent_GetOwningPawn, "GetOwningPawn" }, // 1244494677
		{ &Z_Construct_UFunction_UNarrativeInventoryComponent_GetSellPrice, "GetSellPrice" }, // 1535554189
		{ &Z_Construct_UFunction_UNarrativeInventoryComponent_GetSpaceForItem, "GetSpaceForItem" }, // 590523231
		{ &Z_Construct_UFunction_UNarrativeInventoryComponent_GetWeightCapacity, "GetWeightCapacity" }, // 474507649
		{ &Z_Construct_UFunction_UNarrativeInventoryComponent_GiveDefaultItems, "GiveDefaultItems" }, // 234586809
		{ &Z_Construct_UFunction_UNarrativeInventoryComponent_HasItem, "HasItem" }, // 2665443296
		{ &Z_Construct_UFunction_UNarrativeInventoryComponent_OnRep_Currency, "OnRep_Currency" }, // 238440912
		{ &Z_Construct_UFunction_UNarrativeInventoryComponent_OnRep_Items, "OnRep_Items" }, // 1922096965
		{ &Z_Construct_UFunction_UNarrativeInventoryComponent_OnRep_LootSource, "OnRep_LootSource" }, // 2667656943
		{ &Z_Construct_UFunction_UNarrativeInventoryComponent_RemoveItem, "RemoveItem" }, // 3481786315
		{ &Z_Construct_UFunction_UNarrativeInventoryComponent_RequestLootItem, "RequestLootItem" }, // 3038913044
		{ &Z_Construct_UFunction_UNarrativeInventoryComponent_RequestStoreItem, "RequestStoreItem" }, // 158749930
		{ &Z_Construct_UFunction_UNarrativeInventoryComponent_ServerConsumeItem, "ServerConsumeItem" }, // 3762763630
		{ &Z_Construct_UFunction_UNarrativeInventoryComponent_ServerRemoveItem, "ServerRemoveItem" }, // 1384160790
		{ &Z_Construct_UFunction_UNarrativeInventoryComponent_ServerRequestLootItem, "ServerRequestLootItem" }, // 3098625527
		{ &Z_Construct_UFunction_UNarrativeInventoryComponent_ServerRequestStoreItem, "ServerRequestStoreItem" }, // 3535347294
		{ &Z_Construct_UFunction_UNarrativeInventoryComponent_ServerStopLooting, "ServerStopLooting" }, // 3194631614
		{ &Z_Construct_UFunction_UNarrativeInventoryComponent_ServerUseItem, "ServerUseItem" }, // 3701305025
		{ &Z_Construct_UFunction_UNarrativeInventoryComponent_SetCapacity, "SetCapacity" }, // 1378052656
		{ &Z_Construct_UFunction_UNarrativeInventoryComponent_SetCurrency, "SetCurrency" }, // 44334207
		{ &Z_Construct_UFunction_UNarrativeInventoryComponent_SetInventoryFriendlyName, "SetInventoryFriendlyName" }, // 3064767472
		{ &Z_Construct_UFunction_UNarrativeInventoryComponent_SetIsVendor, "SetIsVendor" }, // 2849696095
		{ &Z_Construct_UFunction_UNarrativeInventoryComponent_SetLootSource, "SetLootSource" }, // 574466560
		{ &Z_Construct_UFunction_UNarrativeInventoryComponent_SetWeightCapacity, "SetWeightCapacity" }, // 343925067
		{ &Z_Construct_UFunction_UNarrativeInventoryComponent_StopLooting, "StopLooting" }, // 860406676
		{ &Z_Construct_UFunction_UNarrativeInventoryComponent_TryAddFromLootTable, "TryAddFromLootTable" }, // 4251661903
		{ &Z_Construct_UFunction_UNarrativeInventoryComponent_TryAddItemFromClass, "TryAddItemFromClass" }, // 909992655
		{ &Z_Construct_UFunction_UNarrativeInventoryComponent_UseItem, "UseItem" }, // 3806126244
	};
...
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UNarrativeInventoryComponent_Statics::NewProp_TickItems_ElementProp = { "TickItems", nullptr, (EPropertyFlags)0x0104000000080008, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UClass_UNarrativeItem_NoRegister, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FSetPropertyParams Z_Construct_UClass_UNarrativeInventoryComponent_Statics::NewProp_TickItems = { "TickItems", nullptr, (EPropertyFlags)0x0124088000000008, UECodeGen_Private::EPropertyGenFlags::Set, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNarrativeInventoryComponent, TickItems), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_TickItems_MetaData), NewProp_TickItems_MetaData) };
...
const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UNarrativeInventoryComponent_Statics::NewProp_DefaultItems_Inner = { "DefaultItems", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UScriptStruct_FItemWithQuantity, METADATA_PARAMS(0, nullptr) }; // 1532294103
...
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UNarrativeInventoryComponent_Statics::PropPointers[] = {
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UNarrativeInventoryComponent_Statics::NewProp_TickItems_ElementProp,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UNarrativeInventoryComponent_Statics::NewProp_TickItems,
...
template<> NARRATIVEARSENAL_API UClass* StaticClass<UNarrativeInventoryComponent>()
{
	return UNarrativeInventoryComponent::StaticClass();
}
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeArsenal_Public_Items_InventoryComponent_h_Statics
{
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FItemAddResult::StaticStruct, Z_Construct_UScriptStruct_FItemAddResult_Statics::NewStructOps, TEXT("ItemAddResult"), &Z_Registration_Info_UScriptStruct_ItemAddResult, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FItemAddResult), 4140060516U) },
		{ FItemWithQuantity::StaticStruct, Z_Construct_UScriptStruct_FItemWithQuantity_Statics::NewStructOps, TEXT("ItemWithQuantity"), &Z_Registration_Info_UScriptStruct_ItemWithQuantity, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FItemWithQuantity), 1532294103U) },
		{ FLootTableRoll::StaticStruct, Z_Construct_UScriptStruct_FLootTableRoll_Statics::NewStructOps, TEXT("LootTableRoll"), &Z_Registration_Info_UScriptStruct_LootTableRoll, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FLootTableRoll), 1127129110U) },
		{ FLootTableRow::StaticStruct, Z_Construct_UScriptStruct_FLootTableRow_Statics::NewStructOps, TEXT("LootTableRow"), &Z_Registration_Info_UScriptStruct_LootTableRow, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FLootTableRow), 459189912U) },
		{ FNarrativeSavedItem::StaticStruct, Z_Construct_UScriptStruct_FNarrativeSavedItem_Statics::NewStructOps, TEXT("NarrativeSavedItem"), &Z_Registration_Info_UScriptStruct_NarrativeSavedItem, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FNarrativeSavedItem), 1537936968U) },
	};
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UItemCollection, UItemCollection::StaticClass, TEXT("UItemCollection"), &Z_Registration_Info_UClass_UItemCollection, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UItemCollection), 331613983U) },
		{ Z_Construct_UClass_UNarrativeInventoryComponent, UNarrativeInventoryComponent::StaticClass, TEXT("UNarrativeInventoryComponent"), &Z_Registration_Info_UClass_UNarrativeInventoryComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNarrativeInventoryComponent), 545639321U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeArsenal_Public_Items_InventoryComponent_h_3534984743(TEXT("/Script/NarrativeArsenal"),
	Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeArsenal_Public_Items_InventoryComponent_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeArsenal_Public_Items_InventoryComponent_h_Statics::ClassInfo),
	Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeArsenal_Public_Items_InventoryComponent_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeArsenal_Public_Items_InventoryComponent_h_Statics::ScriptStructInfo),
	nullptr, 0);
// End Registration
