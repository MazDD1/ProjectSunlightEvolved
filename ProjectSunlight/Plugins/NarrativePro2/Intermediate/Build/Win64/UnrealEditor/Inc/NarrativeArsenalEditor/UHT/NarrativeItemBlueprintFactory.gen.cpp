...
#include "NarrativeArsenalEditor/Private/NarrativeItemBlueprintFactory.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeNarrativeItemBlueprintFactory() {}

// Begin Cross Module References
NARRATIVEARSENALEDITOR_API UClass* Z_Construct_UClass_UItemCollectionFactory();
NARRATIVEARSENALEDITOR_API UClass* Z_Construct_UClass_UItemCollectionFactory_NoRegister();
NARRATIVEARSENALEDITOR_API UClass* Z_Construct_UClass_UNarrativeItemBlueprintFactory();
NARRATIVEARSENALEDITOR_API UClass* Z_Construct_UClass_UNarrativeItemBlueprintFactory_NoRegister();
...
template<> NARRATIVEARSENALEDITOR_API UClass* StaticClass<UNarrativeItemBlueprintFactory>()
{
	return UNarrativeItemBlueprintFactory::StaticClass();
}
...
template<> NARRATIVEARSENALEDITOR_API UClass* StaticClass<UItemCollectionFactory>()
{
	return UItemCollectionFactory::StaticClass();
}
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeArsenalEditor_Private_NarrativeItemBlueprintFactory_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UNarrativeItemBlueprintFactory, UNarrativeItemBlueprintFactory::StaticClass, TEXT("UNarrativeItemBlueprintFactory"), &Z_Registration_Info_UClass_UNarrativeItemBlueprintFactory, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNarrativeItemBlueprintFactory), 4007588489U) },
		{ Z_Construct_UClass_UItemCollectionFactory, UItemCollectionFactory::StaticClass, TEXT("UItemCollectionFactory"), &Z_Registration_Info_UClass_UItemCollectionFactory, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UItemCollectionFactory), 3719048466U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeArsenalEditor_Private_NarrativeItemBlueprintFactory_h_1780337313(TEXT("/Script/NarrativeArsenalEditor"),
	Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeArsenalEditor_Private_NarrativeItemBlueprintFactory_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeArsenalEditor_Private_NarrativeItemBlueprintFactory_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
