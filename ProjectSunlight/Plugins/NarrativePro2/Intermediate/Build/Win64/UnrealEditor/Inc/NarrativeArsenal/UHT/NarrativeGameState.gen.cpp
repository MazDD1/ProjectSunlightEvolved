...
struct Z_Construct_UClass_UScheduledBehavior_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_bDisabled_MetaData[] = {
		{ "Category", "Scheduled Behavior" },
		{ "Comment", "//Will disable the scheduled behavior\n" },
		{ "ModuleRelativePath", "Public/UnrealFramework/NarrativeGameState.h" },
		{ "ToolTip", "Will disable the scheduled behavior" },
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_StartTime_MetaData[] = {
		{ "Category", "Scheduled Behavior" },
		{ "Comment", "//time to begin scheduled behavior\n" },
		{ "ModuleRelativePath", "Public/UnrealFramework/NarrativeGameState.h" },
		{ "ToolTip", "time to begin scheduled behavior" },
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_EndTime_MetaData[] = {
		{ "Category", "Scheduled Behavior" },
		{ "Comment", "//time to end scheduled behavior\n" },
		{ "ModuleRelativePath", "Public/UnrealFramework/NarrativeGameState.h" },
		{ "ToolTip", "time to end scheduled behavior" },
	};
#endif // WITH_METADATA
...
void Z_Construct_UClass_UScheduledBehavior_Statics::NewProp_bDisabled_SetBit(void* Obj)
{
	((UScheduledBehavior*)Obj)->bDisabled = 1;
}
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UScheduledBehavior_Statics::NewProp_bDisabled = { "bDisabled", nullptr, (EPropertyFlags)0x0010000000010001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UScheduledBehavior), &Z_Construct_UClass_UScheduledBehavior_Statics::NewProp_bDisabled_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_bDisabled_MetaData), NewProp_bDisabled_MetaData) };
...
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UScheduledBehavior_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UScheduledBehavior_Statics::NewProp_bDisabled,
...
// Begin Class ANarrativeGameState Function AdvanceToTimeOfDay
struct Z_Construct_UFunction_ANarrativeGameState_AdvanceToTimeOfDay_Statics
{
	struct NarrativeGameState_eventAdvanceToTimeOfDay_Parms
	{
		float DesiredTime;
	};
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[] = {
		{ "Category", "Time of Day" },
		{ "Comment", "//Advances forward to the specified time of day \n" },
		{ "ModuleRelativePath", "Public/UnrealFramework/NarrativeGameState.h" },
		{ "ToolTip", "Advances forward to the specified time of day" },
	};
...
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_ANarrativeGameState_AdvanceToTimeOfDay_Statics::NewProp_DesiredTime = { "DesiredTime", nullptr, (EPropertyFlags)0x0010000000000082, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(NarrativeGameState_eventAdvanceToTimeOfDay_Parms, DesiredTime), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_DesiredTime_MetaData), NewProp_DesiredTime_MetaData) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_ANarrativeGameState_AdvanceToTimeOfDay_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_ANarrativeGameState_AdvanceToTimeOfDay_Statics::NewProp_DesiredTime,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_ANarrativeGameState_AdvanceToTimeOfDay_Statics::PropPointers) < 2048);
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_ANarrativeGameState_AdvanceToTimeOfDay_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ANarrativeGameState, nullptr, "AdvanceToTimeOfDay", nullptr, nullptr, Z_Construct_UFunction_ANarrativeGameState_AdvanceToTimeOfDay_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_ANarrativeGameState_AdvanceToTimeOfDay_Statics::PropPointers), sizeof(Z_Construct_UFunction_ANarrativeGameState_AdvanceToTimeOfDay_Statics::NarrativeGameState_eventAdvanceToTimeOfDay_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_ANarrativeGameState_AdvanceToTimeOfDay_Statics::Function_MetaDataParams), Z_Construct_UFunction_ANarrativeGameState_AdvanceToTimeOfDay_Statics::Function_MetaDataParams) };
static_assert(sizeof(Z_Construct_UFunction_ANarrativeGameState_AdvanceToTimeOfDay_Statics::NarrativeGameState_eventAdvanceToTimeOfDay_Parms) < MAX_uint16);
UFunction* Z_Construct_UFunction_ANarrativeGameState_AdvanceToTimeOfDay()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_ANarrativeGameState_AdvanceToTimeOfDay_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(ANarrativeGameState::execAdvanceToTimeOfDay)
{
	P_GET_PROPERTY(FFloatProperty,Z_Param_DesiredTime);
	P_FINISH;
	P_NATIVE_BEGIN;
	P_THIS->AdvanceToTimeOfDay(Z_Param_DesiredTime);
	P_NATIVE_END;
}
// End Class ANarrativeGameState Function AdvanceToTimeOfDay
...
void ANarrativeGameState::StaticRegisterNativesANarrativeGameState()
{
	...
	static const FNameNativePtrPair Funcs[] = {
		...
		{ "AdvanceToTimeOfDay", &ANarrativeGameState::execAdvanceToTimeOfDay },
...
struct Z_Construct_UClass_ANarrativeGameState_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_ANarrativeGameState_AdvanceToTimeOfDay, "AdvanceToTimeOfDay" }, // 1396018591
...
const UECodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_ANarrativeGameState_Statics::InterfaceParams[] = {
	{ Z_Construct_UClass_UNarrativeSavableActor_NoRegister, (int32)VTABLE_OFFSET(ANarrativeGameState, INarrativeSavableActor), false },  // 319030605
};
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeArsenal_Public_UnrealFramework_NarrativeGameState_h_Statics
{
	...
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		...
		{ Z_Construct_UClass_UScheduledBehavior, UScheduledBehavior::StaticClass, TEXT("UScheduledBehavior"), &Z_Registration_Info_UClass_UScheduledBehavior, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UScheduledBehavior), 3559903588U) },
		{ Z_Construct_UClass_ANarrativeGameState, ANarrativeGameState::StaticClass, TEXT("ANarrativeGameState"), &Z_Registration_Info_UClass_ANarrativeGameState, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ANarrativeGameState), 1281780354U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeArsenal_Public_UnrealFramework_NarrativeGameState_h_629333597(TEXT("/Script/NarrativeArsenal"),
	Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeArsenal_Public_UnrealFramework_NarrativeGameState_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeArsenal_Public_UnrealFramework_NarrativeGameState_h_Statics::ClassInfo),
	Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeArsenal_Public_UnrealFramework_NarrativeGameState_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeArsenal_Public_UnrealFramework_NarrativeGameState_h_Statics::ScriptStructInfo),
	nullptr, 0);
// End Registration
