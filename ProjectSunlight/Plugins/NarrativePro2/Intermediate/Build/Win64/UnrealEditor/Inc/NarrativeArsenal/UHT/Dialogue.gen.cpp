...
struct Z_Construct_UScriptStruct_FSpeakerInfo_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_OwnedTags_MetaData[] = {
		{ "Category", "Speaker Details" },
		{ "Comment", "//Tags to apply to this speaker for the duration of the dialogue \n" },
		{ "ModuleRelativePath", "Public/Tales/Dialogue.h" },
		{ "ToolTip", "Tags to apply to this speaker for the duration of the dialogue" },
	};
...
const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FSpeakerInfo_Statics::NewProp_OwnedTags = { "OwnedTags", nullptr, (EPropertyFlags)0x0010000000000015, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FSpeakerInfo, OwnedTags), Z_Construct_UScriptStruct_FGameplayTagContainer, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_OwnedTags_MetaData), NewProp_OwnedTags_MetaData) }; // 3352185621
...
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UScriptStruct_FSpeakerInfo_Statics::PropPointers[] = {
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FSpeakerInfo_Statics::NewProp_OwnedTags,
...
struct Z_Construct_UScriptStruct_FDialoguePlayParams_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_bOverride_bFreeMovement_MetaData[] = {
		{ "Category", "Overrides" },
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_bFreeMovement_MetaData[] = {
		{ "Category", "Play Params" },
		{ "Comment", "//Do we want the dialogue to be free movement? \n" },
		{ "editcondition", "bOverride_bFreeMovement" },
		{ "ModuleRelativePath", "Public/Tales/Dialogue.h" },
		{ "ToolTip", "Do we want the dialogue to be free movement?" },
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_bOverride_bStopMovement_MetaData[] = {
		{ "Category", "Overrides" },
		{ "InlineEditConditionToggle", "" },
		{ "ModuleRelativePath", "Public/Tales/Dialogue.h" },
		{ "PinHiddenByDefault", "" },
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_bStopMovement_MetaData[] = {
		{ "Category", "Play Params" },
		{ "Comment", "//Do we want the dialogue to stop the characters in it from moving when it begins? \n" },
		{ "editcondition", "bOverride_bStopMovement" },
		{ "ModuleRelativePath", "Public/Tales/Dialogue.h" },
		{ "ToolTip", "Do we want the dialogue to stop the characters in it from moving when it begins?" },
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_Speakers_MetaData[] = {
		{ "Category", "Play Params" },
		{ "Comment", "//Any node without a speaker defined will have this NPC used as the speaker instead. Useful for having many different characters reuse a generic dialogue asset\n" },
		{ "ModuleRelativePath", "Public/Tales/Dialogue.h" },
		{ "ToolTip", "Any node without a speaker defined will have this NPC used as the speaker instead. Useful for having many different characters reuse a generic dialogue asset" },
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_NonUniqueNPCs_MetaData[] = {
		{ "Category", "Play Params" },
		{ "Comment", "//Non-Unique NPCs can play dialogue, however you need to specify which NPC wants to play the dialogue in here, so we know which NPC you need in the dialogue\n//TODO wont work in networked games as playparams aren't passed to clients yet \n" },
		{ "ModuleRelativePath", "Public/Tales/Dialogue.h" },
		{ "ToolTip", "Non-Unique NPCs can play dialogue, however you need to specify which NPC wants to play the dialogue in here, so we know which NPC you need in the dialogue\nTODO wont work in networked games as playparams aren't passed to clients yet" },
	};
#endif // WITH_METADATA
	static const UECodeGen_Private::FNamePropertyParams NewProp_StartFromID;
	static const UECodeGen_Private::FIntPropertyParams NewProp_Priority;
	static void NewProp_bOverride_bFreeMovement_SetBit(void* Obj);
	static const UECodeGen_Private::FBoolPropertyParams NewProp_bOverride_bFreeMovement;
	...
	static void NewProp_bOverride_bStopMovement_SetBit(void* Obj);
	static const UECodeGen_Private::FBoolPropertyParams NewProp_bOverride_bStopMovement;
	static void NewProp_bStopMovement_SetBit(void* Obj);
	static const UECodeGen_Private::FBoolPropertyParams NewProp_bStopMovement;
	static const UECodeGen_Private::FObjectPropertyParams NewProp_Speakers_Inner;
...
void Z_Construct_UScriptStruct_FDialoguePlayParams_Statics::NewProp_bOverride_bFreeMovement_SetBit(void* Obj)
{
	((FDialoguePlayParams*)Obj)->bOverride_bFreeMovement = 1;
}
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FDialoguePlayParams_Statics::NewProp_bOverride_bFreeMovement = { "bOverride_bFreeMovement", nullptr, (EPropertyFlags)0x0010000000010005, UECodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(uint8), sizeof(FDialoguePlayParams), &Z_Construct_UScriptStruct_FDialoguePlayParams_Statics::NewProp_bOverride_bFreeMovement_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_bOverride_bFreeMovement_MetaData), NewProp_bOverride_bFreeMovement_MetaData) };
void Z_Construct_UScriptStruct_FDialoguePlayParams_Statics::NewProp_bFreeMovement_SetBit(void* Obj)
{
	((FDialoguePlayParams*)Obj)->bFreeMovement = 1;
}
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FDialoguePlayParams_Statics::NewProp_bFreeMovement = { "bFreeMovement", nullptr, (EPropertyFlags)0x0010000000010005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(FDialoguePlayParams), &Z_Construct_UScriptStruct_FDialoguePlayParams_Statics::NewProp_bFreeMovement_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_bFreeMovement_MetaData), NewProp_bFreeMovement_MetaData) };
void Z_Construct_UScriptStruct_FDialoguePlayParams_Statics::NewProp_bOverride_bStopMovement_SetBit(void* Obj)
{
	((FDialoguePlayParams*)Obj)->bOverride_bStopMovement = 1;
}
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FDialoguePlayParams_Statics::NewProp_bOverride_bStopMovement = { "bOverride_bStopMovement", nullptr, (EPropertyFlags)0x0010000000010005, UECodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(uint8), sizeof(FDialoguePlayParams), &Z_Construct_UScriptStruct_FDialoguePlayParams_Statics::NewProp_bOverride_bStopMovement_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_bOverride_bStopMovement_MetaData), NewProp_bOverride_bStopMovement_MetaData) };
void Z_Construct_UScriptStruct_FDialoguePlayParams_Statics::NewProp_bStopMovement_SetBit(void* Obj)
{
	((FDialoguePlayParams*)Obj)->bStopMovement = 1;
}
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FDialoguePlayParams_Statics::NewProp_bStopMovement = { "bStopMovement", nullptr, (EPropertyFlags)0x0010000000010005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(FDialoguePlayParams), &Z_Construct_UScriptStruct_FDialoguePlayParams_Statics::NewProp_bStopMovement_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_bStopMovement_MetaData), NewProp_bStopMovement_MetaData) };
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UScriptStruct_FDialoguePlayParams_Statics::NewProp_Speakers_Inner = { "Speakers", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UClass_ANarrativeNPCCharacter_NoRegister, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FDialoguePlayParams_Statics::NewProp_Speakers = { "Speakers", nullptr, (EPropertyFlags)0x0010000000010005, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FDialoguePlayParams, Speakers), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_Speakers_MetaData), NewProp_Speakers_MetaData) };
...
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UScriptStruct_FDialoguePlayParams_Statics::PropPointers[] = {
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FDialoguePlayParams_Statics::NewProp_bOverride_bFreeMovement,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FDialoguePlayParams_Statics::NewProp_bFreeMovement,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FDialoguePlayParams_Statics::NewProp_bOverride_bStopMovement,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FDialoguePlayParams_Statics::NewProp_bStopMovement,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FDialoguePlayParams_Statics::NewProp_Speakers_Inner,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FDialoguePlayParams_Statics::NewProp_Speakers,
...
AActor* UDialogue::LinkSpeakerAvatar(FSpeakerInfo const& Info, const int32 Idx)
{
	...
	{
		return LinkSpeakerAvatar_Implementation(Info, Idx);
	}
}
struct Z_Construct_UFunction_UDialogue_LinkSpeakerAvatar_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_Idx_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif // WITH_METADATA
	static const UECodeGen_Private::FStructPropertyParams NewProp_Info;
...
const UECodeGen_Private::FIntPropertyParams Z_Construct_UFunction_UDialogue_LinkSpeakerAvatar_Statics::NewProp_Idx = { "Idx", nullptr, (EPropertyFlags)0x0010000000000082, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(Dialogue_eventLinkSpeakerAvatar_Parms, Idx), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_Idx_MetaData), NewProp_Idx_MetaData) };
...
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UDialogue_LinkSpeakerAvatar_Statics::PropPointers[] = {
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UDialogue_LinkSpeakerAvatar_Statics::NewProp_Idx,
...
DEFINE_FUNCTION(UDialogue::execLinkSpeakerAvatar)
{
	...
	P_FINISH;
	P_NATIVE_BEGIN;
	*(AActor**)Z_Param__Result=P_THIS->LinkSpeakerAvatar_Implementation(Z_Param_Out_Info,Z_Param_Idx);
	P_NATIVE_END;
}
...
struct Z_Construct_UClass_UDialogue_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_bAdjustPlayerTransform_MetaData[] = {
		{ "Category", "Adjustment" },
		{ "Comment", "/*\n\x09* If enabled, we'll move the player to stand in front of the first speaker. \n\x09*/" },
		{ "ModuleRelativePath", "Public/Tales/Dialogue.h" },
		{ "ToolTip", "* If enabled, we'll move the player to stand in front of the first speaker." },
	};
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_UDialogue_DestroySpeakerAvatar, "DestroySpeakerAvatar" }, // 1467061083
		{ &Z_Construct_UFunction_UDialogue_EndCurrentLine, "EndCurrentLine" }, // 1587358615
		{ &Z_Construct_UFunction_UDialogue_FinishDialogueNode, "FinishDialogueNode" }, // 1164171801
		...
		{ &Z_Construct_UFunction_UDialogue_LinkSpeakerAvatar, "LinkSpeakerAvatar" }, // 885884142
		{ &Z_Construct_UFunction_UDialogue_OnNPCDialogueLineFinished, "OnNPCDialogueLineFinished" }, // 3927717368
		{ &Z_Construct_UFunction_UDialogue_OnNPCDialogueLineStarted, "OnNPCDialogueLineStarted" }, // 660433312
		...
		{ &Z_Construct_UFunction_UDialogue_PlayDialogueNode, "PlayDialogueNode" }, // 29818828
		...
		{ &Z_Construct_UFunction_UDialogue_PlayNPCDialogue, "PlayNPCDialogue" }, // 2037060121
...
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UDialogue_Statics::NewProp_RootDialogue = { "RootDialogue", nullptr, (EPropertyFlags)0x0010000000020001, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDialogue, RootDialogue), Z_Construct_UClass_UDialogueNode_NPC_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_RootDialogue_MetaData), NewProp_RootDialogue_MetaData) };
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UDialogue_Statics::NewProp_NPCReplies_Inner = { "NPCReplies", nullptr, (EPropertyFlags)0x0000000000020000, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UClass_UDialogueNode_NPC_NoRegister, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UDialogue_Statics::NewProp_NPCReplies = { "NPCReplies", nullptr, (EPropertyFlags)0x0010000000020001, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDialogue, NPCReplies), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_NPCReplies_MetaData), NewProp_NPCReplies_MetaData) };
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UDialogue_Statics::NewProp_PlayerReplies_Inner = { "PlayerReplies", nullptr, (EPropertyFlags)0x0000000000020000, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UClass_UDialogueNode_Player_NoRegister, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UDialogue_Statics::NewProp_PlayerReplies = { "PlayerReplies", nullptr, (EPropertyFlags)0x0010000000020001, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDialogue, PlayerReplies), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_PlayerReplies_MetaData), NewProp_PlayerReplies_MetaData) };
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeArsenal_Public_Tales_Dialogue_h_Statics
{
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FSpeakerInfo::StaticStruct, Z_Construct_UScriptStruct_FSpeakerInfo_Statics::NewStructOps, TEXT("SpeakerInfo"), &Z_Registration_Info_UScriptStruct_SpeakerInfo, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FSpeakerInfo), 2303145874U) },
		...
		{ FDialoguePlayParams::StaticStruct, Z_Construct_UScriptStruct_FDialoguePlayParams_Statics::NewStructOps, TEXT("DialoguePlayParams"), &Z_Registration_Info_UScriptStruct_DialoguePlayParams, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FDialoguePlayParams), 556030645U) },
	};
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UDialogue, UDialogue::StaticClass, TEXT("UDialogue"), &Z_Registration_Info_UClass_UDialogue, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDialogue), 2944727165U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeArsenal_Public_Tales_Dialogue_h_2489941633(TEXT("/Script/NarrativeArsenal"),
	Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeArsenal_Public_Tales_Dialogue_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeArsenal_Public_Tales_Dialogue_h_Statics::ClassInfo),
	Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeArsenal_Public_Tales_Dialogue_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeArsenal_Public_Tales_Dialogue_h_Statics::ScriptStructInfo),
	nullptr, 0);
// End Registration
