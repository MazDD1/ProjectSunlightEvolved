...
struct Z_Construct_UScriptStruct_FTaskNavigationMarker_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_MarkerSubtitleText_MetaData[] = {
		{ "Category", "Task - Navigation Markers" },
		{ "Comment", "//Subtitle to use for the marker. \n" },
		{ "ModuleRelativePath", "Public/Tales/QuestTask.h" },
		{ "ToolTip", "Subtitle to use for the marker." },
	};
...
const UECodeGen_Private::FTextPropertyParams Z_Construct_UScriptStruct_FTaskNavigationMarker_Statics::NewProp_MarkerSubtitleText = { "MarkerSubtitleText", nullptr, (EPropertyFlags)0x0010000000000015, UECodeGen_Private::EPropertyGenFlags::Text, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FTaskNavigationMarker, MarkerSubtitleText), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_MarkerSubtitleText_MetaData), NewProp_MarkerSubtitleText_MetaData) };
...
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UScriptStruct_FTaskNavigationMarker_Statics::PropPointers[] = {
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FTaskNavigationMarker_Statics::NewProp_MarkerSubtitleText,
...
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UNarrativeTask_Statics::NewProp_SpawnedMarker = { "SpawnedMarker", nullptr, (EPropertyFlags)0x0114000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNarrativeTask, SpawnedMarker), Z_Construct_UClass_UMapMarker_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_SpawnedMarker_MetaData), NewProp_SpawnedMarker_MetaData) };
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeArsenal_Public_Tales_QuestTask_h_Statics
{
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FTaskNavigationMarker::StaticStruct, Z_Construct_UScriptStruct_FTaskNavigationMarker_Statics::NewStructOps, TEXT("TaskNavigationMarker"), &Z_Registration_Info_UScriptStruct_TaskNavigationMarker, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FTaskNavigationMarker), 3509051504U) },
	};
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UNarrativeTask, UNarrativeTask::StaticClass, TEXT("UNarrativeTask"), &Z_Registration_Info_UClass_UNarrativeTask, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNarrativeTask), 2016679137U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeArsenal_Public_Tales_QuestTask_h_1299687482(TEXT("/Script/NarrativeArsenal"),
	Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeArsenal_Public_Tales_QuestTask_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeArsenal_Public_Tales_QuestTask_h_Statics::ClassInfo),
	Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeArsenal_Public_Tales_QuestTask_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeArsenal_Public_Tales_QuestTask_h_Statics::ScriptStructInfo),
	nullptr, 0);
// End Registration
