...
// Begin Class UNarrativeCheatManager Function AdvanceToTime
struct Z_Construct_UFunction_UNarrativeCheatManager_AdvanceToTime_Statics
{
	struct NarrativeCheatManager_eventAdvanceToTime_Parms
	{
		float Time;
	};
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[] = {
		{ "Comment", "//Advance the ingame time by however many hours is needed to reach the specified time. \n" },
		{ "ModuleRelativePath", "Public/UnrealFramework/NarrativeCheatManager.h" },
		{ "ToolTip", "Advance the ingame time by however many hours is needed to reach the specified time." },
	};
...
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UNarrativeCheatManager_AdvanceToTime_Statics::NewProp_Time = { "Time", nullptr, (EPropertyFlags)0x0010000000000082, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(NarrativeCheatManager_eventAdvanceToTime_Parms, Time), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_Time_MetaData), NewProp_Time_MetaData) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UNarrativeCheatManager_AdvanceToTime_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UNarrativeCheatManager_AdvanceToTime_Statics::NewProp_Time,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UNarrativeCheatManager_AdvanceToTime_Statics::PropPointers) < 2048);
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UNarrativeCheatManager_AdvanceToTime_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UNarrativeCheatManager, nullptr, "AdvanceToTime", nullptr, nullptr, Z_Construct_UFunction_UNarrativeCheatManager_AdvanceToTime_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UNarrativeCheatManager_AdvanceToTime_Statics::PropPointers), sizeof(Z_Construct_UFunction_UNarrativeCheatManager_AdvanceToTime_Statics::NarrativeCheatManager_eventAdvanceToTime_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00020601, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UNarrativeCheatManager_AdvanceToTime_Statics::Function_MetaDataParams), Z_Construct_UFunction_UNarrativeCheatManager_AdvanceToTime_Statics::Function_MetaDataParams) };
static_assert(sizeof(Z_Construct_UFunction_UNarrativeCheatManager_AdvanceToTime_Statics::NarrativeCheatManager_eventAdvanceToTime_Parms) < MAX_uint16);
UFunction* Z_Construct_UFunction_UNarrativeCheatManager_AdvanceToTime()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UNarrativeCheatManager_AdvanceToTime_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(UNarrativeCheatManager::execAdvanceToTime)
{
	P_GET_PROPERTY(FFloatProperty,Z_Param_Time);
	P_FINISH;
	P_NATIVE_BEGIN;
	P_THIS->AdvanceToTime(Z_Param_Time);
	P_NATIVE_END;
}
// End Class UNarrativeCheatManager Function AdvanceToTime
...
void UNarrativeCheatManager::StaticRegisterNativesUNarrativeCheatManager()
{
	...
	static const FNameNativePtrPair Funcs[] = {
		...
		{ "AdvanceToTime", &UNarrativeCheatManager::execAdvanceToTime },
...
struct Z_Construct_UClass_UNarrativeCheatManager_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_UNarrativeCheatManager_AdvanceToTime, "AdvanceToTime" }, // 3816878149
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeArsenal_Public_UnrealFramework_NarrativeCheatManager_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UNarrativeCheatManager, UNarrativeCheatManager::StaticClass, TEXT("UNarrativeCheatManager"), &Z_Registration_Info_UClass_UNarrativeCheatManager, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNarrativeCheatManager), 2775936614U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeArsenal_Public_UnrealFramework_NarrativeCheatManager_h_3128348304(TEXT("/Script/NarrativeArsenal"),
	Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeArsenal_Public_UnrealFramework_NarrativeCheatManager_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeArsenal_Public_UnrealFramework_NarrativeCheatManager_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
