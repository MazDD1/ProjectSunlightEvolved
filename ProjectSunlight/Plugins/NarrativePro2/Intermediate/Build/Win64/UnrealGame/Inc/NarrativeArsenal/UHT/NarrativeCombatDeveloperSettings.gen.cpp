...
struct Z_Construct_UClass_UNarrativeCombatDeveloperSettings_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_NotifyTeammatesToFightRange_MetaData[] = {
		{ "Category", "Combat|AI" },
		{ "ClampMin", "10" },
		{ "Comment", "/** If an NPC starts attacking an enemy, their teammates within this amount of distance will be notified to attack also.\n\x09ie You can turn this number down to prevent the whole city getting into fights where you might only want teammates within 50 meters! */" },
		{ "ModuleRelativePath", "Public/Settings/NarrativeCombatDeveloperSettings.h" },
		{ "ToolTip", "If an NPC starts attacking an enemy, their teammates within this amount of distance will be notified to attack also.\n      ie You can turn this number down to prevent the whole city getting into fights where you might only want teammates within 50 meters!" },
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_MeleeCombatAnimSampleAmount_MetaData[] = {
		{ "Category", "Combat|FX" },
		{ "ClampMax", "100" },
		{ "ClampMin", "1" },
		{ "Comment", "//** We'll sample this number of anim samples when reading through a melee attack. Lower numbers give better performance but less accuracy. */\n" },
		{ "ModuleRelativePath", "Public/Settings/NarrativeCombatDeveloperSettings.h" },
		{ "ToolTip", "/ We'll sample this number of anim samples when reading through a melee attack. Lower numbers give better performance but less accuracy." },
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_bAllowFriendlyFire_MetaData[] = {
		{ "Category", "Combat|General" },
		{ "Comment", "//** Whether or not we'll allow aligned factions to damage each other. */\n" },
		{ "ModuleRelativePath", "Public/Settings/NarrativeCombatDeveloperSettings.h" },
		{ "ToolTip", "/ Whether or not we'll allow aligned factions to damage each other." },
	};
#endif // WITH_METADATA
	...
	static const UECodeGen_Private::FFloatPropertyParams NewProp_NotifyTeammatesToFightRange;
	static const UECodeGen_Private::FIntPropertyParams NewProp_MeleeCombatAnimSampleAmount;
...
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UNarrativeCombatDeveloperSettings_Statics::NewProp_NotifyTeammatesToFightRange = { "NotifyTeammatesToFightRange", nullptr, (EPropertyFlags)0x0010000000004015, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNarrativeCombatDeveloperSettings, NotifyTeammatesToFightRange), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_NotifyTeammatesToFightRange_MetaData), NewProp_NotifyTeammatesToFightRange_MetaData) };
const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UNarrativeCombatDeveloperSettings_Statics::NewProp_MeleeCombatAnimSampleAmount = { "MeleeCombatAnimSampleAmount", nullptr, (EPropertyFlags)0x0010000000004015, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNarrativeCombatDeveloperSettings, MeleeCombatAnimSampleAmount), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_MeleeCombatAnimSampleAmount_MetaData), NewProp_MeleeCombatAnimSampleAmount_MetaData) };
void Z_Construct_UClass_UNarrativeCombatDeveloperSettings_Statics::NewProp_bAllowFriendlyFire_SetBit(void* Obj)
{
	((UNarrativeCombatDeveloperSettings*)Obj)->bAllowFriendlyFire = 1;
}
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UNarrativeCombatDeveloperSettings_Statics::NewProp_bAllowFriendlyFire = { "bAllowFriendlyFire", nullptr, (EPropertyFlags)0x0010000000004015, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UNarrativeCombatDeveloperSettings), &Z_Construct_UClass_UNarrativeCombatDeveloperSettings_Statics::NewProp_bAllowFriendlyFire_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_bAllowFriendlyFire_MetaData), NewProp_bAllowFriendlyFire_MetaData) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UNarrativeCombatDeveloperSettings_Statics::PropPointers[] = {
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UNarrativeCombatDeveloperSettings_Statics::NewProp_NotifyTeammatesToFightRange,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UNarrativeCombatDeveloperSettings_Statics::NewProp_MeleeCombatAnimSampleAmount,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UNarrativeCombatDeveloperSettings_Statics::NewProp_bAllowFriendlyFire,
};
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeArsenal_Public_Settings_NarrativeCombatDeveloperSettings_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UNarrativeCombatDeveloperSettings, UNarrativeCombatDeveloperSettings::StaticClass, TEXT("UNarrativeCombatDeveloperSettings"), &Z_Registration_Info_UClass_UNarrativeCombatDeveloperSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNarrativeCombatDeveloperSettings), 2381198724U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeArsenal_Public_Settings_NarrativeCombatDeveloperSettings_h_3168781686(TEXT("/Script/NarrativeArsenal"),
	Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeArsenal_Public_Settings_NarrativeCombatDeveloperSettings_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeArsenal_Public_Settings_NarrativeCombatDeveloperSettings_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
