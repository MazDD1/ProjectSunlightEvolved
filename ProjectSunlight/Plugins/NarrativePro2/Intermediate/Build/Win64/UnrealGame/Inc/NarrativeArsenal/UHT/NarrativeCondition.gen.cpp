...
NARRATIVEARSENAL_API UEnum* Z_Construct_UEnum_NarrativeArsenal_EConditionFilter();
...
// Begin Enum EConditionFilter
static FEnumRegistrationInfo Z_Registration_Info_UEnum_EConditionFilter;
static UEnum* EConditionFilter_StaticEnum()
{
	if (!Z_Registration_Info_UEnum_EConditionFilter.OuterSingleton)
	{
		Z_Registration_Info_UEnum_EConditionFilter.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_NarrativeArsenal_EConditionFilter, (UObject*)Z_Construct_UPackage__Script_NarrativeArsenal(), TEXT("EConditionFilter"));
	}
	return Z_Registration_Info_UEnum_EConditionFilter.OuterSingleton;
}
template<> NARRATIVEARSENAL_API UEnum* StaticEnum<EConditionFilter>()
{
	return EConditionFilter_StaticEnum();
}
struct Z_Construct_UEnum_NarrativeArsenal_EConditionFilter_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
		{ "BlueprintType", "true" },
		{ "CF_AnyCharacter.Comment", "//Select this if your condition can be ran on any character\n" },
		{ "CF_AnyCharacter.DisplayName", "Anyone" },
		{ "CF_AnyCharacter.Name", "EConditionFilter::CF_AnyCharacter" },
		{ "CF_AnyCharacter.ToolTip", "Select this if your condition can be ran on any character" },
		{ "CF_DontTarget.Comment", "//Select this if your condition isn't supposed to run on a given character - ie checking time of day or something that doesn't need a character\n" },
		{ "CF_DontTarget.DisplayName", "No Target" },
		{ "CF_DontTarget.Name", "EConditionFilter::CF_DontTarget" },
		{ "CF_DontTarget.ToolTip", "Select this if your condition isn't supposed to run on a given character - ie checking time of day or something that doesn't need a character" },
		{ "CF_OnlyNPCs.Comment", "//Select this if your condition can be ran only on NPCs, ie checking some AI related state. \n" },
		{ "CF_OnlyNPCs.DisplayName", "Only NPCs" },
		{ "CF_OnlyNPCs.Name", "EConditionFilter::CF_OnlyNPCs" },
		{ "CF_OnlyNPCs.ToolTip", "Select this if your condition can be ran only on NPCs, ie checking some AI related state." },
		{ "CF_OnlyPlayers.Comment", "//Select this if your condition can only be ran on player characters, and not AI. \n" },
		{ "CF_OnlyPlayers.DisplayName", "Only Players" },
		{ "CF_OnlyPlayers.Name", "EConditionFilter::CF_OnlyPlayers" },
		{ "CF_OnlyPlayers.ToolTip", "Select this if your condition can only be ran on player characters, and not AI." },
		{ "Comment", "/**\n* Used for picking who we can run the conditions on \n*/" },
		{ "ModuleRelativePath", "Public/Tales/NarrativeCondition.h" },
		{ "ToolTip", "Used for picking who we can run the conditions on" },
	};
#endif // WITH_METADATA
	static constexpr UECodeGen_Private::FEnumeratorParam Enumerators[] = {
		{ "EConditionFilter::CF_DontTarget", (int64)EConditionFilter::CF_DontTarget },
		{ "EConditionFilter::CF_AnyCharacter", (int64)EConditionFilter::CF_AnyCharacter },
		{ "EConditionFilter::CF_OnlyNPCs", (int64)EConditionFilter::CF_OnlyNPCs },
		{ "EConditionFilter::CF_OnlyPlayers", (int64)EConditionFilter::CF_OnlyPlayers },
	};
	static const UECodeGen_Private::FEnumParams EnumParams;
};
const UECodeGen_Private::FEnumParams Z_Construct_UEnum_NarrativeArsenal_EConditionFilter_Statics::EnumParams = {
	(UObject*(*)())Z_Construct_UPackage__Script_NarrativeArsenal,
	nullptr,
	"EConditionFilter",
	"EConditionFilter",
	Z_Construct_UEnum_NarrativeArsenal_EConditionFilter_Statics::Enumerators,
	RF_Public|RF_Transient|RF_MarkAsNative,
	UE_ARRAY_COUNT(Z_Construct_UEnum_NarrativeArsenal_EConditionFilter_Statics::Enumerators),
	EEnumFlags::None,
	(uint8)UEnum::ECppForm::EnumClass,
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_NarrativeArsenal_EConditionFilter_Statics::Enum_MetaDataParams), Z_Construct_UEnum_NarrativeArsenal_EConditionFilter_Statics::Enum_MetaDataParams)
};
UEnum* Z_Construct_UEnum_NarrativeArsenal_EConditionFilter()
{
	if (!Z_Registration_Info_UEnum_EConditionFilter.InnerSingleton)
	{
		UECodeGen_Private::ConstructUEnum(Z_Registration_Info_UEnum_EConditionFilter.InnerSingleton, Z_Construct_UEnum_NarrativeArsenal_EConditionFilter_Statics::EnumParams);
	}
	return Z_Registration_Info_UEnum_EConditionFilter.InnerSingleton;
}
// End Enum EConditionFilter
...
bool UNarrativeCondition::CheckCondition(APawn* Target, APlayerController* Controller, UTalesComponent* NarrativeComponent)
{
	...
	{
		return CheckCondition_Implementation(Target, Controller, NarrativeComponent);
	}
}
...
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UNarrativeCondition_CheckCondition_Statics::NewProp_Target = { "Target", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(NarrativeCondition_eventCheckCondition_Parms, Target), Z_Construct_UClass_APawn_NoRegister, METADATA_PARAMS(0, nullptr) };
...
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UNarrativeCondition_CheckCondition_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UNarrativeCondition_CheckCondition_Statics::NewProp_Target,
...
DEFINE_FUNCTION(UNarrativeCondition::execCheckCondition)
{
	...
	P_FINISH;
	P_NATIVE_BEGIN;
	*(bool*)Z_Param__Result=P_THIS->CheckCondition_Implementation(Z_Param_Target,Z_Param_Controller,Z_Param_NarrativeComponent);
	P_NATIVE_END;
}
// End Class UNarrativeCondition Function CheckCondition

// Begin Class UNarrativeCondition Function GetCharacterTargets
struct Z_Construct_UFunction_UNarrativeCondition_GetCharacterTargets_Statics
{
	struct NarrativeCondition_eventGetCharacterTargets_Parms
	{
...
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UNarrativeCondition_GetCharacterTargets_Statics::NewProp_ReturnValue_Inner = { "ReturnValue", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UClass_UCharacterDefinition_NoRegister, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FArrayPropertyParams Z_Construct_UFunction_UNarrativeCondition_GetCharacterTargets_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(NarrativeCondition_eventGetCharacterTargets_Parms, ReturnValue), EArrayPropertyFlags::None, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UNarrativeCondition_GetCharacterTargets_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UNarrativeCondition_GetCharacterTargets_Statics::NewProp_ReturnValue_Inner,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UNarrativeCondition_GetCharacterTargets_Statics::NewProp_ReturnValue,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UNarrativeCondition_GetCharacterTargets_Statics::PropPointers) < 2048);
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UNarrativeCondition_GetCharacterTargets_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UNarrativeCondition, nullptr, "GetCharacterTargets", nullptr, nullptr, Z_Construct_UFunction_UNarrativeCondition_GetCharacterTargets_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UNarrativeCondition_GetCharacterTargets_Statics::PropPointers), sizeof(Z_Construct_UFunction_UNarrativeCondition_GetCharacterTargets_Statics::NarrativeCondition_eventGetCharacterTargets_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UNarrativeCondition_GetCharacterTargets_Statics::Function_MetaDataParams), Z_Construct_UFunction_UNarrativeCondition_GetCharacterTargets_Statics::Function_MetaDataParams) };
static_assert(sizeof(Z_Construct_UFunction_UNarrativeCondition_GetCharacterTargets_Statics::NarrativeCondition_eventGetCharacterTargets_Parms) < MAX_uint16);
UFunction* Z_Construct_UFunction_UNarrativeCondition_GetCharacterTargets()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UNarrativeCondition_GetCharacterTargets_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(UNarrativeCondition::execGetCharacterTargets)
{
	P_FINISH;
	P_NATIVE_BEGIN;
...
// End Class UNarrativeCondition Function GetCharacterTargets
...
void UNarrativeCondition::StaticRegisterNativesUNarrativeCondition()
{
	...
	static const FNameNativePtrPair Funcs[] = {
		...
		{ "GetCharacterTargets", &UNarrativeCondition::execGetCharacterTargets },
...
struct Z_Construct_UClass_UNarrativeCondition_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_ConditionFilter_MetaData[] = {
		{ "Category", "Condition" },
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_CharacterTargets_MetaData[] = {
		{ "Category", "Condition" },
		{ "Comment", "/**Characters we should run the Condition on. If empty, we'll run on the character that owns the quest/dialogue.*/" },
		{ "EditCondition", "ConditionFilter == EConditionFilter::CF_AnyCharacter" },
		{ "EditConditionHides", "" },
		{ "ModuleRelativePath", "Public/Tales/NarrativeCondition.h" },
		{ "ToolTip", "Characters we should run the Condition on. If empty, we'll run on the character that owns the quest/dialogue." },
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_NPCTargets_MetaData[] = {
		{ "Category", "Condition" },
		{ "Comment", "/** NPCs we should run the Condition on. If empty, we'll run the Condition on all NPCs in the dialogue */" },
		{ "EditCondition", "ConditionFilter == EConditionFilter::CF_OnlyNPCs" },
		{ "EditConditionHides", "" },
		{ "ModuleRelativePath", "Public/Tales/NarrativeCondition.h" },
		{ "ToolTip", "NPCs we should run the Condition on. If empty, we'll run the Condition on all NPCs in the dialogue" },
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_PlayerTargets_MetaData[] = {
		{ "Category", "Condition" },
		{ "Comment", "/** Players we should run the Condition on. If empty, we'll run on the character that owns the quest/dialogue. */" },
		{ "EditCondition", "ConditionFilter == EConditionFilter::CF_OnlyPlayers" },
		{ "EditConditionHides", "" },
		{ "ModuleRelativePath", "Public/Tales/NarrativeCondition.h" },
		{ "ToolTip", "Players we should run the Condition on. If empty, we'll run on the character that owns the quest/dialogue." },
	};
	...
	static const UECodeGen_Private::FBytePropertyParams NewProp_ConditionFilter_Underlying;
	static const UECodeGen_Private::FEnumPropertyParams NewProp_ConditionFilter;
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_UNarrativeCondition_CheckCondition, "CheckCondition" }, // 803130802
		{ &Z_Construct_UFunction_UNarrativeCondition_GetCharacterTargets, "GetCharacterTargets" }, // 4227383732
...
const UECodeGen_Private::FBytePropertyParams Z_Construct_UClass_UNarrativeCondition_Statics::NewProp_ConditionFilter_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, nullptr, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UNarrativeCondition_Statics::NewProp_ConditionFilter = { "ConditionFilter", nullptr, (EPropertyFlags)0x0010000000000015, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNarrativeCondition, ConditionFilter), Z_Construct_UEnum_NarrativeArsenal_EConditionFilter, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_ConditionFilter_MetaData), NewProp_ConditionFilter_MetaData) }; // 1440845338
...
const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UNarrativeCondition_Statics::NewProp_CharacterTargets = { "CharacterTargets", nullptr, (EPropertyFlags)0x0124080000000015, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNarrativeCondition, CharacterTargets), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_CharacterTargets_MetaData), NewProp_CharacterTargets_MetaData) };
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UNarrativeCondition_Statics::NewProp_NPCTargets_Inner = { "NPCTargets", nullptr, (EPropertyFlags)0x0104000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UClass_UNPCDefinition_NoRegister, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UNarrativeCondition_Statics::NewProp_NPCTargets = { "NPCTargets", nullptr, (EPropertyFlags)0x0124080000000015, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNarrativeCondition, NPCTargets), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_NPCTargets_MetaData), NewProp_NPCTargets_MetaData) };
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UNarrativeCondition_Statics::NewProp_PlayerTargets_Inner = { "PlayerTargets", nullptr, (EPropertyFlags)0x0104000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UClass_UPlayerDefinition_NoRegister, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UNarrativeCondition_Statics::NewProp_PlayerTargets = { "PlayerTargets", nullptr, (EPropertyFlags)0x0124080000000015, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNarrativeCondition, PlayerTargets), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_PlayerTargets_MetaData), NewProp_PlayerTargets_MetaData) };
...
const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UNarrativeCondition_Statics::NewProp_PartyConditionPolicy = { "PartyConditionPolicy", nullptr, (EPropertyFlags)0x0020080000000005, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNarrativeCondition, PartyConditionPolicy), Z_Construct_UEnum_NarrativeArsenal_EPartyConditionPolicy, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_PartyConditionPolicy_MetaData), NewProp_PartyConditionPolicy_MetaData) }; // 3025712406
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UNarrativeCondition_Statics::PropPointers[] = {
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UNarrativeCondition_Statics::NewProp_ConditionFilter_Underlying,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UNarrativeCondition_Statics::NewProp_ConditionFilter,
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UNarrativeCondition_Statics::NewProp_NPCTargets_Inner,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UNarrativeCondition_Statics::NewProp_NPCTargets,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UNarrativeCondition_Statics::NewProp_PlayerTargets_Inner,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UNarrativeCondition_Statics::NewProp_PlayerTargets,
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeArsenal_Public_Tales_NarrativeCondition_h_Statics
{
	static constexpr FEnumRegisterCompiledInInfo EnumInfo[] = {
		...
		{ EConditionFilter_StaticEnum, TEXT("EConditionFilter"), &Z_Registration_Info_UEnum_EConditionFilter, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1440845338U) },
	};
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UNarrativeCondition, UNarrativeCondition::StaticClass, TEXT("UNarrativeCondition"), &Z_Registration_Info_UClass_UNarrativeCondition, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNarrativeCondition), 4049030994U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeArsenal_Public_Tales_NarrativeCondition_h_2398951515(TEXT("/Script/NarrativeArsenal"),
	Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeArsenal_Public_Tales_NarrativeCondition_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeArsenal_Public_Tales_NarrativeCondition_h_Statics::ClassInfo),
	nullptr, 0,
	Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeArsenal_Public_Tales_NarrativeCondition_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeArsenal_Public_Tales_NarrativeCondition_h_Statics::EnumInfo));
// End Registration
