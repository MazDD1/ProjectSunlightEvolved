...
struct Z_Construct_UEnum_NarrativeArsenal_ENarrativeClimbMode_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
		...
		{ "JumpWarping.Comment", "// Planar Jump Transition to new Climb Surface\n" },
		{ "JumpWarping.Name", "ENarrativeClimbMode::JumpWarping" },
		{ "JumpWarping.ToolTip", "Planar Jump Transition to new Climb Surface" },
		{ "Mantling.Comment", "// Jump using motion warping to reach target \n" },
		{ "Mantling.Name", "ENarrativeClimbMode::Mantling" },
		{ "Mantling.ToolTip", "Jump using motion warping to reach target" },
		{ "ModuleRelativePath", "Public/Character/NarrativeCharacterMovement.h" },
		...
		{ "Turn.Comment", "// Climbing up to the top of a ledge \n" },
		{ "Turn.Name", "ENarrativeClimbMode::Turn" },
		{ "Turn.ToolTip", "Climbing up to the top of a ledge" },
	};
#endif // WITH_METADATA
	static constexpr UECodeGen_Private::FEnumeratorParam Enumerators[] = {
		...
		{ "ENarrativeClimbMode::JumpWarping", (int64)ENarrativeClimbMode::JumpWarping },
		{ "ENarrativeClimbMode::Mantling", (int64)ENarrativeClimbMode::Mantling },
...
const UECodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_UNarrativeCharacterMovement_GetClimbMode_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(NarrativeCharacterMovement_eventGetClimbMode_Parms, ReturnValue), Z_Construct_UEnum_NarrativeArsenal_ENarrativeClimbMode, METADATA_PARAMS(0, nullptr) }; // 1696721910
...
const UECodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_UNarrativeCharacterMovement_GetDesiredClimbMode_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(NarrativeCharacterMovement_eventGetDesiredClimbMode_Parms, ReturnValue), Z_Construct_UEnum_NarrativeArsenal_ENarrativeClimbMode, METADATA_PARAMS(0, nullptr) }; // 1696721910
...
// Begin Class UNarrativeCharacterMovement Function GetMirrorMovement
struct Z_Construct_UFunction_UNarrativeCharacterMovement_GetMirrorMovement_Statics
{
	struct NarrativeCharacterMovement_eventGetMirrorMovement_Parms
	{
...
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UNarrativeCharacterMovement_GetMirrorMovement_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000080588, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(NarrativeCharacterMovement_eventGetMirrorMovement_Parms, ReturnValue), Z_Construct_UClass_UNarrativeCharacterMovement_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_ReturnValue_MetaData), NewProp_ReturnValue_MetaData) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UNarrativeCharacterMovement_GetMirrorMovement_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UNarrativeCharacterMovement_GetMirrorMovement_Statics::NewProp_ReturnValue,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UNarrativeCharacterMovement_GetMirrorMovement_Statics::PropPointers) < 2048);
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UNarrativeCharacterMovement_GetMirrorMovement_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UNarrativeCharacterMovement, nullptr, "GetMirrorMovement", nullptr, nullptr, Z_Construct_UFunction_UNarrativeCharacterMovement_GetMirrorMovement_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UNarrativeCharacterMovement_GetMirrorMovement_Statics::PropPointers), sizeof(Z_Construct_UFunction_UNarrativeCharacterMovement_GetMirrorMovement_Statics::NarrativeCharacterMovement_eventGetMirrorMovement_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UNarrativeCharacterMovement_GetMirrorMovement_Statics::Function_MetaDataParams), Z_Construct_UFunction_UNarrativeCharacterMovement_GetMirrorMovement_Statics::Function_MetaDataParams) };
static_assert(sizeof(Z_Construct_UFunction_UNarrativeCharacterMovement_GetMirrorMovement_Statics::NarrativeCharacterMovement_eventGetMirrorMovement_Parms) < MAX_uint16);
UFunction* Z_Construct_UFunction_UNarrativeCharacterMovement_GetMirrorMovement()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UNarrativeCharacterMovement_GetMirrorMovement_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(UNarrativeCharacterMovement::execGetMirrorMovement)
{
	P_FINISH;
	P_NATIVE_BEGIN;
	*(UNarrativeCharacterMovement**)Z_Param__Result=P_THIS->GetMirrorMovement();
	P_NATIVE_END;
}
// End Class UNarrativeCharacterMovement Function GetMirrorMovement

// Begin Class UNarrativeCharacterMovement Function GetNarrativeCharacterOwner
struct Z_Construct_UFunction_UNarrativeCharacterMovement_GetNarrativeCharacterOwner_Statics
{
	struct NarrativeCharacterMovement_eventGetNarrativeCharacterOwner_Parms
	{
...
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UNarrativeCharacterMovement_GetNarrativeCharacterOwner_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(NarrativeCharacterMovement_eventGetNarrativeCharacterOwner_Parms, ReturnValue), Z_Construct_UClass_ANarrativeCharacter_NoRegister, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UNarrativeCharacterMovement_GetNarrativeCharacterOwner_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UNarrativeCharacterMovement_GetNarrativeCharacterOwner_Statics::NewProp_ReturnValue,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UNarrativeCharacterMovement_GetNarrativeCharacterOwner_Statics::PropPointers) < 2048);
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UNarrativeCharacterMovement_GetNarrativeCharacterOwner_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UNarrativeCharacterMovement, nullptr, "GetNarrativeCharacterOwner", nullptr, nullptr, Z_Construct_UFunction_UNarrativeCharacterMovement_GetNarrativeCharacterOwner_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UNarrativeCharacterMovement_GetNarrativeCharacterOwner_Statics::PropPointers), sizeof(Z_Construct_UFunction_UNarrativeCharacterMovement_GetNarrativeCharacterOwner_Statics::NarrativeCharacterMovement_eventGetNarrativeCharacterOwner_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UNarrativeCharacterMovement_GetNarrativeCharacterOwner_Statics::Function_MetaDataParams), Z_Construct_UFunction_UNarrativeCharacterMovement_GetNarrativeCharacterOwner_Statics::Function_MetaDataParams) };
static_assert(sizeof(Z_Construct_UFunction_UNarrativeCharacterMovement_GetNarrativeCharacterOwner_Statics::NarrativeCharacterMovement_eventGetNarrativeCharacterOwner_Parms) < MAX_uint16);
UFunction* Z_Construct_UFunction_UNarrativeCharacterMovement_GetNarrativeCharacterOwner()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UNarrativeCharacterMovement_GetNarrativeCharacterOwner_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(UNarrativeCharacterMovement::execGetNarrativeCharacterOwner)
{
	P_FINISH;
	P_NATIVE_BEGIN;
	*(ANarrativeCharacter**)Z_Param__Result=P_THIS->GetNarrativeCharacterOwner();
	P_NATIVE_END;
}
// End Class UNarrativeCharacterMovement Function GetNarrativeCharacterOwner
...
// Begin Class UNarrativeCharacterMovement Function IsMovementLocked
struct Z_Construct_UFunction_UNarrativeCharacterMovement_IsMovementLocked_Statics
{
	struct NarrativeCharacterMovement_eventIsMovementLocked_Parms
	{
		bool ReturnValue;
	};
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[] = {
		{ "Category", "Sprint" },
		{ "Comment", "/**Return true if movement is locked*/" },
		{ "ModuleRelativePath", "Public/Character/NarrativeCharacterMovement.h" },
		{ "ToolTip", "Return true if movement is locked" },
	};
#endif // WITH_METADATA
	static void NewProp_ReturnValue_SetBit(void* Obj);
	static const UECodeGen_Private::FBoolPropertyParams NewProp_ReturnValue;
...
void Z_Construct_UFunction_UNarrativeCharacterMovement_IsMovementLocked_Statics::NewProp_ReturnValue_SetBit(void* Obj)
{
	((NarrativeCharacterMovement_eventIsMovementLocked_Parms*)Obj)->ReturnValue = 1;
}
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UNarrativeCharacterMovement_IsMovementLocked_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(NarrativeCharacterMovement_eventIsMovementLocked_Parms), &Z_Construct_UFunction_UNarrativeCharacterMovement_IsMovementLocked_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UNarrativeCharacterMovement_IsMovementLocked_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UNarrativeCharacterMovement_IsMovementLocked_Statics::NewProp_ReturnValue,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UNarrativeCharacterMovement_IsMovementLocked_Statics::PropPointers) < 2048);
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UNarrativeCharacterMovement_IsMovementLocked_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UNarrativeCharacterMovement, nullptr, "IsMovementLocked", nullptr, nullptr, Z_Construct_UFunction_UNarrativeCharacterMovement_IsMovementLocked_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UNarrativeCharacterMovement_IsMovementLocked_Statics::PropPointers), sizeof(Z_Construct_UFunction_UNarrativeCharacterMovement_IsMovementLocked_Statics::NarrativeCharacterMovement_eventIsMovementLocked_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UNarrativeCharacterMovement_IsMovementLocked_Statics::Function_MetaDataParams), Z_Construct_UFunction_UNarrativeCharacterMovement_IsMovementLocked_Statics::Function_MetaDataParams) };
static_assert(sizeof(Z_Construct_UFunction_UNarrativeCharacterMovement_IsMovementLocked_Statics::NarrativeCharacterMovement_eventIsMovementLocked_Parms) < MAX_uint16);
UFunction* Z_Construct_UFunction_UNarrativeCharacterMovement_IsMovementLocked()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UNarrativeCharacterMovement_IsMovementLocked_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(UNarrativeCharacterMovement::execIsMovementLocked)
{
	P_FINISH;
	P_NATIVE_BEGIN;
	*(bool*)Z_Param__Result=P_THIS->IsMovementLocked();
	P_NATIVE_END;
}
// End Class UNarrativeCharacterMovement Function IsMovementLocked
...
// Begin Class UNarrativeCharacterMovement Function RemoveClimbWarpingMode
struct Z_Construct_UFunction_UNarrativeCharacterMovement_RemoveClimbWarpingMode_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Public/Character/NarrativeCharacterMovement.h" },
...
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UNarrativeCharacterMovement_RemoveClimbWarpingMode_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UNarrativeCharacterMovement, nullptr, "RemoveClimbWarpingMode", nullptr, nullptr, nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00040401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UNarrativeCharacterMovement_RemoveClimbWarpingMode_Statics::Function_MetaDataParams), Z_Construct_UFunction_UNarrativeCharacterMovement_RemoveClimbWarpingMode_Statics::Function_MetaDataParams) };
UFunction* Z_Construct_UFunction_UNarrativeCharacterMovement_RemoveClimbWarpingMode()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UNarrativeCharacterMovement_RemoveClimbWarpingMode_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(UNarrativeCharacterMovement::execRemoveClimbWarpingMode)
{
	P_FINISH;
	P_NATIVE_BEGIN;
	P_THIS->RemoveClimbWarpingMode();
	P_NATIVE_END;
}
// End Class UNarrativeCharacterMovement Function RemoveClimbWarpingMode

// Begin Class UNarrativeCharacterMovement Function RemoveClimbWarpingModeEndClimb
struct Z_Construct_UFunction_UNarrativeCharacterMovement_RemoveClimbWarpingModeEndClimb_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Public/Character/NarrativeCharacterMovement.h" },
...
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UNarrativeCharacterMovement_RemoveClimbWarpingModeEndClimb_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UNarrativeCharacterMovement, nullptr, "RemoveClimbWarpingModeEndClimb", nullptr, nullptr, nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00040401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UNarrativeCharacterMovement_RemoveClimbWarpingModeEndClimb_Statics::Function_MetaDataParams), Z_Construct_UFunction_UNarrativeCharacterMovement_RemoveClimbWarpingModeEndClimb_Statics::Function_MetaDataParams) };
UFunction* Z_Construct_UFunction_UNarrativeCharacterMovement_RemoveClimbWarpingModeEndClimb()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UNarrativeCharacterMovement_RemoveClimbWarpingModeEndClimb_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(UNarrativeCharacterMovement::execRemoveClimbWarpingModeEndClimb)
{
	P_FINISH;
	P_NATIVE_BEGIN;
	P_THIS->RemoveClimbWarpingModeEndClimb();
	P_NATIVE_END;
}
// End Class UNarrativeCharacterMovement Function RemoveClimbWarpingModeEndClimb

// Begin Class UNarrativeCharacterMovement Function SetMirrorComponent
struct Z_Construct_UFunction_UNarrativeCharacterMovement_SetMirrorComponent_Statics
{
	struct NarrativeCharacterMovement_eventSetMirrorComponent_Parms
	{
		UNarrativeCharacterMovement* MirrorCMC;
	};
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[] = {
		{ "Category", "Sprint" },
		{ "Comment", "/**Set our mirror component*/" },
		{ "ModuleRelativePath", "Public/Character/NarrativeCharacterMovement.h" },
		{ "ToolTip", "Set our mirror component" },
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_MirrorCMC_MetaData[] = {
		{ "EditInline", "true" },
	};
#endif // WITH_METADATA
	static const UECodeGen_Private::FObjectPropertyParams NewProp_MirrorCMC;
	static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
	static const UECodeGen_Private::FFunctionParams FuncParams;
};
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UNarrativeCharacterMovement_SetMirrorComponent_Statics::NewProp_MirrorCMC = { "MirrorCMC", nullptr, (EPropertyFlags)0x0010000000080080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(NarrativeCharacterMovement_eventSetMirrorComponent_Parms, MirrorCMC), Z_Construct_UClass_UNarrativeCharacterMovement_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_MirrorCMC_MetaData), NewProp_MirrorCMC_MetaData) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UNarrativeCharacterMovement_SetMirrorComponent_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UNarrativeCharacterMovement_SetMirrorComponent_Statics::NewProp_MirrorCMC,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UNarrativeCharacterMovement_SetMirrorComponent_Statics::PropPointers) < 2048);
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UNarrativeCharacterMovement_SetMirrorComponent_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UNarrativeCharacterMovement, nullptr, "SetMirrorComponent", nullptr, nullptr, Z_Construct_UFunction_UNarrativeCharacterMovement_SetMirrorComponent_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UNarrativeCharacterMovement_SetMirrorComponent_Statics::PropPointers), sizeof(Z_Construct_UFunction_UNarrativeCharacterMovement_SetMirrorComponent_Statics::NarrativeCharacterMovement_eventSetMirrorComponent_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UNarrativeCharacterMovement_SetMirrorComponent_Statics::Function_MetaDataParams), Z_Construct_UFunction_UNarrativeCharacterMovement_SetMirrorComponent_Statics::Function_MetaDataParams) };
static_assert(sizeof(Z_Construct_UFunction_UNarrativeCharacterMovement_SetMirrorComponent_Statics::NarrativeCharacterMovement_eventSetMirrorComponent_Parms) < MAX_uint16);
UFunction* Z_Construct_UFunction_UNarrativeCharacterMovement_SetMirrorComponent()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UNarrativeCharacterMovement_SetMirrorComponent_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(UNarrativeCharacterMovement::execSetMirrorComponent)
{
	P_GET_OBJECT(UNarrativeCharacterMovement,Z_Param_MirrorCMC);
	P_FINISH;
	P_NATIVE_BEGIN;
	P_THIS->SetMirrorComponent(Z_Param_MirrorCMC);
	P_NATIVE_END;
}
// End Class UNarrativeCharacterMovement Function SetMirrorComponent
...
void UNarrativeCharacterMovement::StaticRegisterNativesUNarrativeCharacterMovement()
{
	...
	static const FNameNativePtrPair Funcs[] = {
		...
		{ "GetMirrorMovement", &UNarrativeCharacterMovement::execGetMirrorMovement },
		{ "GetNarrativeCharacterOwner", &UNarrativeCharacterMovement::execGetNarrativeCharacterOwner },
		...
		{ "IsMovementLocked", &UNarrativeCharacterMovement::execIsMovementLocked },
		...
		{ "RemoveClimbWarpingMode", &UNarrativeCharacterMovement::execRemoveClimbWarpingMode },
		{ "RemoveClimbWarpingModeEndClimb", &UNarrativeCharacterMovement::execRemoveClimbWarpingModeEndClimb },
		{ "SetMirrorComponent", &UNarrativeCharacterMovement::execSetMirrorComponent },
...
struct Z_Construct_UClass_UNarrativeCharacterMovement_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_bCanExitClimbStrafe_MetaData[] = {
		{ "Category", "Climb" },
		{ "ModuleRelativePath", "Public/Character/NarrativeCharacterMovement.h" },
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_LastLocalYInput_MetaData[] = {
		{ "Category", "Climb" },
		{ "ModuleRelativePath", "Public/Character/NarrativeCharacterMovement.h" },
	};
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_TurnJumpZVelocity_MetaData[] = {
		{ "Category", "Climb" },
		{ "ModuleRelativePath", "Public/Character/NarrativeCharacterMovement.h" },
	};
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_ClimbMantleMontage_MetaData[] = {
		{ "Category", "Climb - Hop" },
		{ "Comment", "//Montage to play when we want to climb up from edge \n" },
		{ "ModuleRelativePath", "Public/Character/NarrativeCharacterMovement.h" },
		{ "ToolTip", "Montage to play when we want to climb up from edge" },
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_HopUpMontage_MetaData[] = {
		{ "Category", "Climb - Hop" },
		{ "Comment", "//Montage to play when we want to jump upwards - need montage since anim sequences dont work \n" },
		{ "ModuleRelativePath", "Public/Character/NarrativeCharacterMovement.h" },
		{ "ToolTip", "Montage to play when we want to jump upwards - need montage since anim sequences dont work" },
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_HopDownMontage_MetaData[] = {
		{ "Category", "Climb - Hop" },
		{ "Comment", "//Montage to play when we want to jump down\n" },
		{ "ModuleRelativePath", "Public/Character/NarrativeCharacterMovement.h" },
		{ "ToolTip", "Montage to play when we want to jump down" },
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_HopLeftMontage_MetaData[] = {
		{ "Category", "Climb - Hop" },
		{ "Comment", "//Montage to play when we want to jump left\n" },
		{ "ModuleRelativePath", "Public/Character/NarrativeCharacterMovement.h" },
		{ "ToolTip", "Montage to play when we want to jump left" },
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_HopRightMontage_MetaData[] = {
		{ "Category", "Climb - Hop" },
		{ "Comment", "//Montage to play when we want to jump right\n" },
		{ "ModuleRelativePath", "Public/Character/NarrativeCharacterMovement.h" },
		{ "ToolTip", "Montage to play when we want to jump right" },
	};
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_MirrorMovement_MetaData[] = {
		{ "Comment", "//We'll copy move speeds etc from this component if set. \n" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "Public/Character/NarrativeCharacterMovement.h" },
		{ "ToolTip", "We'll copy move speeds etc from this component if set." },
	};
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_bIsWarping_MetaData[] = {
		{ "ModuleRelativePath", "Public/Character/NarrativeCharacterMovement.h" },
	};
	...
	static void NewProp_bCanExitClimbStrafe_SetBit(void* Obj);
	static const UECodeGen_Private::FBoolPropertyParams NewProp_bCanExitClimbStrafe;
	static const UECodeGen_Private::FFloatPropertyParams NewProp_LastLocalYInput;
	...
	static const UECodeGen_Private::FFloatPropertyParams NewProp_TurnJumpZVelocity;
	static const UECodeGen_Private::FFloatPropertyParams NewProp_ClimbJumpHorizontalVelocity;
	static const UECodeGen_Private::FObjectPropertyParams NewProp_ClimbMantleMontage;
	...
	static const UECodeGen_Private::FObjectPropertyParams NewProp_MirrorMovement;
	...
	static void NewProp_bIsWarping_SetBit(void* Obj);
	static const UECodeGen_Private::FBoolPropertyParams NewProp_bIsWarping;
	static const UECodeGen_Private::FObjectPropertyParams NewProp_NarrativeCharacterOwner;
	static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
	static UObject* (*const DependentSingletons[])();
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_UNarrativeCharacterMovement_GetClimbMode, "GetClimbMode" }, // 3769473499
		{ &Z_Construct_UFunction_UNarrativeCharacterMovement_GetClimbSurface, "GetClimbSurface" }, // 3494924044
		{ &Z_Construct_UFunction_UNarrativeCharacterMovement_GetDesiredClimbMode, "GetDesiredClimbMode" }, // 1414875243
		{ &Z_Construct_UFunction_UNarrativeCharacterMovement_GetLocalInputVector, "GetLocalInputVector" }, // 3854894472
		{ &Z_Construct_UFunction_UNarrativeCharacterMovement_GetMirrorMovement, "GetMirrorMovement" }, // 864142375
		{ &Z_Construct_UFunction_UNarrativeCharacterMovement_GetNarrativeCharacterOwner, "GetNarrativeCharacterOwner" }, // 1342542789
		...
		{ &Z_Construct_UFunction_UNarrativeCharacterMovement_IsMovementLocked, "IsMovementLocked" }, // 3465035912
		...
		{ &Z_Construct_UFunction_UNarrativeCharacterMovement_RemoveClimbWarpingMode, "RemoveClimbWarpingMode" }, // 1038650202
		{ &Z_Construct_UFunction_UNarrativeCharacterMovement_RemoveClimbWarpingModeEndClimb, "RemoveClimbWarpingModeEndClimb" }, // 1249871360
		{ &Z_Construct_UFunction_UNarrativeCharacterMovement_SetMirrorComponent, "SetMirrorComponent" }, // 3340479134
...
void Z_Construct_UClass_UNarrativeCharacterMovement_Statics::NewProp_bCanExitClimbStrafe_SetBit(void* Obj)
{
	((UNarrativeCharacterMovement*)Obj)->bCanExitClimbStrafe = 1;
}
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UNarrativeCharacterMovement_Statics::NewProp_bCanExitClimbStrafe = { "bCanExitClimbStrafe", nullptr, (EPropertyFlags)0x0010000000020005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UNarrativeCharacterMovement), &Z_Construct_UClass_UNarrativeCharacterMovement_Statics::NewProp_bCanExitClimbStrafe_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_bCanExitClimbStrafe_MetaData), NewProp_bCanExitClimbStrafe_MetaData) };
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UNarrativeCharacterMovement_Statics::NewProp_LastLocalYInput = { "LastLocalYInput", nullptr, (EPropertyFlags)0x0010000000020005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNarrativeCharacterMovement, LastLocalYInput), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_LastLocalYInput_MetaData), NewProp_LastLocalYInput_MetaData) };
...
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UNarrativeCharacterMovement_Statics::NewProp_TurnJumpZVelocity = { "TurnJumpZVelocity", nullptr, (EPropertyFlags)0x0020080000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNarrativeCharacterMovement, TurnJumpZVelocity), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_TurnJumpZVelocity_MetaData), NewProp_TurnJumpZVelocity_MetaData) };
...
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UNarrativeCharacterMovement_Statics::NewProp_ClimbMantleMontage = { "ClimbMantleMontage", nullptr, (EPropertyFlags)0x0124080000000005, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNarrativeCharacterMovement, ClimbMantleMontage), Z_Construct_UClass_UAnimMontage_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_ClimbMantleMontage_MetaData), NewProp_ClimbMantleMontage_MetaData) };
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UNarrativeCharacterMovement_Statics::NewProp_HopUpMontage = { "HopUpMontage", nullptr, (EPropertyFlags)0x0124080000000005, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNarrativeCharacterMovement, HopUpMontage), Z_Construct_UClass_UAnimMontage_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_HopUpMontage_MetaData), NewProp_HopUpMontage_MetaData) };
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UNarrativeCharacterMovement_Statics::NewProp_HopDownMontage = { "HopDownMontage", nullptr, (EPropertyFlags)0x0124080000000005, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNarrativeCharacterMovement, HopDownMontage), Z_Construct_UClass_UAnimMontage_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_HopDownMontage_MetaData), NewProp_HopDownMontage_MetaData) };
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UNarrativeCharacterMovement_Statics::NewProp_HopLeftMontage = { "HopLeftMontage", nullptr, (EPropertyFlags)0x0124080000000005, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNarrativeCharacterMovement, HopLeftMontage), Z_Construct_UClass_UAnimMontage_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_HopLeftMontage_MetaData), NewProp_HopLeftMontage_MetaData) };
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UNarrativeCharacterMovement_Statics::NewProp_HopRightMontage = { "HopRightMontage", nullptr, (EPropertyFlags)0x0124080000000005, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNarrativeCharacterMovement, HopRightMontage), Z_Construct_UClass_UAnimMontage_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_HopRightMontage_MetaData), NewProp_HopRightMontage_MetaData) };
...
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UNarrativeCharacterMovement_Statics::NewProp_MirrorMovement = { "MirrorMovement", nullptr, (EPropertyFlags)0x0124080000080008, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNarrativeCharacterMovement, MirrorMovement), Z_Construct_UClass_UNarrativeCharacterMovement_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_MirrorMovement_MetaData), NewProp_MirrorMovement_MetaData) };
...
void Z_Construct_UClass_UNarrativeCharacterMovement_Statics::NewProp_bIsWarping_SetBit(void* Obj)
{
	((UNarrativeCharacterMovement*)Obj)->bIsWarping = 1;
}
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UNarrativeCharacterMovement_Statics::NewProp_bIsWarping = { "bIsWarping", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UNarrativeCharacterMovement), &Z_Construct_UClass_UNarrativeCharacterMovement_Statics::NewProp_bIsWarping_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_bIsWarping_MetaData), NewProp_bIsWarping_MetaData) };
...
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UNarrativeCharacterMovement_Statics::PropPointers[] = {
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UNarrativeCharacterMovement_Statics::NewProp_bCanExitClimbStrafe,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UNarrativeCharacterMovement_Statics::NewProp_LastLocalYInput,
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UNarrativeCharacterMovement_Statics::NewProp_TurnJumpZVelocity,
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UNarrativeCharacterMovement_Statics::NewProp_ClimbMantleMontage,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UNarrativeCharacterMovement_Statics::NewProp_HopUpMontage,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UNarrativeCharacterMovement_Statics::NewProp_HopDownMontage,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UNarrativeCharacterMovement_Statics::NewProp_HopLeftMontage,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UNarrativeCharacterMovement_Statics::NewProp_HopRightMontage,
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UNarrativeCharacterMovement_Statics::NewProp_MirrorMovement,
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UNarrativeCharacterMovement_Statics::NewProp_bIsWarping,
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeArsenal_Public_Character_NarrativeCharacterMovement_h_Statics
{
	static constexpr FEnumRegisterCompiledInInfo EnumInfo[] = {
		...
		{ ENarrativeClimbMode_StaticEnum, TEXT("ENarrativeClimbMode"), &Z_Registration_Info_UEnum_ENarrativeClimbMode, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1696721910U) },
	};
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UNarrativeCharacterMovement, UNarrativeCharacterMovement::StaticClass, TEXT("UNarrativeCharacterMovement"), &Z_Registration_Info_UClass_UNarrativeCharacterMovement, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNarrativeCharacterMovement), 758265572U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeArsenal_Public_Character_NarrativeCharacterMovement_h_691135759(TEXT("/Script/NarrativeArsenal"),
	Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeArsenal_Public_Character_NarrativeCharacterMovement_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeArsenal_Public_Character_NarrativeCharacterMovement_h_Statics::ClassInfo),
	nullptr, 0,
	Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeArsenal_Public_Character_NarrativeCharacterMovement_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeArsenal_Public_Character_NarrativeCharacterMovement_h_Statics::EnumInfo));
// End Registration
