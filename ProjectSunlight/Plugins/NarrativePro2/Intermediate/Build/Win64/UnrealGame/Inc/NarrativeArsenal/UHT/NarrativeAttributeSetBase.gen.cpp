...
// Begin Class UNarrativeAttributeSetBase Function OnRep_StealthRating
struct Z_Construct_UFunction_UNarrativeAttributeSetBase_OnRep_StealthRating_Statics
{
	struct NarrativeAttributeSetBase_eventOnRep_StealthRating_Parms
	{
		FGameplayAttributeData OldStealthRating;
	};
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Public/GAS/NarrativeAttributeSetBase.h" },
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_OldStealthRating_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif // WITH_METADATA
	static const UECodeGen_Private::FStructPropertyParams NewProp_OldStealthRating;
	static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
	static const UECodeGen_Private::FFunctionParams FuncParams;
};
const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UNarrativeAttributeSetBase_OnRep_StealthRating_Statics::NewProp_OldStealthRating = { "OldStealthRating", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(NarrativeAttributeSetBase_eventOnRep_StealthRating_Parms, OldStealthRating), Z_Construct_UScriptStruct_FGameplayAttributeData, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_OldStealthRating_MetaData), NewProp_OldStealthRating_MetaData) }; // 675369593
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UNarrativeAttributeSetBase_OnRep_StealthRating_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UNarrativeAttributeSetBase_OnRep_StealthRating_Statics::NewProp_OldStealthRating,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UNarrativeAttributeSetBase_OnRep_StealthRating_Statics::PropPointers) < 2048);
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UNarrativeAttributeSetBase_OnRep_StealthRating_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UNarrativeAttributeSetBase, nullptr, "OnRep_StealthRating", nullptr, nullptr, Z_Construct_UFunction_UNarrativeAttributeSetBase_OnRep_StealthRating_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UNarrativeAttributeSetBase_OnRep_StealthRating_Statics::PropPointers), sizeof(Z_Construct_UFunction_UNarrativeAttributeSetBase_OnRep_StealthRating_Statics::NarrativeAttributeSetBase_eventOnRep_StealthRating_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00480400, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UNarrativeAttributeSetBase_OnRep_StealthRating_Statics::Function_MetaDataParams), Z_Construct_UFunction_UNarrativeAttributeSetBase_OnRep_StealthRating_Statics::Function_MetaDataParams) };
static_assert(sizeof(Z_Construct_UFunction_UNarrativeAttributeSetBase_OnRep_StealthRating_Statics::NarrativeAttributeSetBase_eventOnRep_StealthRating_Parms) < MAX_uint16);
UFunction* Z_Construct_UFunction_UNarrativeAttributeSetBase_OnRep_StealthRating()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UNarrativeAttributeSetBase_OnRep_StealthRating_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(UNarrativeAttributeSetBase::execOnRep_StealthRating)
{
	P_GET_STRUCT_REF(FGameplayAttributeData,Z_Param_Out_OldStealthRating);
	P_FINISH;
	P_NATIVE_BEGIN;
	P_THIS->OnRep_StealthRating(Z_Param_Out_OldStealthRating);
	P_NATIVE_END;
}
// End Class UNarrativeAttributeSetBase Function OnRep_StealthRating
...
void UNarrativeAttributeSetBase::StaticRegisterNativesUNarrativeAttributeSetBase()
{
	...
	static const FNameNativePtrPair Funcs[] = {
		...
		{ "OnRep_StealthRating", &UNarrativeAttributeSetBase::execOnRep_StealthRating },
...
struct Z_Construct_UClass_UNarrativeAttributeSetBase_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_AttackDamage_MetaData[] = {
		...
		{ "Comment", "// AttackDamage is the amount of damage our attacks do. \n" },
		{ "ModuleRelativePath", "Public/GAS/NarrativeAttributeSetBase.h" },
		{ "ToolTip", "AttackDamage is the amount of damage our attacks do." },
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_StealthRating_MetaData[] = {
		{ "Category", "Stealth Rating" },
		{ "Comment", "// The higher the stealth rating, the more forgiving NPCs perception will be of you. 100 Stealth rating = not perceptable, 50 stealth rating = 50% less alert, etc. \n" },
		{ "ModuleRelativePath", "Public/GAS/NarrativeAttributeSetBase.h" },
		{ "ToolTip", "The higher the stealth rating, the more forgiving NPCs perception will be of you. 100 Stealth rating = not perceptable, 50 stealth rating = 50% less alert, etc." },
	};
	...
	static const UECodeGen_Private::FStructPropertyParams NewProp_StealthRating;
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_UNarrativeAttributeSetBase_OnRep_StealthRating, "OnRep_StealthRating" }, // 2247843962
...
const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UNarrativeAttributeSetBase_Statics::NewProp_StealthRating = { "StealthRating", "OnRep_StealthRating", (EPropertyFlags)0x0010000100000034, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNarrativeAttributeSetBase, StealthRating), Z_Construct_UScriptStruct_FGameplayAttributeData, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_StealthRating_MetaData), NewProp_StealthRating_MetaData) }; // 675369593
...
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UNarrativeAttributeSetBase_Statics::PropPointers[] = {
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UNarrativeAttributeSetBase_Statics::NewProp_StealthRating,
...
void UNarrativeAttributeSetBase::ValidateGeneratedRepEnums(const TArray<struct FRepRecord>& ClassReps) const
{
	...
	static const FName Name_StealthRating(TEXT("StealthRating"));
	const bool bIsValid = true
		...
		&& Name_StealthRating == ClassReps[(int32)ENetFields_Private::StealthRating].Property->GetFName();
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeArsenal_Public_GAS_NarrativeAttributeSetBase_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UNarrativeAttributeSetBase, UNarrativeAttributeSetBase::StaticClass, TEXT("UNarrativeAttributeSetBase"), &Z_Registration_Info_UClass_UNarrativeAttributeSetBase, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNarrativeAttributeSetBase), 728553269U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeArsenal_Public_GAS_NarrativeAttributeSetBase_h_3343319068(TEXT("/Script/NarrativeArsenal"),
	Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeArsenal_Public_GAS_NarrativeAttributeSetBase_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeArsenal_Public_GAS_NarrativeAttributeSetBase_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
