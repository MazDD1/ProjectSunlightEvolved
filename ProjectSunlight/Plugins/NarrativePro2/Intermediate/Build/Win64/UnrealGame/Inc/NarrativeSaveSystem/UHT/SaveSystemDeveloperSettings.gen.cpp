...
struct Z_Construct_UClass_USaveSystemDeveloperSettings_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_SaveGameClass_MetaData[] = {
		{ "Category", "Narrative Pro|Save System" },
		{ "Comment", "/** The class to use for our save game  */" },
		{ "MetaClass", "/Script/NarrativeSaveSystem.NarrativeSave" },
		{ "ModuleRelativePath", "Public/SaveSystemDeveloperSettings.h" },
		{ "ToolTip", "The class to use for our save game" },
	};
#endif // WITH_METADATA
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeSaveSystem_Public_SaveSystemDeveloperSettings_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_USaveSystemDeveloperSettings, USaveSystemDeveloperSettings::StaticClass, TEXT("USaveSystemDeveloperSettings"), &Z_Registration_Info_UClass_USaveSystemDeveloperSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USaveSystemDeveloperSettings), 2077371322U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeSaveSystem_Public_SaveSystemDeveloperSettings_h_2105079125(TEXT("/Script/NarrativeSaveSystem"),
	Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeSaveSystem_Public_SaveSystemDeveloperSettings_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeSaveSystem_Public_SaveSystemDeveloperSettings_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
