...
struct Z_Construct_UClass_UCharacterDefinition_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_TriggerSets_MetaData[] = {
		{ "AssetBundles", "SpawnedData" },
		{ "Category", "Triggers" },
		{ "Comment", "/** The triggers that should exist on this character by default.  */" },
		{ "ModuleRelativePath", "Public/Character/CharacterDefinition.h" },
		{ "ToolTip", "The triggers that should exist on this character by default." },
	};
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_AbilityConfiguration_MetaData[] = {
		{ "Category", "Abilities" },
		{ "Comment", "// Contains some default abilities to grant, attributes, etc. \n" },
		{ "ModuleRelativePath", "Public/Character/CharacterDefinition.h" },
	...
	static const UECodeGen_Private::FObjectPropertyParams NewProp_AbilityConfiguration;
...
const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UCharacterDefinition_Statics::NewProp_DefaultItemLoadout = { "DefaultItemLoadout", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UCharacterDefinition, DefaultItemLoadout), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_DefaultItemLoadout_MetaData), NewProp_DefaultItemLoadout_MetaData) }; // 1127129110
...
const UECodeGen_Private::FSoftObjectPropertyParams Z_Construct_UClass_UCharacterDefinition_Statics::NewProp_TriggerSets_Inner = { "TriggerSets", nullptr, (EPropertyFlags)0x0004000000000000, UECodeGen_Private::EPropertyGenFlags::SoftObject, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UClass_UTriggerSet_NoRegister, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UCharacterDefinition_Statics::NewProp_TriggerSets = { "TriggerSets", nullptr, (EPropertyFlags)0x0014000000000015, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UCharacterDefinition, TriggerSets), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_TriggerSets_MetaData), NewProp_TriggerSets_MetaData) };
...
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UCharacterDefinition_Statics::NewProp_AbilityConfiguration = { "AbilityConfiguration", nullptr, (EPropertyFlags)0x0114000000000015, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UCharacterDefinition, AbilityConfiguration), Z_Construct_UClass_UAbilityConfiguration_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_AbilityConfiguration_MetaData), NewProp_AbilityConfiguration_MetaData) };
...
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UCharacterDefinition_Statics::PropPointers[] = {
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UCharacterDefinition_Statics::NewProp_TriggerSets_Inner,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UCharacterDefinition_Statics::NewProp_TriggerSets,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UCharacterDefinition_Statics::NewProp_AttackPriority,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UCharacterDefinition_Statics::NewProp_AbilityConfiguration,
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeArsenal_Public_Character_CharacterDefinition_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UCharacterDefinition, UCharacterDefinition::StaticClass, TEXT("UCharacterDefinition"), &Z_Registration_Info_UClass_UCharacterDefinition, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UCharacterDefinition), 4270863169U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeArsenal_Public_Character_CharacterDefinition_h_1610346002(TEXT("/Script/NarrativeArsenal"),
	Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeArsenal_Public_Character_CharacterDefinition_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeArsenal_Public_Character_CharacterDefinition_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
