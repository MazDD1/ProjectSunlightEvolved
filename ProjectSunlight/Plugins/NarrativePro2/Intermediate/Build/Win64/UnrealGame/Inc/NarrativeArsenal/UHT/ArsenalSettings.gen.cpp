...
struct Z_Construct_UClass_UArsenalSettings_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_InteractionTraceProfile_MetaData[] = {
		{ "Category", "Narrative Pro|Trace Channels" },
		{ "GetOptions", "Engine.KismetSystemLibrary.GetCollisionProfileNames" },
		{ "ModuleRelativePath", "Public/ArsenalSettings.h" },
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_WeaponTraceChannel_MetaData[] = {
		{ "Category", "Narrative Pro|Trace Channels" },
		{ "ModuleRelativePath", "Public/ArsenalSettings.h" },
	};
#endif // WITH_METADATA
	...
	static const UECodeGen_Private::FNamePropertyParams NewProp_InteractionTraceProfile;
	static const UECodeGen_Private::FBytePropertyParams NewProp_WeaponTraceChannel;
...
const UECodeGen_Private::FNamePropertyParams Z_Construct_UClass_UArsenalSettings_Statics::NewProp_InteractionTraceProfile = { "InteractionTraceProfile", nullptr, (EPropertyFlags)0x0010000000004015, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UArsenalSettings, InteractionTraceProfile), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_InteractionTraceProfile_MetaData), NewProp_InteractionTraceProfile_MetaData) };
const UECodeGen_Private::FBytePropertyParams Z_Construct_UClass_UArsenalSettings_Statics::NewProp_WeaponTraceChannel = { "WeaponTraceChannel", nullptr, (EPropertyFlags)0x0010000000004015, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UArsenalSettings, WeaponTraceChannel), Z_Construct_UEnum_Engine_ECollisionChannel, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_WeaponTraceChannel_MetaData), NewProp_WeaponTraceChannel_MetaData) }; // 756624936
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UArsenalSettings_Statics::PropPointers[] = {
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UArsenalSettings_Statics::NewProp_InteractionTraceProfile,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UArsenalSettings_Statics::NewProp_WeaponTraceChannel,
};
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeArsenal_Public_ArsenalSettings_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UArsenalSettings, UArsenalSettings::StaticClass, TEXT("UArsenalSettings"), &Z_Registration_Info_UClass_UArsenalSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UArsenalSettings), 1043450366U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeArsenal_Public_ArsenalSettings_h_4037115366(TEXT("/Script/NarrativeArsenal"),
	Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeArsenal_Public_ArsenalSettings_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeArsenal_Public_ArsenalSettings_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
