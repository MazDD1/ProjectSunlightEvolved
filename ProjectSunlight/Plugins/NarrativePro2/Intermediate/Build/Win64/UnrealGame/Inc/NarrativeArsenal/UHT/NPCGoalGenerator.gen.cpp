...
// Begin ScriptStruct FSavedNPCGoalGenerator
static FStructRegistrationInfo Z_Registration_Info_UScriptStruct_SavedNPCGoalGenerator;
class UScriptStruct* FSavedNPCGoalGenerator::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_SavedNPCGoalGenerator.OuterSingleton)
	{
		Z_Registration_Info_UScriptStruct_SavedNPCGoalGenerator.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FSavedNPCGoalGenerator, (UObject*)Z_Construct_UPackage__Script_NarrativeArsenal(), TEXT("SavedNPCGoalGenerator"));
	}
	return Z_Registration_Info_UScriptStruct_SavedNPCGoalGenerator.OuterSingleton;
}
template<> NARRATIVEARSENAL_API UScriptStruct* StaticStruct<FSavedNPCGoalGenerator>()
{
	return FSavedNPCGoalGenerator::StaticStruct();
}
struct Z_Construct_UScriptStruct_FSavedNPCGoalGenerator_Statics
{
#if WITH_METADATA
	...
	{
		return (UScriptStruct::ICppStructOps*)new UScriptStruct::TCppStructOps<FSavedNPCGoalGenerator>();
	}
	static const UECodeGen_Private::FStructParams StructParams;
};
const UECodeGen_Private::FClassPropertyParams Z_Construct_UScriptStruct_FSavedNPCGoalGenerator_Statics::NewProp_Class = { "Class", nullptr, (EPropertyFlags)0x0014000001000000, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FSavedNPCGoalGenerator, Class), Z_Construct_UClass_UClass, Z_Construct_UClass_UNPCGoalGenerator_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_Class_MetaData), NewProp_Class_MetaData) };
const UECodeGen_Private::FBytePropertyParams Z_Construct_UScriptStruct_FSavedNPCGoalGenerator_Statics::NewProp_Data_Inner = { "Data", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, nullptr, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FSavedNPCGoalGenerator_Statics::NewProp_Data = { "Data", nullptr, (EPropertyFlags)0x0010000001000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FSavedNPCGoalGenerator, Data), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_Data_MetaData), NewProp_Data_MetaData) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UScriptStruct_FSavedNPCGoalGenerator_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FSavedNPCGoalGenerator_Statics::NewProp_Class,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FSavedNPCGoalGenerator_Statics::NewProp_Data_Inner,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FSavedNPCGoalGenerator_Statics::NewProp_Data,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSavedNPCGoalGenerator_Statics::PropPointers) < 2048);
const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FSavedNPCGoalGenerator_Statics::StructParams = {
	(UObject* (*)())Z_Construct_UPackage__Script_NarrativeArsenal,
	nullptr,
	&NewStructOps,
	"SavedNPCGoalGenerator",
	Z_Construct_UScriptStruct_FSavedNPCGoalGenerator_Statics::PropPointers,
	UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSavedNPCGoalGenerator_Statics::PropPointers),
	sizeof(FSavedNPCGoalGenerator),
	alignof(FSavedNPCGoalGenerator),
	RF_Public|RF_Transient|RF_MarkAsNative,
	EStructFlags(0x00000201),
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSavedNPCGoalGenerator_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FSavedNPCGoalGenerator_Statics::Struct_MetaDataParams)
};
UScriptStruct* Z_Construct_UScriptStruct_FSavedNPCGoalGenerator()
{
	if (!Z_Registration_Info_UScriptStruct_SavedNPCGoalGenerator.InnerSingleton)
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_SavedNPCGoalGenerator.InnerSingleton, Z_Construct_UScriptStruct_FSavedNPCGoalGenerator_Statics::StructParams);
	}
	return Z_Registration_Info_UScriptStruct_SavedNPCGoalGenerator.InnerSingleton;
}
// End ScriptStruct FSavedNPCGoalGenerator
...
struct Z_Construct_UClass_UNPCGoalGenerator_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_bSaveGoalGenerator_MetaData[] = {
		...
		{ "Comment", "//Whether this generator should be saved to disk or not\n" },
		{ "ModuleRelativePath", "Public/AI/Activities/NPCGoalGenerator.h" },
		{ "ToolTip", "Whether this generator should be saved to disk or not" },
	};
...
void Z_Construct_UClass_UNPCGoalGenerator_Statics::NewProp_bSaveGoalGenerator_SetBit(void* Obj)
{
	((UNPCGoalGenerator*)Obj)->bSaveGoalGenerator = 1;
}
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UNPCGoalGenerator_Statics::NewProp_bSaveGoalGenerator = { "bSaveGoalGenerator", nullptr, (EPropertyFlags)0x0010000000010015, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UNPCGoalGenerator), &Z_Construct_UClass_UNPCGoalGenerator_Statics::NewProp_bSaveGoalGenerator_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_bSaveGoalGenerator_MetaData), NewProp_bSaveGoalGenerator_MetaData) };
...
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UNPCGoalGenerator_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UNPCGoalGenerator_Statics::NewProp_bSaveGoalGenerator,
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeArsenal_Public_AI_Activities_NPCGoalGenerator_h_Statics
{
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FSavedNPCGoalGenerator::StaticStruct, Z_Construct_UScriptStruct_FSavedNPCGoalGenerator_Statics::NewStructOps, TEXT("SavedNPCGoalGenerator"), &Z_Registration_Info_UScriptStruct_SavedNPCGoalGenerator, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FSavedNPCGoalGenerator), 3315734014U) },
	};
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UNPCGoalGenerator, UNPCGoalGenerator::StaticClass, TEXT("UNPCGoalGenerator"), &Z_Registration_Info_UClass_UNPCGoalGenerator, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNPCGoalGenerator), 4200977375U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeArsenal_Public_AI_Activities_NPCGoalGenerator_h_2620215745(TEXT("/Script/NarrativeArsenal"),
	Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeArsenal_Public_AI_Activities_NPCGoalGenerator_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeArsenal_Public_AI_Activities_NPCGoalGenerator_h_Statics::ClassInfo),
	Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeArsenal_Public_AI_Activities_NPCGoalGenerator_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_build_U5M_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_NarrativePro_Source_NarrativeArsenal_Public_AI_Activities_NPCGoalGenerator_h_Statics::ScriptStructInfo),
	nullptr, 0);
// End Registration
